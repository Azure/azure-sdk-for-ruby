  ...
  module AzureEnvironments
    ...
    class AzureEnvironment
      ...
      def initialize(options)
        required_properties = %i[name portal_url management_endpoint_url resource_manager_endpoint_url active_directory_endpoint_url active_directory_resource_id]
