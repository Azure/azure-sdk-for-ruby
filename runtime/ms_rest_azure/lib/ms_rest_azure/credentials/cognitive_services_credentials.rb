...
module MsRestAzure
  ...
  class CognitiveServicesCredentials < MsRest::ServiceClientCredentials
    ...
    def initialize(subscription_key)
      raise ArgumentError, 'Subscription key cannot be nil' if subscription_key.nil?
      raise ArgumentError, 'Subscription key must be of type string' if subscription_key.class.to_s != 'String'
