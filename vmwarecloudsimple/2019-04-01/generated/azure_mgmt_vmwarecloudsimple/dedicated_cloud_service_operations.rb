...
module Microsoft.VMwareCloudSimple
  ...
  class DedicatedCloudServiceOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Microsoft.VMwareCloudSimple::Models::DedicatedCloudServiceListResponse.mapper()
    ...
    def get_async(resource_group_name, dedicated_cloud_service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Microsoft.VMwareCloudSimple::Models::DedicatedCloudService.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, dedicated_cloud_service_name, dedicated_cloud_service_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Microsoft.VMwareCloudSimple::Models::DedicatedCloudService.mapper()
