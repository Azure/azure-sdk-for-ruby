...
class ProfileGenerator
  CLIENTS_WITH_NO_BASE_URL = %w{ComputerVisionDataClass ContentModeratorDataClass FaceDataClass TextAnalyticsDataClass EventGridDataClass KeyVaultDataClass QnamakerDataClass CustomvisionpredictionDataClass CustomvisiontrainingDataClass AutosuggestDataClass CustomimagesearchDataClass }
