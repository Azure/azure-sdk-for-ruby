...
module Azure::Batch::V2018_03_01_6_1
  module Models
    ...
    class PoolListUsageMetricsResult
      ...
      #
      # @return [PoolListUsageMetricsResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for PoolListUsageMetricsResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PoolListUsageMetricsResult',
          type: {
            name: 'Composite',
            class_name: 'PoolListUsageMetricsResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'PoolUsageMetricsElementType',
                      type: {
                        name: 'Composite',
