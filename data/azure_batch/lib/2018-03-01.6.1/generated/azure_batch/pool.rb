...
module Azure::Batch::V2018_03_01_6_1
  ...
  class Pool
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolListUsageMetricsResult.mapper()
    ...
    def get_all_lifetime_statistics_async(pool_get_all_lifetime_statistics_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolStatistics.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def add_async(pool, pool_add_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolAddParameter.mapper()
    ...
    def list_async(pool_list_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_03_01_6_1::Models::CloudPoolListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_async(pool_id, pool_get_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_03_01_6_1::Models::CloudPool.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def patch_async(pool_id, pool_patch_parameter, pool_patch_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolPatchParameter.mapper()
    ...
    def enable_auto_scale_async(pool_id, pool_enable_auto_scale_parameter, pool_enable_auto_scale_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolEnableAutoScaleParameter.mapper()
    ...
    def evaluate_auto_scale_async(pool_id, pool_evaluate_auto_scale_parameter, pool_evaluate_auto_scale_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolEvaluateAutoScaleParameter.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_03_01_6_1::Models::AutoScaleRun.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def resize_async(pool_id, pool_resize_parameter, pool_resize_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolResizeParameter.mapper()
    ...
    def update_properties_async(pool_id, pool_update_properties_parameter, pool_update_properties_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolUpdatePropertiesParameter.mapper()
    ...
    def upgrade_os_async(pool_id, pool_upgrade_osparameter, pool_upgrade_os_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::PoolUpgradeOSParameter.mapper()
    ...
    def remove_nodes_async(pool_id, node_remove_parameter, pool_remove_nodes_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_03_01_6_1::Models::NodeRemoveParameter.mapper()
