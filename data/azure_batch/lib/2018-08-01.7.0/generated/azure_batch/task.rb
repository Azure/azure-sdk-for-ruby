...
module Azure::Batch::V2018_08_01_7_0
  ...
  class Task
    ...
    def add_async(job_id, task, task_add_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_08_01_7_0::Models::TaskAddParameter.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2018_08_01_7_0::Models::CloudTaskListResult.mapper()
    ...
    def add_collection_async(job_id, task_collection, task_add_collection_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_08_01_7_0::Models::TaskAddCollectionParameter.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_08_01_7_0::Models::TaskAddCollectionResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_async(job_id, task_id, task_get_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_08_01_7_0::Models::CloudTask.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(job_id, task_id, task_update_parameter, task_update_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_08_01_7_0::Models::TaskUpdateParameter.mapper()
    ...
    def list_subtasks_async(job_id, task_id, task_list_subtasks_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_08_01_7_0::Models::CloudTaskListSubtasksResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
