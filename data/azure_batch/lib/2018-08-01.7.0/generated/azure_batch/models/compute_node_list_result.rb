...
module Azure::Batch::V2018_08_01_7_0
  module Models
    ...
    class ComputeNodeListResult
      ...
      #
      # @return [ComputeNodeListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ComputeNodeListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ComputeNodeListResult',
          type: {
            name: 'Composite',
            class_name: 'ComputeNodeListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ComputeNodeElementType',
                      type: {
                        name: 'Composite',
