...
module Azure::Batch::V2018_12_01_8_0
  module Models
    ...
    class CloudJobScheduleListResult
      ...
      #
      # @return [CloudJobScheduleListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for CloudJobScheduleListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'CloudJobScheduleListResult',
          type: {
            name: 'Composite',
            class_name: 'CloudJobScheduleListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'CloudJobScheduleElementType',
                      type: {
                        name: 'Composite',
