...
module Azure::Batch::V2018_12_01_8_0
  ...
  class Job
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobStatistics.mapper()
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::CloudJob.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def patch_async(job_id, job_patch_parameter, job_patch_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobPatchParameter.mapper()
    ...
    def update_async(job_id, job_update_parameter, job_update_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobUpdateParameter.mapper()
    ...
    def disable_async(job_id, job_disable_parameter, job_disable_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobDisableParameter.mapper()
    ...
    def terminate_async(job_id, job_terminate_parameter:nil, job_terminate_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobTerminateParameter.mapper()
    ...
    def add_async(job, job_add_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::JobAddParameter.mapper()
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::CloudJobListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::CloudJobListPreparationAndReleaseTaskStatusResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::TaskCounts.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
