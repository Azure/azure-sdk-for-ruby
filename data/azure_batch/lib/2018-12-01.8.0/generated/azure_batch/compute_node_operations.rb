...
module Azure::Batch::V2018_12_01_8_0
  ...
  class ComputeNodeOperations
    ...
    def add_user_async(pool_id, node_id, user, compute_node_add_user_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::ComputeNodeUser.mapper()
    ...
    def update_user_async(pool_id, node_id, user_name, node_update_user_parameter, compute_node_update_user_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::NodeUpdateUserParameter.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::ComputeNode.mapper()
    ...
    def reboot_async(pool_id, node_id, node_reboot_parameter:nil, compute_node_reboot_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::NodeRebootParameter.mapper()
    ...
    def reimage_async(pool_id, node_id, node_reimage_parameter:nil, compute_node_reimage_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::NodeReimageParameter.mapper()
    ...
    def disable_scheduling_async(pool_id, node_id, node_disable_scheduling_parameter:nil, compute_node_disable_scheduling_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::NodeDisableSchedulingParameter.mapper()
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::ComputeNodeGetRemoteLoginSettingsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def upload_batch_service_logs_async(pool_id, node_id, upload_batch_service_logs_configuration, compute_node_upload_batch_service_logs_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2018_12_01_8_0::Models::UploadBatchServiceLogsConfiguration.mapper()
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::UploadBatchServiceLogsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2018_12_01_8_0::Models::ComputeNodeListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
