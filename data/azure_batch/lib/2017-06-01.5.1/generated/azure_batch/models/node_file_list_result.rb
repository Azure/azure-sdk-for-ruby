...
module Azure::Batch::V2017_06_01_5_1
  module Models
    ...
    class NodeFileListResult
      ...
      #
      # @return [NodeFileListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for NodeFileListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'NodeFileListResult',
          type: {
            name: 'Composite',
            class_name: 'NodeFileListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'NodeFileElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'NodeFile'
                      }
