...
module Azure::Batch::V2017_06_01_5_1
  module Models
    ...
    class ExitOptions
      ...
      #
      # none - Take no action.
      # disable - Disable the job. This is equivalent to calling the disable
      # job API, with a disableTasks value of requeue.
      # terminate - Terminate the job. The terminateReason in the job's
      # executionInfo is set to "TaskFailed". The default is none for exit code
      # 0 and terminate for all other exit conditions.
      #
      ...
      # exit conditions. If the job's usesTaskDependencies property is set to
      # false, then specifying the dependencyAction property returns an error
