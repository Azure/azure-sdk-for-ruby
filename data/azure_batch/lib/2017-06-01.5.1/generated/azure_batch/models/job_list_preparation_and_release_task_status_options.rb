...
module Azure::Batch::V2017_06_01_5_1
  module Models
    ...
    class JobListPreparationAndReleaseTaskStatusOptions
      ...
      # @return [String] An OData $filter clause. To get the status of the Job
      ...
      #
      # Mapper for JobListPreparationAndReleaseTaskStatusOptions class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          type: {
            name: 'Composite',
            class_name: 'JobListPreparationAndReleaseTaskStatusOptions',
            model_properties: {
              filter: {
                client_side_validation: true,
                required: false,
