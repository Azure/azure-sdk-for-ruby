...
module Azure::Batch::V2017_06_01_5_1
  ...
  class Job
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobStatistics.mapper()
    ...
    def get_async(job_id, job_get_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::CloudJob.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def patch_async(job_id, job_patch_parameter, job_patch_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobPatchParameter.mapper()
    ...
    def update_async(job_id, job_update_parameter, job_update_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobUpdateParameter.mapper()
    ...
    def disable_async(job_id, job_disable_parameter, job_disable_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobDisableParameter.mapper()
    ...
    def terminate_async(job_id, job_terminate_parameter:nil, job_terminate_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobTerminateParameter.mapper()
    ...
    def add_async(job, job_add_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobAddParameter.mapper()
    ...
    def list_async(job_list_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::CloudJobListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_preparation_and_release_task_status_async(job_id, job_list_preparation_and_release_task_status_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::CloudJobListPreparationAndReleaseTaskStatusResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_task_counts_async(job_id, job_get_task_counts_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::TaskCounts.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
