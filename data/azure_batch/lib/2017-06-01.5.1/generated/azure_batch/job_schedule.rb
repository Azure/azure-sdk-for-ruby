...
module Azure::Batch::V2017_06_01_5_1
  ...
  class JobSchedule
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::CloudJobSchedule.mapper()
    ...
    def patch_async(job_schedule_id, job_schedule_patch_parameter, job_schedule_patch_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobSchedulePatchParameter.mapper()
    ...
    def update_async(job_schedule_id, job_schedule_update_parameter, job_schedule_update_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobScheduleUpdateParameter.mapper()
    ...
    def add_async(cloud_job_schedule, job_schedule_add_options:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::V2017_06_01_5_1::Models::JobScheduleAddParameter.mapper()
    ...
    def list_async(job_schedule_list_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2017_06_01_5_1::Models::CloudJobScheduleListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
