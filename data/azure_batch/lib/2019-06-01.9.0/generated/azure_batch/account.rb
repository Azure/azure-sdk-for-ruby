...
module Azure::Batch::V2019_06_01_9_0
  ...
  class Account
    ...
    #
    # @param account_list_supported_images_options
    # [AccountListSupportedImagesOptions] Additional parameters for the operation
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Array<ImageInformation>] operation results.
    #
    def list_supported_images(account_list_supported_images_options:nil, custom_headers:nil)
      first_page = list_supported_images_as_lazy(account_list_supported_images_options:account_list_supported_images_options, custom_headers:custom_headers)
    ...
    #
    def list_supported_images_with_http_info(account_list_supported_images_options:nil, custom_headers:nil)
      list_supported_images_async(account_list_supported_images_options:account_list_supported_images_options, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_supported_images_async(account_list_supported_images_options:nil, custom_headers:nil)
      ...
      ocp_date = nil
      unless account_list_supported_images_options.nil?
        filter = account_list_supported_images_options.filter
      end
      unless account_list_supported_images_options.nil?
        max_results = account_list_supported_images_options.maxResults
      end
      unless account_list_supported_images_options.nil?
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::V2019_06_01_9_0::Models::AccountListSupportedImagesResult.mapper()
    ...
    request_url = request_url.gsub('{batchUrl}', @client.batch_url)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::V2019_06_01_9_0::Models::PoolNodeCountsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # to List operation.
    # @param account_list_supported_images_next_options
    # [AccountListSupportedImagesNextOptions] Additional parameters for the
    # operation
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [AccountListSupportedImagesResult] operation results.
    #
    def list_supported_images_next(next_page_link, account_list_supported_images_next_options:nil, custom_headers:nil)
      response = list_supported_images_next_async(next_page_link, account_list_supported_images_next_options:account_list_supported_images_next_options, custom_headers:custom_headers).value!
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_supported_images_next_with_http_info(next_page_link, account_list_supported_images_next_options:nil, custom_headers:nil)
      list_supported_images_next_async(next_page_link, account_list_supported_images_next_options:account_list_supported_images_next_options, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_supported_images_next_async(next_page_link, account_list_supported_images_next_options:nil, custom_headers:nil)
      fail ArgumentError, 'next_page_link is nil' if next_page_link.nil?

      client_request_id = nil
      return_client_request_id = nil
      ocp_date = nil
      unless account_list_supported_images_next_options.nil?
        client_request_id = account_list_supported_images_next_options.client_request_id
      end
      unless account_list_supported_images_next_options.nil?
        return_client_request_id = account_list_supported_images_next_options.return_client_request_id
      end
      unless account_list_supported_images_next_options.nil?
        ocp_date = account_list_supported_images_next_options.ocp_date
      end
    ...
    # will be added to the HTTP request.
    #
    # @return [AccountListSupportedImagesResult] which provide lazy access to pages
    # of the response.
    #
    def list_supported_images_as_lazy(account_list_supported_images_options:nil, custom_headers:nil)
      response = list_supported_images_async(account_list_supported_images_options:account_list_supported_images_options, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          account_list_supported_images_next_options = account_list_supported_images_options
          list_supported_images_next_async(next_page_link, account_list_supported_images_next_options:account_list_supported_images_next_options, custom_headers:custom_headers)
        end
        page
      end
    end
