...
module Azure::Batch::V2019_06_01_9_0
  module Models
    ...
    class PoolSpecification
      ...
      # Compute Nodes. Enabling inter-node communication limits the maximum
      # size of the Pool due to deployment restrictions on the Compute Nodes of
      # the Pool. This may result in the Pool not reaching its desired size.
