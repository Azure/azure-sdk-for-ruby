...
module Azure::Batch::V2019_06_01_9_0
  module Models
    ...
    class CloudJob
      ...
      # Preparation Task is a special Task run on each Compute Node before any
      ...
      # a special Task run at the end of the Job on each Compute Node that has
      # run any other Task of the Job.
      ...
      # lifetime of the Job. This property is populated only if the CloudJob
      # was retrieved with an expand clause including the 'stats' attribute;
