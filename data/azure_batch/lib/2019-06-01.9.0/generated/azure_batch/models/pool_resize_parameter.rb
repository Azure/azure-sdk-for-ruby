...
module Azure::Batch::V2019_06_01_9_0
  module Models
    ...
    class PoolResizeParameter
      ...
      # @return [Duration] The timeout for allocation of Nodes to the Pool or
      # removal of Compute Nodes from the Pool. The default value is 15
      ...
      # Compute Node and its running task(s) if the Pool size is decreasing.
