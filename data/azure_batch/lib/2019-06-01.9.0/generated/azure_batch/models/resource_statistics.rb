...
module Azure::Batch::V2019_06_01_9_0
  module Models
    ...
    class ResourceStatistics
      ...
      # @return [Float] The average CPU usage across all Compute Nodes in the
      # Pool (percentage per node).
      attr_accessor :avg_cpupercentage

      # @return [Float] The average memory usage in GiB across all Compute
      # Nodes in the Pool.
      attr_accessor :avg_memory_gi_b

      # @return [Float] The peak memory usage in GiB across all Compute Nodes
      # in the Pool.
      attr_accessor :peak_memory_gi_b

      # @return [Float] The average used disk space in GiB across all Compute
      # Nodes in the Pool.
      attr_accessor :avg_disk_gi_b

      # @return [Float] The peak used disk space in GiB across all Compute
      # Nodes in the Pool.
