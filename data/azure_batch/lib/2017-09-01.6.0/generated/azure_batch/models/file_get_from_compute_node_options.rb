...
module Azure::Batch::V2017_09_01_6_0
  module Models
    ...
    class FileGetFromComputeNodeOptions
      ...
      # @return [String] The byte range to be retrieved. The default is to
      # retrieve the entire file. The format is bytes=startRange-endRange.
      attr_accessor :ocp_range
      ...
      #
      # Mapper for FileGetFromComputeNodeOptions class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          type: {
            name: 'Composite',
            class_name: 'FileGetFromComputeNodeOptions',
            model_properties: {
              timeout: {
                client_side_validation: true,
                required: false,
