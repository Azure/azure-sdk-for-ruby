...
module Azure::Batch::V2017_09_01_6_0
  module Models
    ...
    class CloudTaskListResult
      ...
      #
      # @return [CloudTaskListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for CloudTaskListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'CloudTaskListResult',
          type: {
            name: 'Composite',
            class_name: 'CloudTaskListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'CloudTaskElementType',
                      type: {
                        name: 'Composite',
