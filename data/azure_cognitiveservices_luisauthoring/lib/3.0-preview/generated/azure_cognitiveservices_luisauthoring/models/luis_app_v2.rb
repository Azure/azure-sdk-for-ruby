...
module Azure::CognitiveServices::LuisAuthoring::V3_0_preview
  module Models
    ...
    class LuisAppV2
      ...
      attr_accessor :luis_schema_version
      ...
      #
      # Mapper for LuisAppV2 class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'LuisAppV2',
          type: {
            name: 'Composite',
            class_name: 'LuisAppV2',
            model_properties: {
              ...
              luis_schema_version: {
                client_side_validation: true,
                required: false,
                serialized_name: 'luis_schema_version',
                type: {
                  name: 'String'
                }
              },
              ...
              intents: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'HierarchicalModelV2ElementType',
                      type: {
                        name: 'Composite',
