...
Gem::Specification.new do |spec|
  ...
  spec.version       = Azure::CognitiveServices::LuisAuthoring::VERSION
  spec.authors       = 'Microsoft Corporation'
  spec.email         = 'azrubyteam@microsoft.com'
  spec.description   = 'Microsoft Azure Cognitive Services LUIS Runtime Client Library for Ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure Cognitive Services LUIS Runtime.'
