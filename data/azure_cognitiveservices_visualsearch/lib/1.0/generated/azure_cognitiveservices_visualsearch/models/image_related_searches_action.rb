...
module Azure::CognitiveServices::VisualSearch::V1_0
  module Models
    ...
    class ImageRelatedSearchesAction < ImageAction
      ...
      # @return [RelatedSearchesModule] A list of queries related to the image.
      attr_accessor :data


      #
      # Mapper for ImageRelatedSearchesAction class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ImageRelatedSearchesAction',
          type: {
            name: 'Composite',
            class_name: 'ImageRelatedSearchesAction',
            model_properties: {
              _type: {
                client_side_validation: true,
                required: true,
