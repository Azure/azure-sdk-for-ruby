...
module Azure::EventGrid::V2018_01_01
  module Models
    ...
    class MediaJobOutputProcessingEventData < MediaJobOutputStateChangeEventData
      ...
      #
      # Mapper for MediaJobOutputProcessingEventData class as Ruby Hash.
      # This will be used for serialization/deserialization.
      #
      def self.mapper()
        {
          required: false,
          serialized_name: '#Microsoft.Media.JobOutputProcessing',
          type: {
            name: 'Composite',
            class_name: 'MediaJobOutputProcessingEventData',
            model_properties: {
              previous_state: {
                required: false,
                read_only: true,
