...
module Azure::EventGrid::V2018_01_01
  module Models
    ...
    class ResourceWriteCancelData
      ...
      #
      # Mapper for ResourceWriteCancelData class as Ruby Hash.
      # This will be used for serialization/deserialization.
      #
      def self.mapper()
        {
          required: false,
          serialized_name: 'ResourceWriteCancelData',
          type: {
            name: 'Composite',
            class_name: 'ResourceWriteCancelData',
            model_properties: {
              tenant_id: {
                required: false,
