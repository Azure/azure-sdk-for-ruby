...
Gem::Specification.new do |spec|
  ...
  spec.version       = Azure::CognitiveServices::SpellCheck::VERSION
  spec.authors       = 'Microsoft Corporation'
  spec.email         = 'azrubyteam@microsoft.com'
  spec.description   = 'Microsoft Azure Cognitive Services Spell Check Client Library for Ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure Cognitive Services Spell Check.'
