...
Gem::Specification.new do |spec|
  ...
  spec.version       = Azure::CognitiveServices::LocalSearch::VERSION
  spec.authors       = 'Microsoft Corporation'
  spec.email         = 'azrubyteam@microsoft.com'
  spec.description   = 'Microsoft Azure Cognitive Services Local Search Client Library for Ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure Cognitive Services Local Search.'
