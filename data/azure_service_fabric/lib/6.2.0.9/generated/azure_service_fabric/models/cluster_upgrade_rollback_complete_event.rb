...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class ClusterUpgradeRollbackCompleteEvent < ClusterEvent
      ...
      #
      # Mapper for ClusterUpgradeRollbackCompleteEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ClusterUpgradeRollbackComplete',
          type: {
            name: 'Composite',
            class_name: 'ClusterUpgradeRollbackCompleteEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
