...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class ApplicationHealthReportCreatedEvent < ApplicationEvent
      ...
      #
      # Mapper for ApplicationHealthReportCreatedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ApplicationHealthReportCreated',
          type: {
            name: 'Composite',
            class_name: 'ApplicationHealthReportCreatedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
