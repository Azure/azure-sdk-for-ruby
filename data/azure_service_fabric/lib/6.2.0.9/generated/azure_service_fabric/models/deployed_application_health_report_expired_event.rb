...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class DeployedApplicationHealthReportExpiredEvent < ApplicationEvent
      ...
      #
      # Mapper for DeployedApplicationHealthReportExpiredEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DeployedApplicationHealthReportExpired',
          type: {
            name: 'Composite',
            class_name: 'DeployedApplicationHealthReportExpiredEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
