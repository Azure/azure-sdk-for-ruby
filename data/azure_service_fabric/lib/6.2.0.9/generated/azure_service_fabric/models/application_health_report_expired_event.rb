...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class ApplicationHealthReportExpiredEvent < ApplicationEvent
      ...
      #
      # Mapper for ApplicationHealthReportExpiredEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ApplicationHealthReportExpired',
          type: {
            name: 'Composite',
            class_name: 'ApplicationHealthReportExpiredEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
