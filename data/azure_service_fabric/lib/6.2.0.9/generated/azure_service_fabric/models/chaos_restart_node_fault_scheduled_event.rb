...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class ChaosRestartNodeFaultScheduledEvent < NodeEvent
      ...
      #
      # Mapper for ChaosRestartNodeFaultScheduledEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosRestartNodeFaultScheduled',
          type: {
            name: 'Composite',
            class_name: 'ChaosRestartNodeFaultScheduledEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
