...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class DeployedApplicationHealthReportCreatedEvent < ApplicationEvent
      ...
      #
      # Mapper for DeployedApplicationHealthReportCreatedEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DeployedApplicationHealthReportCreated',
          type: {
            name: 'Composite',
            class_name: 'DeployedApplicationHealthReportCreatedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
