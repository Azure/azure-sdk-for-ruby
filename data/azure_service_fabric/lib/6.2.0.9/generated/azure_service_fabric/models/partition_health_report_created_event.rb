...
module Azure::ServiceFabric::V6_2_0_9
  module Models
    ...
    class PartitionHealthReportCreatedEvent < PartitionEvent
      ...
      #
      # Mapper for PartitionHealthReportCreatedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PartitionHealthReportCreated',
          type: {
            name: 'Composite',
            class_name: 'PartitionHealthReportCreatedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
