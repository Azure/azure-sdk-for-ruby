...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ChaosReplicaRemovalScheduledEvent < ReplicaEvent
      ...
      #
      # Mapper for ChaosReplicaRemovalScheduledEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosReplicaRemovalScheduled',
          type: {
            name: 'Composite',
            class_name: 'ChaosReplicaRemovalScheduledEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
