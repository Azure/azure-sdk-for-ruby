...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class PagedGatewayResourceDescriptionList
      ...
      # @return [Array<GatewayResourceDescription>] One page of the list.
      attr_accessor :items


      #
      # Mapper for PagedGatewayResourceDescriptionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedGatewayResourceDescriptionList',
          type: {
            name: 'Composite',
            class_name: 'PagedGatewayResourceDescriptionList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'GatewayResourceDescriptionElementType',
                      type: {
                        name: 'Composite',
