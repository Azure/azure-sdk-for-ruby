...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class PagedNetworkResourceDescriptionList
      ...
      # @return [Array<NetworkResourceDescription>] One page of the list.
      attr_accessor :items


      #
      # Mapper for PagedNetworkResourceDescriptionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedNetworkResourceDescriptionList',
          type: {
            name: 'Composite',
            class_name: 'PagedNetworkResourceDescriptionList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'NetworkResourceDescriptionElementType',
                      type: {
                        name: 'Composite',
