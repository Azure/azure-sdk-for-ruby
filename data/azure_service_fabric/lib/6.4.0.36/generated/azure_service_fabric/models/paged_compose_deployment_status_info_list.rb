...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    #
    # The list of compose deployments in the cluster. The list is paged when
    ...
    class PagedComposeDeploymentStatusInfoList
      ...
      # @return [Array<ComposeDeploymentStatusInfo>] List of compose deployment
      # status information.
      attr_accessor :items


      #
      # Mapper for PagedComposeDeploymentStatusInfoList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedComposeDeploymentStatusInfoList',
          type: {
            name: 'Composite',
            class_name: 'PagedComposeDeploymentStatusInfoList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ComposeDeploymentStatusInfoElementType',
                      type: {
                        name: 'Composite',
