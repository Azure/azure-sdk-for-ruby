...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class DeployedServicePackageNewHealthReportEvent < ApplicationEvent
      ...
      #
      # Mapper for DeployedServicePackageNewHealthReportEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DeployedServicePackageNewHealthReport',
          type: {
            name: 'Composite',
            class_name: 'DeployedServicePackageNewHealthReportEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
