...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ApplicationUpgradeDomainCompletedEvent < ApplicationEvent
      ...
      #
      # Mapper for ApplicationUpgradeDomainCompletedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ApplicationUpgradeDomainCompleted',
          type: {
            name: 'Composite',
            class_name: 'ApplicationUpgradeDomainCompletedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
