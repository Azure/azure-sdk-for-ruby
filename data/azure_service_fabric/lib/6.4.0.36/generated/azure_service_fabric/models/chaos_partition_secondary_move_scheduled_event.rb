...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ChaosPartitionSecondaryMoveScheduledEvent < PartitionEvent
      ...
      #
      # Mapper for ChaosPartitionSecondaryMoveScheduledEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosPartitionSecondaryMoveScheduled',
          type: {
            name: 'Composite',
            class_name: 'ChaosPartitionSecondaryMoveScheduledEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
