...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ContainerInstanceView
      ...
      # @return [Integer] The number of times the container has been restarted.
      ...
      # @return [Array<ContainerEvent>] The events of this container instance.
      attr_accessor :events


      #
      # Mapper for ContainerInstanceView class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ContainerInstanceView',
          type: {
            name: 'Composite',
