...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class PagedServiceReplicaDescriptionList
      ...
      # @return [Array<ServiceReplicaDescription>] List of service resource
      # replica description.
      attr_accessor :items


      #
      # Mapper for PagedServiceReplicaDescriptionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedServiceReplicaDescriptionList',
          type: {
            name: 'Composite',
            class_name: 'PagedServiceReplicaDescriptionList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ServiceReplicaDescriptionElementType',
                      type: {
                        name: 'Composite',
