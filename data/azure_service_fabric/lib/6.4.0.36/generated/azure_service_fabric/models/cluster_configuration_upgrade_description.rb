...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ClusterConfigurationUpgradeDescription
      ...
      # @return [String] The cluster configuration as a JSON string. For
      # example, [this
      ...
      # @return [Duration] The length of time between attempts to perform
      ...
      # domain. Default value: Date.parse('PT0H0M0S') .
