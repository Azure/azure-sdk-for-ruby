...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class DeployedServicePackageHealthReportExpiredEvent < ApplicationEvent
      ...
      #
      # Mapper for DeployedServicePackageHealthReportExpiredEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DeployedServicePackageHealthReportExpired',
          type: {
            name: 'Composite',
            class_name: 'DeployedServicePackageHealthReportExpiredEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
