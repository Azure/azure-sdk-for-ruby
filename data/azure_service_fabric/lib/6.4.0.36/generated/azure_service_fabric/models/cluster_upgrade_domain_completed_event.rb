...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ClusterUpgradeDomainCompletedEvent < ClusterEvent
      ...
      #
      # Mapper for ClusterUpgradeDomainCompletedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ClusterUpgradeDomainCompleted',
          type: {
            name: 'Composite',
            class_name: 'ClusterUpgradeDomainCompletedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
