...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class StatelessReplicaNewHealthReportEvent < ReplicaEvent
      ...
      #
      # Mapper for StatelessReplicaNewHealthReportEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'StatelessReplicaNewHealthReport',
          type: {
            name: 'Composite',
            class_name: 'StatelessReplicaNewHealthReportEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
