...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class PagedApplicationResourceDescriptionList
      ...
      # @return [Array<ApplicationResourceDescription>] One page of the list.
      attr_accessor :items


      #
      # Mapper for PagedApplicationResourceDescriptionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedApplicationResourceDescriptionList',
          type: {
            name: 'Composite',
            class_name: 'PagedApplicationResourceDescriptionList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationResourceDescriptionElementType',
                      type: {
                        name: 'Composite',
