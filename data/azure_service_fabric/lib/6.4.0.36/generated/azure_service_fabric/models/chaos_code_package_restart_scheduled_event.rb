...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ChaosCodePackageRestartScheduledEvent < ApplicationEvent
      ...
      #
      # Mapper for ChaosCodePackageRestartScheduledEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosCodePackageRestartScheduled',
          type: {
            name: 'Composite',
            class_name: 'ChaosCodePackageRestartScheduledEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
