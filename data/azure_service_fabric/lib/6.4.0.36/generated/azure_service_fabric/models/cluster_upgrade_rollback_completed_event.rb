...
module Azure::ServiceFabric::V6_4_0_36
  module Models
    ...
    class ClusterUpgradeRollbackCompletedEvent < ClusterEvent
      ...
      #
      # Mapper for ClusterUpgradeRollbackCompletedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ClusterUpgradeRollbackCompleted',
          type: {
            name: 'Composite',
            class_name: 'ClusterUpgradeRollbackCompletedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
