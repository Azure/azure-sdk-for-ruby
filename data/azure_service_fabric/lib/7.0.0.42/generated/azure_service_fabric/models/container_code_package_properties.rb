...
module Azure::ServiceFabric::V7_0_0_42
  module Models
    ...
    class ContainerCodePackageProperties
      ...
      # @return [Array<Probe>] An array of liveness probes for a code package.
      # It determines when to restart a code package.
      attr_accessor :liveness_probe

      # @return [Array<Probe>] An array of readiness probes for a code package.
          ...
          type: {
            ...
            model_properties: {
              ...
              readiness_probe: {
                client_side_validation: true,
                required: false,
                serialized_name: 'readinessProbe',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
