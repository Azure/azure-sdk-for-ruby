...
module Azure::ServiceFabric::V6_3_0_9
  module Models
    ...
    class ChaosRestartCodePackageFaultScheduledEvent < ApplicationEvent
      ...
      #
      # Mapper for ChaosRestartCodePackageFaultScheduledEvent class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosRestartCodePackageFaultScheduled',
          type: {
            name: 'Composite',
            class_name: 'ChaosRestartCodePackageFaultScheduledEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
