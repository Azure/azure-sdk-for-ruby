...
module Azure::ServiceFabric::V6_3_0_9
  module Models
    ...
    class ChaosRemoveReplicaFaultCompletedEvent < ReplicaEvent
      ...
      #
      # Mapper for ChaosRemoveReplicaFaultCompletedEvent class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ChaosRemoveReplicaFaultCompleted',
          type: {
            name: 'Composite',
            class_name: 'ChaosRemoveReplicaFaultCompletedEvent',
            model_properties: {
              event_instance_id: {
                client_side_validation: true,
                required: true,
