...
module Azure::ServiceFabric::V6_3_0_9
  module Models
    #
    # The list of application types that are provisioned or being provisioned
    ...
    class PagedApplicationTypeInfoList
      ...
      # @return [Array<ApplicationTypeInfo>] List of application type
      # information.
      attr_accessor :items


      #
      # Mapper for PagedApplicationTypeInfoList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedApplicationTypeInfoList',
          type: {
            name: 'Composite',
            class_name: 'PagedApplicationTypeInfoList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationTypeInfoElementType',
                      type: {
                        name: 'Composite',
