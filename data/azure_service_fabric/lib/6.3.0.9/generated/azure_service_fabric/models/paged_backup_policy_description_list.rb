...
module Azure::ServiceFabric::V6_3_0_9
  module Models
    ...
    class PagedBackupPolicyDescriptionList
      ...
      # @return [Array<BackupPolicyDescription>] The list of backup policies
      # information.
      attr_accessor :items


      #
      # Mapper for PagedBackupPolicyDescriptionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PagedBackupPolicyDescriptionList',
          type: {
            name: 'Composite',
            class_name: 'PagedBackupPolicyDescriptionList',
            model_properties: {
              continuation_token: {
                client_side_validation: true,
                required: false,
              ...
              items: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'BackupPolicyDescriptionElementType',
                      type: {
                        name: 'Composite',
