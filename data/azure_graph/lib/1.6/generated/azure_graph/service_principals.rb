...
module Azure::Graph::V1_6
  ...
  class ServicePrincipals
    ...
    def create_async(parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Graph::V1_6::Models::ServicePrincipalCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::Graph::V1_6::Models::ServicePrincipal.mapper()
    ...
    def list_async(filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Graph::V1_6::Models::ServicePrincipalListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
