...
module Azure::CognitiveServices::CustomVision::Training::V3_0
  ...
  #
  class TrainingClient < MsRestAzure::AzureServiceClient
    include MsRestAzure
    ...
    #
    # Creates initializes a new instance of the TrainingClient class.
    ...
    def get_domains(custom_headers = nil)
      response = get_domains_async(custom_headers).value!
    ...
    def get_domains_with_http_info(custom_headers = nil)
      get_domains_async(custom_headers).value!
    end
    ...
    def get_domain(domain_id, custom_headers = nil)
      response = get_domain_async(domain_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_domain_with_http_info(domain_id, custom_headers = nil)
      get_domain_async(domain_id, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Domain.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_tagged_image_count(project_id, iteration_id = nil, tag_ids = nil, custom_headers = nil)
      response = get_tagged_image_count_async(project_id, iteration_id, tag_ids, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_tagged_image_count_with_http_info(project_id, iteration_id = nil, tag_ids = nil, custom_headers = nil)
      get_tagged_image_count_async(project_id, iteration_id, tag_ids, custom_headers).value!
    end
    ...
    def get_untagged_image_count(project_id, iteration_id = nil, custom_headers = nil)
      response = get_untagged_image_count_async(project_id, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_untagged_image_count_with_http_info(project_id, iteration_id = nil, custom_headers = nil)
      get_untagged_image_count_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def create_image_tags(project_id, batch, custom_headers = nil)
      response = create_image_tags_async(project_id, batch, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_image_tags_with_http_info(project_id, batch, custom_headers = nil)
      create_image_tags_async(project_id, batch, custom_headers).value!
    end
    ...
    def create_image_tags_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageTagCreateBatch.mapper()
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageTagCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete_image_tags(project_id, image_ids, tag_ids, custom_headers = nil)
      response = delete_image_tags_async(project_id, image_ids, tag_ids, custom_headers).value!
      nil
    end
    ...
    def delete_image_tags_with_http_info(project_id, image_ids, tag_ids, custom_headers = nil)
      delete_image_tags_async(project_id, image_ids, tag_ids, custom_headers).value!
    end
    ...
    def create_image_regions(project_id, batch, custom_headers = nil)
      response = create_image_regions_async(project_id, batch, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_image_regions_with_http_info(project_id, batch, custom_headers = nil)
      create_image_regions_async(project_id, batch, custom_headers).value!
    end
    ...
    def create_image_regions_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageRegionCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageRegionCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete_image_regions(project_id, region_ids, custom_headers = nil)
      response = delete_image_regions_async(project_id, region_ids, custom_headers).value!
      nil
    end
    ...
    def delete_image_regions_with_http_info(project_id, region_ids, custom_headers = nil)
      delete_image_regions_async(project_id, region_ids, custom_headers).value!
    end
    ...
    def get_tagged_images(project_id, iteration_id = nil, tag_ids = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      response = get_tagged_images_async(project_id, iteration_id, tag_ids, order_by, take, skip, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_tagged_images_with_http_info(project_id, iteration_id = nil, tag_ids = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      get_tagged_images_async(project_id, iteration_id, tag_ids, order_by, take, skip, custom_headers).value!
    end
    ...
    def get_untagged_images(project_id, iteration_id = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      response = get_untagged_images_async(project_id, iteration_id, order_by, take, skip, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_untagged_images_with_http_info(project_id, iteration_id = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      get_untagged_images_async(project_id, iteration_id, order_by, take, skip, custom_headers).value!
    end
    ...
    def get_images_by_ids(project_id, image_ids = nil, iteration_id = nil, custom_headers = nil)
      response = get_images_by_ids_async(project_id, image_ids, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_images_by_ids_with_http_info(project_id, image_ids = nil, iteration_id = nil, custom_headers = nil)
      get_images_by_ids_async(project_id, image_ids, iteration_id, custom_headers).value!
    end
    ...
    def create_images_from_data(project_id, image_data, tag_ids = nil, custom_headers = nil)
      response = create_images_from_data_async(project_id, image_data, tag_ids, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_images_from_data_with_http_info(project_id, image_data, tag_ids = nil, custom_headers = nil)
      create_images_from_data_async(project_id, image_data, tag_ids, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete_images(project_id, image_ids, custom_headers = nil)
      response = delete_images_async(project_id, image_ids, custom_headers).value!
      nil
    end
    ...
    def delete_images_with_http_info(project_id, image_ids, custom_headers = nil)
      delete_images_async(project_id, image_ids, custom_headers).value!
    end
    ...
    def create_images_from_files(project_id, batch, custom_headers = nil)
      response = create_images_from_files_async(project_id, batch, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_images_from_files_with_http_info(project_id, batch, custom_headers = nil)
      create_images_from_files_async(project_id, batch, custom_headers).value!
    end
    ...
    def create_images_from_files_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageFileCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_images_from_urls(project_id, batch, custom_headers = nil)
      response = create_images_from_urls_async(project_id, batch, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_images_from_urls_with_http_info(project_id, batch, custom_headers = nil)
      create_images_from_urls_async(project_id, batch, custom_headers).value!
    end
    ...
    def create_images_from_urls_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageUrlCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_images_from_predictions(project_id, batch, custom_headers = nil)
      response = create_images_from_predictions_async(project_id, batch, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_images_from_predictions_with_http_info(project_id, batch, custom_headers = nil)
      create_images_from_predictions_async(project_id, batch, custom_headers).value!
    end
    ...
    def create_images_from_predictions_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageIdCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def get_image_region_proposals(project_id, image_id, custom_headers = nil)
      response = get_image_region_proposals_async(project_id, image_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_image_region_proposals_with_http_info(project_id, image_id, custom_headers = nil)
      get_image_region_proposals_async(project_id, image_id, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageRegionProposal.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete_prediction(project_id, ids, custom_headers = nil)
      response = delete_prediction_async(project_id, ids, custom_headers).value!
      nil
    end
    ...
    def delete_prediction_with_http_info(project_id, ids, custom_headers = nil)
      delete_prediction_async(project_id, ids, custom_headers).value!
    end
    ...
    def quick_test_image_url(project_id, image_url, iteration_id = nil, custom_headers = nil)
      response = quick_test_image_url_async(project_id, image_url, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def quick_test_image_url_with_http_info(project_id, image_url, iteration_id = nil, custom_headers = nil)
      quick_test_image_url_async(project_id, image_url, iteration_id, custom_headers).value!
    end
    ...
    def quick_test_image_url_async(project_id, image_url, iteration_id = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImageUrl.mapper()
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::ImagePrediction.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def quick_test_image(project_id, image_data, iteration_id = nil, custom_headers = nil)
      response = quick_test_image_async(project_id, image_data, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def quick_test_image_with_http_info(project_id, image_data, iteration_id = nil, custom_headers = nil)
      quick_test_image_async(project_id, image_data, iteration_id, custom_headers).value!
    end
    ...
    def query_predictions(project_id, query, custom_headers = nil)
      response = query_predictions_async(project_id, query, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def query_predictions_with_http_info(project_id, query, custom_headers = nil)
      query_predictions_async(project_id, query, custom_headers).value!
    end
    ...
    def query_predictions_async(project_id, query, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::PredictionQueryToken.mapper()
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::PredictionQueryResult.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_iteration_performance(project_id, iteration_id, threshold = nil, overlap_threshold = nil, custom_headers = nil)
      response = get_iteration_performance_async(project_id, iteration_id, threshold, overlap_threshold, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_iteration_performance_with_http_info(project_id, iteration_id, threshold = nil, overlap_threshold = nil, custom_headers = nil)
      get_iteration_performance_async(project_id, iteration_id, threshold, overlap_threshold, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::IterationPerformance.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_image_performances(project_id, iteration_id, tag_ids = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      response = get_image_performances_async(project_id, iteration_id, tag_ids, order_by, take, skip, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_image_performances_with_http_info(project_id, iteration_id, tag_ids = nil, order_by = nil, take = 50, skip = 0, custom_headers = nil)
      get_image_performances_async(project_id, iteration_id, tag_ids, order_by, take, skip, custom_headers).value!
    end
    ...
    def get_image_performance_count(project_id, iteration_id, tag_ids = nil, custom_headers = nil)
      response = get_image_performance_count_async(project_id, iteration_id, tag_ids, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_image_performance_count_with_http_info(project_id, iteration_id, tag_ids = nil, custom_headers = nil)
      get_image_performance_count_async(project_id, iteration_id, tag_ids, custom_headers).value!
    end
    ...
    def get_projects(custom_headers = nil)
      response = get_projects_async(custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_projects_with_http_info(custom_headers = nil)
      get_projects_async(custom_headers).value!
    end
    ...
    def create_project(name, description = nil, domain_id = nil, classification_type = nil, target_export_platforms = nil, custom_headers = nil)
      response = create_project_async(name, description, domain_id, classification_type, target_export_platforms, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_project_with_http_info(name, description = nil, domain_id = nil, classification_type = nil, target_export_platforms = nil, custom_headers = nil)
      create_project_async(name, description, domain_id, classification_type, target_export_platforms, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Project.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_project(project_id, custom_headers = nil)
      response = get_project_async(project_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_project_with_http_info(project_id, custom_headers = nil)
      get_project_async(project_id, custom_headers).value!
    end
    ...
    def delete_project(project_id, custom_headers = nil)
      response = delete_project_async(project_id, custom_headers).value!
      nil
    end
    ...
    def delete_project_with_http_info(project_id, custom_headers = nil)
      delete_project_async(project_id, custom_headers).value!
    end
    ...
    def update_project(project_id, updated_project, custom_headers = nil)
      response = update_project_async(project_id, updated_project, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_project_with_http_info(project_id, updated_project, custom_headers = nil)
      update_project_async(project_id, updated_project, custom_headers).value!
    end
    ...
    def update_project_async(project_id, updated_project, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Project.mapper()
    ...
    def train_project(project_id, training_type = nil, reserved_budget_in_hours = 0, force_train = false, notification_email_address = nil, custom_headers = nil)
      response = train_project_async(project_id, training_type, reserved_budget_in_hours, force_train, notification_email_address, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def train_project_with_http_info(project_id, training_type = nil, reserved_budget_in_hours = 0, force_train = false, notification_email_address = nil, custom_headers = nil)
      train_project_async(project_id, training_type, reserved_budget_in_hours, force_train, notification_email_address, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Iteration.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_iterations(project_id, custom_headers = nil)
      response = get_iterations_async(project_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_iterations_with_http_info(project_id, custom_headers = nil)
      get_iterations_async(project_id, custom_headers).value!
    end
    ...
    def get_iteration(project_id, iteration_id, custom_headers = nil)
      response = get_iteration_async(project_id, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_iteration_with_http_info(project_id, iteration_id, custom_headers = nil)
      get_iteration_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def delete_iteration(project_id, iteration_id, custom_headers = nil)
      response = delete_iteration_async(project_id, iteration_id, custom_headers).value!
      nil
    end
    ...
    def delete_iteration_with_http_info(project_id, iteration_id, custom_headers = nil)
      delete_iteration_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def update_iteration(project_id, iteration_id, updated_iteration, custom_headers = nil)
      response = update_iteration_async(project_id, iteration_id, updated_iteration, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_iteration_with_http_info(project_id, iteration_id, updated_iteration, custom_headers = nil)
      update_iteration_async(project_id, iteration_id, updated_iteration, custom_headers).value!
    end
    ...
    def update_iteration_async(project_id, iteration_id, updated_iteration, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Iteration.mapper()
    ...
    def publish_iteration(project_id, iteration_id, publish_name, prediction_id, custom_headers = nil)
      response = publish_iteration_async(project_id, iteration_id, publish_name, prediction_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def publish_iteration_with_http_info(project_id, iteration_id, publish_name, prediction_id, custom_headers = nil)
      publish_iteration_async(project_id, iteration_id, publish_name, prediction_id, custom_headers).value!
    end
    ...
    def unpublish_iteration(project_id, iteration_id, custom_headers = nil)
      response = unpublish_iteration_async(project_id, iteration_id, custom_headers).value!
      nil
    end
    ...
    def unpublish_iteration_with_http_info(project_id, iteration_id, custom_headers = nil)
      unpublish_iteration_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def get_exports(project_id, iteration_id, custom_headers = nil)
      response = get_exports_async(project_id, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_exports_with_http_info(project_id, iteration_id, custom_headers = nil)
      get_exports_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def export_iteration(project_id, iteration_id, platform, flavor = nil, custom_headers = nil)
      response = export_iteration_async(project_id, iteration_id, platform, flavor, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def export_iteration_with_http_info(project_id, iteration_id, platform, flavor = nil, custom_headers = nil)
      export_iteration_async(project_id, iteration_id, platform, flavor, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Export.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_tag(project_id, tag_id, iteration_id = nil, custom_headers = nil)
      response = get_tag_async(project_id, tag_id, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_tag_with_http_info(project_id, tag_id, iteration_id = nil, custom_headers = nil)
      get_tag_async(project_id, tag_id, iteration_id, custom_headers).value!
    end
    ...
    request_url = request_url.gsub('{Endpoint}', endpoint)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Tag.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete_tag(project_id, tag_id, custom_headers = nil)
      response = delete_tag_async(project_id, tag_id, custom_headers).value!
      nil
    end
    ...
    def delete_tag_with_http_info(project_id, tag_id, custom_headers = nil)
      delete_tag_async(project_id, tag_id, custom_headers).value!
    end
    ...
    def update_tag(project_id, tag_id, updated_tag, custom_headers = nil)
      response = update_tag_async(project_id, tag_id, updated_tag, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_tag_with_http_info(project_id, tag_id, updated_tag, custom_headers = nil)
      update_tag_async(project_id, tag_id, updated_tag, custom_headers).value!
    end
    ...
    def update_tag_async(project_id, tag_id, updated_tag, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V3_0::Models::Tag.mapper()
    ...
    def get_tags(project_id, iteration_id = nil, custom_headers = nil)
      response = get_tags_async(project_id, iteration_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_tags_with_http_info(project_id, iteration_id = nil, custom_headers = nil)
      get_tags_async(project_id, iteration_id, custom_headers).value!
    end
    ...
    def create_tag(project_id, name, description = nil, type = nil, custom_headers = nil)
      response = create_tag_async(project_id, name, description, type, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_tag_with_http_info(project_id, name, description = nil, type = nil, custom_headers = nil)
      create_tag_async(project_id, name, description, type, custom_headers).value!
    end
    ...
    #
    def add_telemetry
        sdk_information = 'azure_cognitiveservices_customvision_training'
        if defined? Azure::CognitiveServices::CustomVision::Training::V3_0::VERSION
          sdk_information = "#{sdk_information}/#{Azure::CognitiveServices::CustomVision::Training::V3_0::VERSION}"
        end
