...
module Azure::CognitiveServices::CustomVision::Training::V1_0
  ...
  class TrainingClient < MsRestAzure::AzureServiceClient
    ...
    def get_domain_async(domain_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Domain.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_images_from_data_async(project_id, image_data, tag_ids = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_images_from_files_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageFileCreateBatch.mapper()
    ...
    def create_images_from_urls_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageUrlCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_images_from_predictions_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageIdCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_image_tags_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageTagCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageTagCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_image_regions_async(project_id, batch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageRegionCreateBatch.mapper()
      request_content = self.serialize(request_mapper,  batch)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageRegionCreateSummary.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_image_region_proposals_async(project_id, image_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageRegionProposal.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def query_predictions_async(project_id, query, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::PredictionQueryToken.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::PredictionQueryResult.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def quick_test_image_url_async(project_id, image_url, iteration_id = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImageUrl.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::ImagePrediction.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def train_project(project_id, custom_headers = nil)
      response = train_project_async(project_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def train_project_with_http_info(project_id, custom_headers = nil)
      train_project_async(project_id, custom_headers).value!
    end
    ...
    def train_project_async(project_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Iteration.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_project(name, description = nil, domain_id = nil, custom_headers = nil)
      response = create_project_async(name, description, domain_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_project_with_http_info(name, description = nil, domain_id = nil, custom_headers = nil)
      create_project_async(name, description, domain_id, custom_headers).value!
    end
    ...
    def create_project_async(name, description = nil, domain_id = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Project.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_project_async(project_id, updated_project, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Project.mapper()
    ...
    def update_iteration_async(project_id, iteration_id, updated_iteration, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Iteration.mapper()
    ...
    def get_iteration_performance_async(project_id, iteration_id, threshold = nil, overlap_threshold = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::IterationPerformance.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def export_iteration_async(project_id, iteration_id, platform, flavor = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Export.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_tag_async(project_id, tag_id, iteration_id = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Tag.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_tag_async(project_id, tag_id, updated_tag, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::CognitiveServices::CustomVision::Training::V1_0::Models::Tag.mapper()
    ...
    def create_tag(project_id, name, description = nil, custom_headers = nil)
      response = create_tag_async(project_id, name, description, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_tag_with_http_info(project_id, name, description = nil, custom_headers = nil)
      create_tag_async(project_id, name, description, custom_headers).value!
    end
    ...
    def add_telemetry
        ...
        if defined? Azure::CognitiveServices::CustomVision::Training::V1_0::VERSION
          sdk_information = "#{sdk_information}/#{Azure::CognitiveServices::CustomVision::Training::V1_0::VERSION}"
        end
