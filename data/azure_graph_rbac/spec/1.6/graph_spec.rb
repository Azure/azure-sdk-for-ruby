...
describe 'GraphRbacClient' do
  ...
  it 'should list all existing users using lazy paging' do
    ...
    expect(next_page.value[0]).to be_a(Azure::GraphRbac::V1_6::Models::User)
  end
  ...
  it 'should create new user' do
    user_param = Azure::GraphRbac::V1_6::Models::UserCreateParameters.new
    user_param.account_enabled = true
    user_param.password_profile = Azure::GraphRbac::V1_6::Models::PasswordProfile.new.tap do |profile|
    ...
    expect(user).to be_a(Azure::GraphRbac::V1_6::Models::User)
