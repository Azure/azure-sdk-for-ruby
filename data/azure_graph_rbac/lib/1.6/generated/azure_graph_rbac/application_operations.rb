...
module Azure::GraphRbac::V1_6
  ...
  class ApplicationOperations
    ...
    #
    #
    def add_password(object_id, custom_headers = nil)
      response = add_password_async(object_id, custom_headers).value!
      nil
    end
    ...
    #
    def add_password_with_http_info(object_id, custom_headers = nil)
      add_password_async(object_id, custom_headers).value!
    end
    ...
    #
    def add_password_async(object_id, custom_headers = nil)
      ...
      path_template = '{tenantID}/applications/{objectId}/addPassword'
