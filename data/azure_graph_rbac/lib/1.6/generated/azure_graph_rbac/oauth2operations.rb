...
module Azure::GraphRbac::V1_6
  ...
  class OAuth2Operations
    ...
    #
    # Creates and initializes a new instance of the OAuth2Operations class.
    ...
    #
    # @return [OAuth2] operation results.
    #
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::GraphRbac::V1_6::Models::OAuth2.mapper()
    ...
    def post_async(body = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::GraphRbac::V1_6::Models::OAuth2.mapper()
