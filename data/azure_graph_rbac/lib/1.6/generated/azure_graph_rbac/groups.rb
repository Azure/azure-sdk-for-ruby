...
module Azure::GraphRbac::V1_6
  ...
  class Groups
    ...
    # object.
    #
    # @param object_id [String] The object ID of the group for which to get owners.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Array<DirectoryObject>] operation results.
    ...
    def list_owners_with_http_info(object_id, custom_headers = nil)
      list_owners_async(object_id, custom_headers).value!
    end
    ...
    def list_owners_async(object_id, custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = '{tenantID}/groups/{objectId}/owners'
    ...
    #
    # @param object_id [String] The object ID of the application to which to add
    # the owner.
    ...
    #
    #
    def add_owner(object_id, parameters, custom_headers = nil)
      response = add_owner_async(object_id, parameters, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def add_owner_with_http_info(object_id, parameters, custom_headers = nil)
      add_owner_async(object_id, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def add_owner_async(object_id, parameters, custom_headers = nil)
      fail ArgumentError, 'object_id is nil' if object_id.nil?
      fail ArgumentError, 'parameters is nil' if parameters.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.tenant_id is nil' if @client.tenant_id.nil?
      ...
      path_template = '{tenantID}/groups/{objectId}/$links/owners'
    ...
    #
    # @param object_id [String] The object ID of the group from which to remove the
    # owner.
    ...
    #
    #
    def remove_owner(object_id, owner_object_id, custom_headers = nil)
      response = remove_owner_async(object_id, owner_object_id, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def remove_owner_with_http_info(object_id, owner_object_id, custom_headers = nil)
      remove_owner_async(object_id, owner_object_id, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def remove_owner_async(object_id, owner_object_id, custom_headers = nil)
      fail ArgumentError, 'object_id is nil' if object_id.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = '{tenantID}/groups/{objectId}/$links/owners/{ownerObjectId}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'objectId' => object_id,'ownerObjectId' => owner_object_id,'tenantID' => @client.tenant_id},
          query_params: {'api-version' => @client.api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
