...
module Azure::GraphRbac::V1_6
  ...
  class OAuth2
    ...
    def get(filter = nil, custom_headers = nil)
      first_page = get_as_lazy(filter, custom_headers)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::GraphRbac::V1_6::Models::PermissionsListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [PermissionsListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [PermissionsListResult] which provide lazy access to pages of the
    # response.
    #
    def get_as_lazy(filter = nil, custom_headers = nil)
