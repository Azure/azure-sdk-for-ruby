...
module Azure::GraphRbac::V1_6
  ...
  class ServicePrincipals
    ...
    #
    # @param parameters [ServicePrincipal] Parameters to create a service
    # principal.
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(object_id, parameters, custom_headers = nil)
      update_async(object_id, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(object_id, parameters, custom_headers = nil)
