...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Microsoft Azure Cognitive Services QnA Maker Client Library for Ruby'
  spec.homepage      = 'https://aka.ms/azure-sdk-for-ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure QnA Maker Services'
  spec.license       = 'MIT'
  spec.metadata      = {
