...
module Azure::KeyVault::V7_2_preview
  module Models
    ...
    class RestoreOperation
      ...
      # @return [Error] Error encountered, if any, during the restore
      # operation.
      attr_accessor :error
      ...
      #
      # Mapper for RestoreOperation class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RestoreOperation',
          type: {
            name: 'Composite',
            class_name: 'RestoreOperation',
            model_properties: {
              status: {
                client_side_validation: true,
                required: false,
