...
module Azure::ARM::Storage
  ...
  class StorageAccounts
    ...
    def create(resource_group_name1, account_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create(resource_group_name1, account_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get_properties(resource_group_name1, account_name1, custom_headers = nil) }
    ...
    def begin_create(resource_group_name1, account_name1, parameters1, custom_headers = nil)
      ...
      path['{accountName}'] = ERB::Util.url_encode(account_name1)
      path['{subscriptionId}'] = ERB::Util.url_encode(@client.subscription_id)
      url = URI.join(@client.base_url, path)
      properties = {}
      properties['api-version'] = ERB::Util.url_encode(@client.api_version.to_s) unless @client.api_version.nil?
