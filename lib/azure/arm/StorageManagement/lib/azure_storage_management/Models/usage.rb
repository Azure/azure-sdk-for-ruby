    ...
    class Usage
      ...
      def self.serialize_object(object)
        ...
        if (serialized_property)
          serialized_property = Azure::ARM::Storage::Models::UsageName.serialize_object(serialized_property)
        end
      ...
      def self.deserialize_object(object)
        ...
        fail MsRest::DeserializationError.new('Error occured in deserializing the enum', nil, nil, nil) if (!deserialized_property.nil? && !deserialized_property.empty? && !Azure::ARM::Storage::Models::UsageUnit.constants.any? { |e| Azure::ARM::Storage::Models::UsageUnit.const_get(e) == deserialized_property })
        ...
        if (deserialized_property)
          deserialized_property = Azure::ARM::Storage::Models::UsageName.deserialize_object(deserialized_property)
        end
