      ...
      def self.serialize_object(object)
        ...
        if (serialized_property)
          ...
          serialized_property.each do |element|
            if (element)
              element = Azure::ARM::Compute::Models::VirtualMachineExtensionHandlerInstanceView.serialize_object(element)
            end
        ...
        if (serialized_property)
          ...
          serialized_property.each do |element1|
            if (element1)
              element1 = Azure::ARM::Compute::Models::InstanceViewStatus.serialize_object(element1)
            end
      ...
      def self.deserialize_object(object)
        ...
        if (deserialized_property)
          ...
          deserialized_property.each do |element2|
            if (element2)
              element2 = Azure::ARM::Compute::Models::VirtualMachineExtensionHandlerInstanceView.deserialize_object(element2)
            end
        ...
        if (deserialized_property)
          ...
          deserialized_property.each do |element3|
            if (element3)
              element3 = Azure::ARM::Compute::Models::InstanceViewStatus.deserialize_object(element3)
            end
