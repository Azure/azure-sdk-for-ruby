  ...
  module Models
    ...
    class Usage
      ...
      def self.deserialize_object(object)
        ...
        fail MsRest::DeserializationError.new('Error occured in deserializing the enum', nil, nil, nil) if (!deserialized_property.nil? && !deserialized_property.empty? && !Azure::ARM::Compute::Models::UsageUnit.constants.any? { |e| Azure::ARM::Compute::Models::UsageUnit.const_get(e) == deserialized_property })
