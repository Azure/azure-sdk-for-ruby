    ...
    class LinuxConfiguration
      ...
      def self.serialize_object(object)
        ...
        if (serialized_property)
          serialized_property = Azure::ARM::Compute::Models::SshConfiguration.serialize_object(serialized_property)
        end
      ...
      def self.deserialize_object(object)
        ...
        if (deserialized_property)
          deserialized_property = Azure::ARM::Compute::Models::SshConfiguration.deserialize_object(deserialized_property)
        end
