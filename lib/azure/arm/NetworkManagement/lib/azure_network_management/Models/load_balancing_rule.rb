    ...
    class LoadBalancingRule < MsRestAzure::SubResource
      ...
      def self.serialize_object(object)
        ...
        if (serialized_property)
          serialized_property = Azure::ARM::Network::Models::LoadBalancingRulePropertiesFormat.serialize_object(serialized_property)
        end
      ...
      def self.deserialize_object(object)
        ...
        if (deserialized_property)
          deserialized_property = Azure::ARM::Network::Models::LoadBalancingRulePropertiesFormat.deserialize_object(deserialized_property)
        end
