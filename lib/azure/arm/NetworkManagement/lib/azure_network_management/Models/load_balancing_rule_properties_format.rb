  ...
  module Models
    ...
    class LoadBalancingRulePropertiesFormat
      ...
      def self.deserialize_object(object)
        ...
        fail MsRest::DeserializationError.new('Error occured in deserializing the enum', nil, nil, nil) if (!deserialized_property.nil? && !deserialized_property.empty? && !AzureNetworkManagement::LoadDistribution.constants.any? { |e| AzureNetworkManagement::LoadDistribution.const_get(e) == deserialized_property })
