...
module AzureNetworkManagement
  ...
  class VirtualNetworks
    ...
    #
    def delete(resource_group_name1, virtual_network_name1, custom_headers = nil)
      # Send request
      response = begin_delete(resource_group_name1, virtual_network_name1, custom_headers = nil).value!
    ...
    # response.
    #
    def begin_delete(resource_group_name1, virtual_network_name1, custom_headers = nil)
      ...
      path['{virtualNetworkName}'] = ERB::Util.url_encode(virtual_network_name1)
    ...
    # response.
    #
    def get(resource_group_name1, virtual_network_name1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_name1 is nil' if virtual_network_name1.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      promise = promise.then do |http_response|
        ...
        if status_code == 200
          begin
            ...
            if (parsed_response)
              parsed_response = AzureNetworkManagement::Models::VirtualNetwork.deserialize_object(parsed_response)
            end
    ...
    # @param resource_group_name1 [String] The name of the resource group.
    # @param virtual_network_name1 [String] The name of the virtual network.
    # @param parameters1 [VirtualNetwork] Parameters supplied to the create/update
    ...
    # @return [TODO: add type] TODO: add text
    #
    def create_or_update(resource_group_name1, virtual_network_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, virtual_network_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, virtual_network_name1, custom_headers = nil) }
    ...
    # response.
    #
    def begin_create_or_update(resource_group_name1, virtual_network_name1, parameters1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_name1 is nil' if virtual_network_name1.nil?
      ...
      if (parameters1)
        parameters1 = AzureNetworkManagement::Models::VirtualNetwork.serialize_object(parameters1)
      end
      ...
      promise = promise.then do |http_response|
        ...
        if status_code == 200
          begin
            parsed_response = JSON.load(response_content) unless response_content.to_s.empty?
            if (parsed_response)
              parsed_response = AzureNetworkManagement::Models::VirtualNetworkListResult.deserialize_object(parsed_response)
            end
            result.body = parsed_response
          rescue Exception => e
            fail MsRest::DeserializationError.new("Error occured in deserializing the response", e.message, e.backtrace, response_content)
