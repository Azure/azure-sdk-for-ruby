...
module Azure::ARM::Network
  ...
  class LoadBalancers
    ...
    def delete(resource_group_name1, load_balancer_name1, custom_headers = nil)
      # Send request
      promise = begin_delete(resource_group_name1, load_balancer_name1, custom_headers)
    ...
    def begin_delete(resource_group_name1, load_balancer_name1, custom_headers = nil)
      ...
      path['{loadBalancerName}'] = ERB::Util.url_encode(load_balancer_name1) if path.include?('{loadBalancerName}')
    ...
    def create_or_update(resource_group_name1, load_balancer_name1, parameters1, custom_headers = nil)
      # Send request
      promise = begin_create_or_update(resource_group_name1, load_balancer_name1, parameters1, custom_headers)
    ...
    def begin_create_or_update(resource_group_name1, load_balancer_name1, parameters1, custom_headers = nil)
      ...
      unless parameters1.nil?
        parameters1 = LoadBalancer.serialize_object(parameters1)
      end
