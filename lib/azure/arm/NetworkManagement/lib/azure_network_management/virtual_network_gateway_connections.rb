...
module Azure::ARM::Network
  ...
  class VirtualNetworkGatewayConnections
    ...
    def create_or_update(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, virtual_network_gateway_connection_name1, custom_headers = nil) }
    ...
    def begin_create_or_update(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil)
      ...
      path['{virtualNetworkGatewayConnectionName}'] = ERB::Util.url_encode(virtual_network_gateway_connection_name1)
    ...
    def delete(resource_group_name1, virtual_network_gateway_connection_name1, custom_headers = nil)
      # Send request
      response = begin_delete(resource_group_name1, virtual_network_gateway_connection_name1, custom_headers = nil).value!
    ...
    def set_shared_key(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_set_shared_key(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get_shared_key(resource_group_name1, virtual_network_gateway_connection_name1, custom_headers = nil) }
    ...
    def reset_shared_key(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_reset_shared_key(resource_group_name1, virtual_network_gateway_connection_name1, parameters1, custom_headers = nil).value!
