...
module Azure::ARM::Network
  ...
  class Subnets
    ...
    def delete(resource_group_name1, virtual_network_name1, subnet_name1, custom_headers = nil)
      # Send request
      response = begin_delete(resource_group_name1, virtual_network_name1, subnet_name1, custom_headers = nil).value!
    ...
    def begin_delete(resource_group_name1, virtual_network_name1, subnet_name1, custom_headers = nil)
      ...
      path['{subnetName}'] = ERB::Util.url_encode(subnet_name1)
    ...
    def create_or_update(resource_group_name1, virtual_network_name1, subnet_name1, subnet_parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, virtual_network_name1, subnet_name1, subnet_parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, virtual_network_name1, subnet_name1, custom_headers = nil) }
