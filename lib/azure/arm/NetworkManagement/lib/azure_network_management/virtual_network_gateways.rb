...
module AzureNetworkManagement
  ...
  class VirtualNetworkGateways
    ...
    # @param virtual_network_gateway_name1 [String] The name of the virtual
    # network gateway.
    # @param parameters1 [VirtualNetworkGateway] Parameters supplied to the Begin
    ...
    #
    def create_or_update(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, virtual_network_gateway_name1, custom_headers = nil) }

      # Defining deserialization method.
      deserialize_method = lambda do |parsed_response|
        if (parsed_response)
          parsed_response = AzureNetworkManagement::Models::VirtualNetworkGateway.deserialize_object(parsed_response)
        end
      end
    ...
    # response.
    #
    def begin_create_or_update(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_gateway_name1 is nil' if virtual_network_gateway_name1.nil?
      ...
      path['{virtualNetworkGatewayName}'] = ERB::Util.url_encode(virtual_network_gateway_name1)
      ...
      if (parameters1)
        parameters1 = AzureNetworkManagement::Models::VirtualNetworkGateway.serialize_object(parameters1)
      end
    ...
    # response.
    #
    def get(resource_group_name1, virtual_network_gateway_name1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_gateway_name1 is nil' if virtual_network_gateway_name1.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
    ...
    # @return [TODO: add type] TODO: add text
    #
    def delete(resource_group_name1, virtual_network_gateway_name1, custom_headers = nil)
      # Send request
      response = begin_delete(resource_group_name1, virtual_network_gateway_name1, custom_headers = nil).value!
    ...
    # response.
    #
    def begin_delete(resource_group_name1, virtual_network_gateway_name1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_gateway_name1 is nil' if virtual_network_gateway_name1.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      promise = promise.then do |http_response|
        ...
        if status_code == 200
          begin
            parsed_response = JSON.load(response_content) unless response_content.to_s.empty?
            if (parsed_response)
              parsed_response = AzureNetworkManagement::Models::VirtualNetworkGatewayListResult.deserialize_object(parsed_response)
            end
            result.body = parsed_response
          rescue Exception => e
            fail MsRest::DeserializationError.new("Error occured in deserializing the response", e.message, e.backtrace, response_content)
    ...
    # @return [TODO: add type] TODO: add text
    #
    def reset(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_reset(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil).value!
    ...
    # response.
    #
    def begin_reset(resource_group_name1, virtual_network_gateway_name1, parameters1, custom_headers = nil)
      fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
      fail ArgumentError, 'virtual_network_gateway_name1 is nil' if virtual_network_gateway_name1.nil?
      fail ArgumentError, 'parameters1 is nil' if parameters1.nil?
      parameters1.validate unless parameters1.nil?
