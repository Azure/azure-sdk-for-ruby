...
module Azure::ARM::Network
  ...
  class LocalNetworkGateways
    ...
    def create_or_update(resource_group_name1, local_network_gateway_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, local_network_gateway_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, local_network_gateway_name1, custom_headers = nil) }
    ...
    def begin_create_or_update(resource_group_name1, local_network_gateway_name1, parameters1, custom_headers = nil)
      ...
      path['{localNetworkGatewayName}'] = ERB::Util.url_encode(local_network_gateway_name1)
    ...
    def delete(resource_group_name1, local_network_gateway_name1, custom_headers = nil)
      # Send request
      response = begin_delete(resource_group_name1, local_network_gateway_name1, custom_headers = nil).value!
