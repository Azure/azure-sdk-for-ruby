...
module Azure::ARM::Network
  ...
  class NetworkInterfaces
    ...
    def delete(resource_group_name1, network_interface_name1, custom_headers = nil)
      # Send request
      promise = begin_delete(resource_group_name1, network_interface_name1, custom_headers)
    ...
    def begin_delete(resource_group_name1, network_interface_name1, custom_headers = nil)
      ...
      path['{networkInterfaceName}'] = ERB::Util.url_encode(network_interface_name1) if path.include?('{networkInterfaceName}')
    ...
    def create_or_update(resource_group_name1, network_interface_name1, parameters1, custom_headers = nil)
      # Send request
      promise = begin_create_or_update(resource_group_name1, network_interface_name1, parameters1, custom_headers)
    ...
    def begin_create_or_update(resource_group_name1, network_interface_name1, parameters1, custom_headers = nil)
      ...
      unless parameters1.nil?
        parameters1 = NetworkInterface.serialize_object(parameters1)
      end
