...
module Azure::ARM::Resources
  ...
  class ResourceGroups
    ...
    def create_or_update(resource_group_name1, parameters1, custom_headers = nil)
      # Send request
      response = begin_create_or_update(resource_group_name1, parameters1, custom_headers = nil).value!

      # Defining polling method.
      get_method = lambda { self.get(resource_group_name1, custom_headers = nil) }

      # Defining deserialization method.
      deserialize_method = lambda do |parsed_response|
        if (parsed_response)
          parsed_response = Azure::ARM::Resources::Models::ResourceGroup.deserialize_object(parsed_response)
        end
      end
