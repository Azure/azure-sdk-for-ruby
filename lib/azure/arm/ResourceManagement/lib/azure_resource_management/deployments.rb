...
# Deployments
  ...
  class Deployments
    ...
    attr_reader :client
            ...
            # response.
            #
            def cancel(resource_group_name1, deployment_name1, custom_headers = nil)
            ...
            # name is case insensitive.
            # @param deployment_name1 [String] The name of the deployment.
            # @param parameters1 [Deployment] Deployment to validate.
            # @param @client.api_version [String] Client Api Version.
            # @param @client.subscription_id [String] Gets subscription credentials which
            # uniquely identify Microsoft Azure subscription. The subscription ID forms
            # part of the URI for every service call.
            ...
            # response.
            #
            def validate(resource_group_name1, deployment_name1, parameters1, custom_headers = nil)
              fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
              fail ArgumentError, 'deployment_name1 is nil' if deployment_name1.nil?
              ...
              if (parameters1)
                parameters1 = AzureResourceManagement::Models::Deployment.serialize_object(parameters1)
              end
              ...
              promise = promise.then do |http_response|
                ...
                if status_code == 200
                  begin
                    ...
                    if (parsed_response)
                      parsed_response = AzureResourceManagement::Models::DeploymentValidateResult.deserialize_object(parsed_response)
                    end
            ...
            # name is case insensitive.
            # @param deployment_name1 [String] The name of the deployment.
            # @param parameters1 [Deployment] Additional parameters supplied to the
            # operation.
            # @param @client.api_version [String] Client Api Version.
            # @param @client.subscription_id [String] Gets subscription credentials which
            # uniquely identify Microsoft Azure subscription. The subscription ID forms
            ...
            # response.
            #
            def create_or_update(resource_group_name1, deployment_name1, parameters1, custom_headers = nil)
              fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
              fail ArgumentError, 'deployment_name1 is nil' if deployment_name1.nil?
              fail ArgumentError, 'parameters1 is nil' if parameters1.nil?
              parameters1.validate unless parameters1.nil?
              ...
              promise = promise.then do |http_response|
                ...
                if status_code == 200
                  begin
                    parsed_response = JSON.load(response_content) unless response_content.to_s.empty?
                    if (parsed_response)
                      parsed_response = AzureResourceManagement::Models::DeploymentExtended.deserialize_object(parsed_response)
                    end
                    result.body = parsed_response
                  rescue Exception => e
                    fail MsRest::DeserializationError.new("Error occured in deserializing the response", e.message, e.backtrace, response_content)
            ...
            # response.
            #
            def get(resource_group_name1, deployment_name1, custom_headers = nil)
              fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
              fail ArgumentError, 'deployment_name1 is nil' if deployment_name1.nil?
              fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
              fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
            ...
            # @param filter1 [DeploymentExtendedFilter] The filter to apply on the
            # operation.
            ...
            # response.
            #
            def list(resource_group_name1, filter1 = nil, top1 = nil, custom_headers = nil)
              fail ArgumentError, 'resource_group_name1 is nil' if resource_group_name1.nil?
              ...
              promise = promise.then do |http_response|
                ...
                if status_code == 200
                  begin
                    parsed_response = JSON.load(response_content) unless response_content.to_s.empty?
                    if (parsed_response)
                      parsed_response = AzureResourceManagement::Models::DeploymentListResult.deserialize_object(parsed_response)
                    end
                    result.body = parsed_response
                  rescue Exception => e
                    fail MsRest::DeserializationError.new("Error occured in deserializing the response", e.message, e.backtrace, response_content)
