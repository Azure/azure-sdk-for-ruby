  ...
  module SQL
    module Mgmt
      ...
      module Models
        ...
        Sku = Azure::SQL::Mgmt::V2015_05_01_preview::Models::Sku
        ...
        Resource = Azure::SQL::Mgmt::V2015_05_01_preview::Models::Resource
        ...
        ProxyResource = Azure::SQL::Mgmt::V2015_05_01_preview::Models::ProxyResource
        ...
        AutomaticTuningOptionModeDesired = Azure::SQL::Mgmt::V2015_05_01_preview::Models::AutomaticTuningOptionModeDesired
        AutomaticTuningOptionModeActual = Azure::SQL::Mgmt::V2015_05_01_preview::Models::AutomaticTuningOptionModeActual
      ...
      class SQLManagementClass
        ...
        def initialize(configurable, base_url=nil, options=nil)
          ...
          @client_1 = Azure::SQL::Mgmt::V2017_03_01_preview::SqlManagementClient.new(configurable.credentials, base_url, options)
          if(@client_1.respond_to?(:subscription_id))
            @client_1.subscription_id = configurable.subscription_id
          end
          add_telemetry(@client_1)
          @extended_database_blob_auditing_policies = @client_1.extended_database_blob_auditing_policies
          @extended_server_blob_auditing_policies = @client_1.extended_server_blob_auditing_policies
          @server_blob_auditing_policies = @client_1.server_blob_auditing_policies
          @database_vulnerability_assessment_rule_baselines = @client_1.database_vulnerability_assessment_rule_baselines
          @database_vulnerability_assessments = @client_1.database_vulnerability_assessments
          @data_warehouse_user_activities_operations = @client_1.data_warehouse_user_activities_operations
          @job_agents = @client_1.job_agents
          @job_credentials = @client_1.job_credentials
          @job_executions = @client_1.job_executions
          @jobs = @client_1.jobs
          @job_step_executions = @client_1.job_step_executions
          @job_steps = @client_1.job_steps
          @job_target_executions = @client_1.job_target_executions
          @job_target_groups = @client_1.job_target_groups
          @job_versions = @client_1.job_versions
          @long_term_retention_backups = @client_1.long_term_retention_backups
          @backup_long_term_retention_policies = @client_1.backup_long_term_retention_policies
          @managed_backup_short_term_retention_policies = @client_1.managed_backup_short_term_retention_policies
          @managed_databases = @client_1.managed_databases
          @managed_restorable_dropped_database_backup_short_term_retention_policies = @client_1.managed_restorable_dropped_database_backup_short_term_retention_policies
          @restorable_dropped_managed_databases = @client_1.restorable_dropped_managed_databases
          @restore_points = @client_1.restore_points
          @server_automatic_tuning_operations = @client_1.server_automatic_tuning_operations
          @server_dns_aliases = @client_1.server_dns_aliases
          @server_security_alert_policies = @client_1.server_security_alert_policies
          @managed_database_security_alert_policies = @client_1.managed_database_security_alert_policies
          @managed_server_security_alert_policies = @client_1.managed_server_security_alert_policies
          @sensitivity_labels = @client_1.sensitivity_labels
          @managed_instance_administrators = @client_1.managed_instance_administrators

          @client_2 = Azure::SQL::Mgmt::V2018_06_01_preview::SqlManagementClient.new(configurable.credentials, base_url, options)
          if(@client_2.respond_to?(:subscription_id))
            @client_2.subscription_id = configurable.subscription_id
          end
          add_telemetry(@client_2)
          @database_columns = @client_2.database_columns
          @database_schemas = @client_2.database_schemas
          @database_tables = @client_2.database_tables
          @database_security_alert_policies = @client_2.database_security_alert_policies
          @managed_database_columns = @client_2.managed_database_columns
          @managed_database_schemas = @client_2.managed_database_schemas
          @managed_database_tables = @client_2.managed_database_tables
          @managed_instance_vulnerability_assessments = @client_2.managed_instance_vulnerability_assessments
          @server_vulnerability_assessments = @client_2.server_vulnerability_assessments
          @instance_pools = @client_2.instance_pools
          @managed_database_sensitivity_labels = @client_2.managed_database_sensitivity_labels
          ...
          @client_4 = Azure::SQL::Mgmt::V2015_05_01_preview::SqlManagementClient.new(configurable.credentials, base_url, options)
          if(@client_4.respond_to?(:subscription_id))
            @client_4.subscription_id = configurable.subscription_id
          end
          add_telemetry(@client_4)
          @database_advisors = @client_4.database_advisors
          @database_recommended_actions = @client_4.database_recommended_actions
          @server_advisors = @client_4.server_advisors
          @database_blob_auditing_policies = @client_4.database_blob_auditing_policies
          @database_automatic_tuning_operations = @client_4.database_automatic_tuning_operations
          @encryption_protectors = @client_4.encryption_protectors
          @failover_groups = @client_4.failover_groups
          @firewall_rules = @client_4.firewall_rules
          @managed_instances = @client_4.managed_instances
          @operations = @client_4.operations
          @server_keys = @client_4.server_keys
          @servers = @client_4.servers
          @sync_agents = @client_4.sync_agents
          @sync_groups = @client_4.sync_groups
          @sync_members = @client_4.sync_members
          @subscription_usages = @client_4.subscription_usages
          @virtual_clusters = @client_4.virtual_clusters
          @virtual_network_rules = @client_4.virtual_network_rules

          @model_classes = ModelClasses.new
        end

        def add_telemetry(client)
          profile_information = "Profiles/azure_sdk/#{Azure::VERSION}/V2019_07_01/SQL/Mgmt"
        ...
        class ModelClasses
          ...
          def sku
            Azure::SQL::Mgmt::V2015_05_01_preview::Models::Sku
          end
          ...
          def resource
            Azure::SQL::Mgmt::V2015_05_01_preview::Models::Resource
          end
          ...
          def proxy_resource
            Azure::SQL::Mgmt::V2015_05_01_preview::Models::ProxyResource
          end
          ...
          def automatic_tuning_option_mode_desired
            Azure::SQL::Mgmt::V2015_05_01_preview::Models::AutomaticTuningOptionModeDesired
          end
          def automatic_tuning_option_mode_actual
            Azure::SQL::Mgmt::V2015_05_01_preview::Models::AutomaticTuningOptionModeActual
          end
