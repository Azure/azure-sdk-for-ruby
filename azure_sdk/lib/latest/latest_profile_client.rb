...
module Azure::Profiles::Latest
  ...
  class Client
    ...
    def initialize(options = {})
      ...
      @app_configuration = AppConfigurationAdapter.new(self, base_url, sdk_options)
