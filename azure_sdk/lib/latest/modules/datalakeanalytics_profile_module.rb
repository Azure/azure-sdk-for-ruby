  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :operations, :data_lake_store_accounts, :compute_policies, :storage_accounts, :locations, :firewall_rules, :accounts, :configurable, :base_url, :options, :model_classes
