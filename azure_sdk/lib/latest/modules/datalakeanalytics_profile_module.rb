  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :accounts, :operations, :data_lake_store_accounts, :storage_accounts, :firewall_rules, :locations, :compute_policies, :configurable, :base_url, :options, :model_classes
