  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :firewall_rules, :operations, :locations, :accounts, :storage_accounts, :data_lake_store_accounts, :compute_policies, :configurable, :base_url, :options, :model_classes
