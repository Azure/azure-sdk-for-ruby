  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :operations, :compute_policies, :firewall_rules, :data_lake_store_accounts, :locations, :accounts, :storage_accounts, :configurable, :base_url, :options, :model_classes
