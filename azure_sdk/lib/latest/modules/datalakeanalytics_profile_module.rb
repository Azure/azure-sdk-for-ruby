  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :operations, :data_lake_store_accounts, :compute_policies, :accounts, :firewall_rules, :storage_accounts, :locations, :configurable, :base_url, :options, :model_classes
