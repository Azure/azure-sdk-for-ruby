  ...
  module DataLakeAnalytics
    module Mgmt
      ...
      class DataLakeAnalyticsManagementClass
        attr_reader :accounts, :firewall_rules, :locations, :storage_accounts, :operations, :data_lake_store_accounts, :compute_policies, :configurable, :base_url, :options, :model_classes
