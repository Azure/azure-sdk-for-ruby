  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :devices, :device_settings, :backup_schedules, :hardware_component_groups, :jobs, :cloud_appliances, :volumes, :volume_containers, :storage_account_credentials, :operations, :backup_policies, :managers, :access_control_records, :alerts, :backups, :bandwidth_settings, :configurable, :base_url, :options, :model_classes
