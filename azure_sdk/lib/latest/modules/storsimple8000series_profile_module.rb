  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :operations, :managers, :access_control_records, :alerts, :bandwidth_settings, :cloud_appliances, :device_settings, :backup_schedules, :hardware_component_groups, :jobs, :backups, :volumes, :devices, :storage_account_credentials, :volume_containers, :backup_policies, :configurable, :base_url, :options, :model_classes
