  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :bandwidth_settings, :operations, :cloud_appliances, :device_settings, :backup_schedules, :alerts, :volume_containers, :hardware_component_groups, :storage_account_credentials, :volumes, :backups, :jobs, :devices, :managers, :backup_policies, :access_control_records, :configurable, :base_url, :options, :model_classes
