  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :device_settings, :volume_containers, :volumes, :storage_account_credentials, :backups, :operations, :jobs, :devices, :backup_policies, :managers, :access_control_records, :alerts, :bandwidth_settings, :cloud_appliances, :backup_schedules, :hardware_component_groups, :configurable, :base_url, :options, :model_classes
