  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :alerts, :bandwidth_settings, :cloud_appliances, :devices, :device_settings, :backup_schedules, :hardware_component_groups, :volume_containers, :backups, :operations, :storage_account_credentials, :volumes, :jobs, :backup_policies, :managers, :access_control_records, :configurable, :base_url, :options, :model_classes
