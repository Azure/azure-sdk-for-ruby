  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :device_settings, :operations, :backup_schedules, :hardware_component_groups, :volume_containers, :cloud_appliances, :storage_account_credentials, :backups, :volumes, :jobs, :devices, :backup_policies, :managers, :access_control_records, :alerts, :bandwidth_settings, :configurable, :base_url, :options, :model_classes
