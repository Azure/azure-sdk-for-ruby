  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :volumes, :hardware_component_groups, :jobs, :managers, :access_control_records, :alerts, :operations, :cloud_appliances, :devices, :bandwidth_settings, :device_settings, :backup_schedules, :backup_policies, :volume_containers, :backups, :storage_account_credentials, :configurable, :base_url, :options, :model_classes
