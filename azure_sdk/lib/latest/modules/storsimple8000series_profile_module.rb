  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :operations, :backups, :jobs, :managers, :devices, :alerts, :bandwidth_settings, :cloud_appliances, :device_settings, :backup_schedules, :access_control_records, :hardware_component_groups, :volume_containers, :volumes, :storage_account_credentials, :backup_policies, :configurable, :base_url, :options, :model_classes
