  ...
  module ContainerInstance
    module Mgmt
      ...
      class ContainerInstanceManagementClass
        attr_reader :service_association_link, :container_groups, :container_group_usage, :operations, :container_operations, :configurable, :base_url, :options, :model_classes
