  ...
  module MediaServices
    module Mgmt
      ...
      class MediaServicesManagementClass
        attr_reader :streaming_endpoints, :live_events, :operations, :mediaservices, :locations, :assets, :content_key_policies, :transforms, :jobs, :streaming_policies, :streaming_locators, :live_outputs, :configurable, :base_url, :options, :model_classes
