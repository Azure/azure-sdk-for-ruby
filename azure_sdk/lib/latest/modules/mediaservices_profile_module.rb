  ...
  module MediaServices
    module Mgmt
      ...
      class MediaServicesManagementClass
        attr_reader :account_filters, :mediaservices, :operations, :assets, :asset_filters, :locations, :jobs, :content_key_policies, :streaming_locators, :live_events, :streaming_policies, :transforms, :streaming_endpoints, :live_outputs, :configurable, :base_url, :options, :model_classes
