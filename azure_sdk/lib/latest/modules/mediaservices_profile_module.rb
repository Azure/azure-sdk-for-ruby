  ...
  module MediaServices
    module Mgmt
      ...
      class MediaServicesManagementClass
        attr_reader :mediaservices, :assets, :locations, :asset_filters, :transforms, :jobs, :content_key_policies, :streaming_policies, :streaming_locators, :live_events, :live_outputs, :streaming_endpoints, :operations, :account_filters, :configurable, :base_url, :options, :model_classes
