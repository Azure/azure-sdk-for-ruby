  ...
  module Monitor
    module Mgmt
      ...
      class MonitorManagementClass
        attr_reader :activity_logs, :operations, :autoscale_settings, :tenant_activity_logs, :event_categories, :alert_rules, :alert_rule_incidents, :log_profiles, :activity_log_alerts, :diagnostic_settings_category_operations, :diagnostic_settings_operations, :metric_baseline, :metrics, :metric_definitions, :metric_alerts, :metric_alerts_status, :action_groups, :scheduled_query_rules, :configurable, :base_url, :options, :model_classes
