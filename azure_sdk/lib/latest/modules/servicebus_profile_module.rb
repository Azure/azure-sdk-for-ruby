  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :disaster_recovery_configs, :topics, :regions, :operations, :migration_configs, :queues, :rules, :premium_messaging_regions_operations, :namespaces, :subscriptions, :event_hubs, :configurable, :base_url, :options, :model_classes
