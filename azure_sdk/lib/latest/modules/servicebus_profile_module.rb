  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :premium_messaging_regions_operations, :event_hubs, :rules, :topics, :namespaces, :regions, :operations, :disaster_recovery_configs, :migration_configs, :queues, :subscriptions, :configurable, :base_url, :options, :model_classes
