  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :operations, :subscriptions, :namespaces, :disaster_recovery_configs, :topics, :event_hubs, :regions, :queues, :rules, :premium_messaging_regions_operations, :configurable, :base_url, :options, :model_classes
