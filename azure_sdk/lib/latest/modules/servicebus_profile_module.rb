  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :subscriptions, :operations, :topics, :disaster_recovery_configs, :namespaces, :queues, :rules, :premium_messaging_regions_operations, :event_hubs, :regions, :migration_configs, :configurable, :base_url, :options, :model_classes
