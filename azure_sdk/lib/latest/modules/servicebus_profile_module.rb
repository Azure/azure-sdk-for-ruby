  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :rules, :premium_messaging_regions_operations, :event_hubs, :subscriptions, :operations, :topics, :regions, :namespaces, :disaster_recovery_configs, :migration_configs, :queues, :configurable, :base_url, :options, :model_classes
