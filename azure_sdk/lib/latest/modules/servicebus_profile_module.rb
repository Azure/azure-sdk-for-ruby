  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :regions, :operations, :queues, :rules, :premium_messaging_regions_operations, :namespaces, :topics, :event_hubs, :disaster_recovery_configs, :subscriptions, :configurable, :base_url, :options, :model_classes
