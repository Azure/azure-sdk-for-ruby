  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :queues, :rules, :premium_messaging_regions_operations, :operations, :regions, :namespaces, :disaster_recovery_configs, :event_hubs, :topics, :subscriptions, :configurable, :base_url, :options, :model_classes
