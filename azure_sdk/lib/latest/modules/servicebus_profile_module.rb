  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :queues, :rules, :premium_messaging_regions_operations, :event_hubs, :subscriptions, :topics, :operations, :namespaces, :regions, :disaster_recovery_configs, :migration_configs, :configurable, :base_url, :options, :model_classes
