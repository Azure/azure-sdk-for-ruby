  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :queues, :rules, :premium_messaging_regions_operations, :event_hubs, :migration_configs, :subscriptions, :operations, :regions, :topics, :disaster_recovery_configs, :namespaces, :configurable, :base_url, :options, :model_classes
