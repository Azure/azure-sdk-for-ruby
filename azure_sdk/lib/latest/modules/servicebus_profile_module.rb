  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :operations, :regions, :namespaces, :topics, :disaster_recovery_configs, :event_hubs, :queues, :rules, :premium_messaging_regions_operations, :subscriptions, :configurable, :base_url, :options, :model_classes
