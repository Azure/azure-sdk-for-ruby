  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :queues, :rules, :premium_messaging_regions_operations, :event_hubs, :migration_configs, :operations, :topics, :namespaces, :regions, :disaster_recovery_configs, :subscriptions, :configurable, :base_url, :options, :model_classes
