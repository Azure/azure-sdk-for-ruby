  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :operations, :namespaces, :topics, :disaster_recovery_configs, :event_hubs, :queues, :rules, :premium_messaging_regions_operations, :subscriptions, :regions, :configurable, :base_url, :options, :model_classes
