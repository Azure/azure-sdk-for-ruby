  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :operations, :regions, :subscriptions, :disaster_recovery_configs, :queues, :rules, :premium_messaging_regions_operations, :namespaces, :topics, :event_hubs, :configurable, :base_url, :options, :model_classes
