  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :regions, :operations, :namespaces, :disaster_recovery_configs, :topics, :queues, :rules, :premium_messaging_regions_operations, :event_hubs, :subscriptions, :configurable, :base_url, :options, :model_classes
