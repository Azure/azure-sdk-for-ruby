  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :namespaces, :disaster_recovery_configs, :migration_configs, :queues, :operations, :subscriptions, :premium_messaging_regions_operations, :rules, :event_hubs, :topics, :regions, :configurable, :base_url, :options, :model_classes
