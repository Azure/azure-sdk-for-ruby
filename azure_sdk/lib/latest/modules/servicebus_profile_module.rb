  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :namespaces, :disaster_recovery_configs, :topics, :event_hubs, :regions, :operations, :queues, :rules, :premium_messaging_regions_operations, :subscriptions, :configurable, :base_url, :options, :model_classes
