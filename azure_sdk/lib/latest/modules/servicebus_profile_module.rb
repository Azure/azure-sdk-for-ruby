  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :topics, :subscriptions, :namespaces, :disaster_recovery_configs, :migration_configs, :queues, :rules, :premium_messaging_regions_operations, :regions, :event_hubs, :operations, :configurable, :base_url, :options, :model_classes
