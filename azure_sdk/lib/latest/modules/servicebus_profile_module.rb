  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :premium_messaging_regions_operations, :event_hubs, :subscriptions, :operations, :topics, :namespaces, :regions, :disaster_recovery_configs, :migration_configs, :queues, :rules, :configurable, :base_url, :options, :model_classes
