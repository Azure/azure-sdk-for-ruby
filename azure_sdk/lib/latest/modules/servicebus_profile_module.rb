  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :premium_messaging_regions_operations, :event_hubs, :queues, :subscriptions, :operations, :topics, :regions, :namespaces, :disaster_recovery_configs, :migration_configs, :rules, :configurable, :base_url, :options, :model_classes
