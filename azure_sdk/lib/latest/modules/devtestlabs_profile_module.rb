  ...
  module DevTestLabs
    module Mgmt
      ...
      class DevTestLabsManagementClass
        attr_reader :virtual_machines, :disks, :provider_operations, :labs, :global_schedules, :operations, :artifact_sources, :arm_templates, :artifacts, :costs, :custom_images, :formulas, :notification_channels, :gallery_images, :schedules, :policy_sets, :environments, :secrets, :virtual_machine_schedules, :service_runners, :users, :virtual_networks, :policies, :configurable, :base_url, :options, :model_classes
