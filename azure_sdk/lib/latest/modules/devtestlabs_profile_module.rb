  ...
  module DevTestLabs
    module Mgmt
      ...
      class DevTestLabsManagementClass
        attr_reader :secrets, :virtual_machine_schedules, :users, :virtual_networks, :virtual_machines, :disks, :operations, :policies, :provider_operations, :labs, :global_schedules, :artifact_sources, :arm_templates, :artifacts, :costs, :custom_images, :formulas, :notification_channels, :policy_sets, :gallery_images, :schedules, :service_runners, :environments, :configurable, :base_url, :options, :model_classes
