  ...
  module DevTestLabs
    module Mgmt
      ...
      class DevTestLabsManagementClass
        attr_reader :provider_operations, :labs, :gallery_images, :global_schedules, :artifact_sources, :arm_templates, :artifacts, :costs, :custom_images, :formulas, :notification_channels, :policy_sets, :schedules, :users, :environments, :service_runners, :secrets, :virtual_machine_schedules, :virtual_networks, :disks, :virtual_machines, :policies, :operations, :configurable, :base_url, :options, :model_classes
