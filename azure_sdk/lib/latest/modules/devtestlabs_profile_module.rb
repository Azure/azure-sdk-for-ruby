  ...
  module DevTestLabs
    module Mgmt
      ...
      class DevTestLabsManagementClass
        attr_reader :provider_operations, :labs, :global_schedules, :artifact_sources, :arm_templates, :artifacts, :costs, :custom_images, :formulas, :gallery_images, :notification_channels, :policy_sets, :service_runners, :users, :schedules, :environments, :secrets, :virtual_machine_schedules, :virtual_networks, :disks, :virtual_machines, :policies, :operations, :configurable, :base_url, :options, :model_classes
