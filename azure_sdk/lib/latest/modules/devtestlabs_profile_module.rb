  ...
  module DevTestLabs
    module Mgmt
      ...
      class DevTestLabsManagementClass
        attr_reader :gallery_images, :virtual_networks, :provider_operations, :labs, :global_schedules, :virtual_machines, :artifact_sources, :artifacts, :costs, :custom_images, :formulas, :notification_channels, :policy_sets, :schedules, :service_runners, :users, :operations, :environments, :virtual_machine_schedules, :secrets, :disks, :policies, :arm_templates, :configurable, :base_url, :options, :model_classes
