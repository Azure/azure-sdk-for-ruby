  ...
  module Web
    module Mgmt
      ...
      class WebManagementClass
        attr_reader :domains, :top_level_domains, :domain_registration_provider, :app_service_certificate_orders, :certificate_registration_provider, :diagnostics, :certificates, :provider, :deleted_web_apps, :recommendations, :resource_health_metadata_operations, :billing_meters, :web_apps, :app_service_environments, :app_service_plans, :configurable, :base_url, :options, :model_classes
