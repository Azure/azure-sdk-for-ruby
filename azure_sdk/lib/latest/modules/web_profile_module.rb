  ...
  module Web
    module Mgmt
      ...
      class WebManagementClass
        attr_reader :domains, :top_level_domains, :domain_registration_provider, :certificate_registration_provider, :app_service_certificate_orders, :provider, :certificates, :diagnostics, :deleted_web_apps, :recommendations, :web_apps, :app_service_environments, :app_service_plans, :configurable, :base_url, :options, :model_classes
