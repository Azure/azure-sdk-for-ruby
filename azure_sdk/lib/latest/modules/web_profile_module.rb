  ...
  module Web
    module Mgmt
      ...
      class WebManagementClass
        attr_reader :app_service_environments, :certificates, :app_service_plans, :provider, :domains, :diagnostics, :app_service_certificate_orders, :certificate_registration_provider, :top_level_domains, :domain_registration_provider, :deleted_web_apps, :recommendations, :web_apps, :configurable, :base_url, :options, :model_classes
