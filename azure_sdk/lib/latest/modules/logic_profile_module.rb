  ...
  module Logic
    module Mgmt
      ...
      class LogicManagementClass
        attr_reader :certificates, :workflows, :workflow_versions, :workflow_triggers, :workflow_trigger_histories, :workflow_runs, :workflow_run_actions, :integration_accounts, :schemas, :maps, :partners, :agreements, :sessions, :configurable, :base_url, :options, :model_classes
