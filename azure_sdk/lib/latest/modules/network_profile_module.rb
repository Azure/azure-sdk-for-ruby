  ...
  module Network
    module Mgmt
      ...
      class NetworkManagementClass
        attr_reader :load_balancer_frontend_ipconfigurations, :inbound_nat_rules, :load_balancer_load_balancing_rules, :load_balancer_network_interfaces, :load_balancer_probes, :network_interface_ipconfigurations, :network_interface_load_balancers, :network_security_groups, :security_rules, :network_watchers, :network_interfaces, :connection_monitors, :packet_captures, :default_security_rules, :load_balancers, :route_filter_rules, :bgp_service_communities, :route_filters, :express_route_circuits, :express_route_service_providers, :routes, :usages, :virtual_networks, :subnets, :public_ipaddresses, :route_tables, :local_network_gateways, :virtual_network_peerings, :virtual_network_gateways, :virtual_network_gateway_connections, :operations, :application_gateways, :express_route_circuit_authorizations, :express_route_circuit_peerings, :application_security_groups, :available_endpoint_services, :load_balancer_backend_address_pools, :configurable, :base_url, :options, :model_classes
