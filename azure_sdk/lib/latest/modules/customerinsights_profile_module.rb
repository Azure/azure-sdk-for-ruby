  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :hubs, :operations, :interactions, :relationships, :relationship_links, :authorization_policies, :profiles, :connector_mappings, :connectors, :widget_types, :kpi, :roles, :views, :role_assignments, :predictions, :images, :links, :configurable, :base_url, :options, :model_classes
