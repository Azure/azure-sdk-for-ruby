  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :hubs, :interactions, :relationships, :relationship_links, :profiles, :authorization_policies, :operations, :connector_mappings, :connectors, :widget_types, :kpi, :roles, :views, :role_assignments, :predictions, :links, :images, :configurable, :base_url, :options, :model_classes
