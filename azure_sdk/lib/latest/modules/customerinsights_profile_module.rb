  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :hubs, :interactions, :relationships, :relationship_links, :authorization_policies, :connectors, :connector_mappings, :profiles, :operations, :widget_types, :kpi, :roles, :views, :links, :role_assignments, :images, :predictions, :configurable, :base_url, :options, :model_classes
