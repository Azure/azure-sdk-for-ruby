  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :predictions, :images, :links, :operations, :role_assignments, :hubs, :profiles, :interactions, :relationship_links, :authorization_policies, :connectors, :connector_mappings, :kpi, :relationships, :widget_types, :views, :roles, :configurable, :base_url, :options, :model_classes
