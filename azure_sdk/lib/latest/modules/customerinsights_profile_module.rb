  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :hubs, :interactions, :relationships, :relationship_links, :authorization_policies, :connectors, :connector_mappings, :kpi, :profiles, :widget_types, :views, :links, :predictions, :roles, :role_assignments, :images, :operations, :configurable, :base_url, :options, :model_classes
