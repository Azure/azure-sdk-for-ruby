  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :relationship_links, :authorization_policies, :connectors, :connector_mappings, :kpi, :widget_types, :profiles, :views, :operations, :predictions, :roles, :links, :role_assignments, :images, :hubs, :interactions, :relationships, :configurable, :base_url, :options, :model_classes
