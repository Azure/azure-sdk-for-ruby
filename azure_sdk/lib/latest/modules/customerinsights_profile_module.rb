  ...
  module CustomerInsights
    module Mgmt
      ...
      class CustomerInsightsManagementClass
        attr_reader :operations, :hubs, :interactions, :profiles, :relationship_links, :authorization_policies, :relationships, :connectors, :connector_mappings, :kpi, :widget_types, :views, :roles, :predictions, :role_assignments, :images, :links, :configurable, :base_url, :options, :model_classes
