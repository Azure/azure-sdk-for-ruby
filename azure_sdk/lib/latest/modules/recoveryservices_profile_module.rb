  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :usages, :vault_certificates, :vaults, :registered_identities, :vault_extended_info_operations, :replication_usages, :operations, :configurable, :base_url, :options, :model_classes
