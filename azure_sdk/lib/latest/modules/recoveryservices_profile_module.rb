  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :vaults, :replication_usages, :usages, :vault_certificates, :operations, :registered_identities, :vault_extended_info_operations, :configurable, :base_url, :options, :model_classes
