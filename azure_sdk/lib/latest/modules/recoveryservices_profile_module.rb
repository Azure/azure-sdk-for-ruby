  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :vault_extended_info_operations, :usages, :recovery_services, :registered_identities, :replication_usages, :operations, :vaults, :vault_certificates, :configurable, :base_url, :options, :model_classes
