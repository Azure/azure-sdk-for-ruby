  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :usages, :vaults, :operations, :registered_identities, :vault_extended_info_operations, :replication_usages, :vault_certificates, :configurable, :base_url, :options, :model_classes
