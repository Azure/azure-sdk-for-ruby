  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :replication_usages, :vault_extended_info_operations, :usages, :vaults, :operations, :vault_certificates, :registered_identities, :configurable, :base_url, :options, :model_classes
