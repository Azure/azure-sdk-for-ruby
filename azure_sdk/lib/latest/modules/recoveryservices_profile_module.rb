  ...
  module RecoveryServices
    module Mgmt
      ...
      class RecoveryServicesManagementClass
        attr_reader :vaults, :operations, :registered_identities, :vault_extended_info_operations, :replication_usages, :vault_certificates, :usages, :configurable, :base_url, :options, :model_classes
