...
module Azure::ARM
  class Client
    ...
    @@supported_clients = {
        ...
        :datalake_analytics_account => 'Azure::ARM::DataLakeAnalytics::Account::DataLakeAnalyticsAccountManagementClient',
        :datalake_store_account => 'Azure::ARM::DataLakeStore::Account::DataLakeStoreAccountManagementClient',
