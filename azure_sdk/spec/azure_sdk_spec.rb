...
describe 'Azure Sdk' do
  describe 'Management plane' do
    ...
    def verify_management_clients(arm_client)
      ...
      expect(arm_client.datalake_analytics_account).to be_instance_of(Azure::ARM::DataLakeAnalytics::Account::DataLakeAnalyticsAccountManagementClient)
      expect(arm_client.datalake_store_account).to be_instance_of(Azure::ARM::DataLakeStore::Account::DataLakeStoreAccountManagementClient)
