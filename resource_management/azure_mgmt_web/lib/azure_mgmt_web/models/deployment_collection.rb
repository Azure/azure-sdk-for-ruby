...
module Azure::ARM::Web
  module Models
    ...
    class DeploymentCollection
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = Deployment.serialize_object(element)
            end
      ...
      # @return [DeploymentCollection] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = DeploymentCollection.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = Deployment.deserialize_object(element1)
            end
