...
module Azure::ARM::Compute
  module Models
    ...
    class VirtualMachineScaleSetVMInstanceRequiredIDs
      ...
      #
      def validate
        fail MsRest::ValidationError, 'property instance_ids is nil' if @instance_ids.nil?
      ...
      # @return [VirtualMachineScaleSetVMInstanceRequiredIDs] Deserialized
      # object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = VirtualMachineScaleSetVMInstanceRequiredIDs.new
