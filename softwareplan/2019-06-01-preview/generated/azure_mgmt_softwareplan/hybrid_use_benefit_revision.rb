...
module Microsoft.SoftwarePlan
  ...
  #
  class HybridUseBenefitRevision
    include MsRestAzure

    #
    # Creates and initializes a new instance of the HybridUseBenefitRevision class.
    ...
    #
    def list(scope, plan_id, custom_headers:nil)
      first_page = list_as_lazy(scope, plan_id, custom_headers:custom_headers)
    ...
    #
    def list_with_http_info(scope, plan_id, custom_headers:nil)
      list_async(scope, plan_id, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_async(scope, plan_id, custom_headers:nil)
      ...
      path_template = '{scope}/providers/Microsoft.SoftwarePlan/hybridUseBenefits/{planId}/revisions'
    ...
    # the response.
    #
    def list_as_lazy(scope, plan_id, custom_headers:nil)
      response = list_async(scope, plan_id, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
