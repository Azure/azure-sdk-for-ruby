...
module Microsoft.Portal
  ...
  class Dashboards
    ...
    def create_or_update(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      response = create_or_update_async(resource_group_name, dashboard_name, dashboard, custom_headers).value!
    ...
    def create_or_update_with_http_info(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      create_or_update_async(resource_group_name, dashboard_name, dashboard, custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Microsoft.Portal::Models::Dashboard.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Microsoft.Portal::Models::Dashboard.mapper()
    ...
    def delete(resource_group_name, dashboard_name, custom_headers = nil)
      response = delete_async(resource_group_name, dashboard_name, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, dashboard_name, custom_headers = nil)
      delete_async(resource_group_name, dashboard_name, custom_headers).value!
    end
    ...
    def get(resource_group_name, dashboard_name, custom_headers = nil)
      response = get_async(resource_group_name, dashboard_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_with_http_info(resource_group_name, dashboard_name, custom_headers = nil)
      get_async(resource_group_name, dashboard_name, custom_headers).value!
    end
    ...
    def update(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      response = update_async(resource_group_name, dashboard_name, dashboard, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      update_async(resource_group_name, dashboard_name, dashboard, custom_headers).value!
    end
    ...
    def update_async(resource_group_name, dashboard_name, dashboard, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Microsoft.Portal::Models::PatchableDashboard.mapper()
      request_content = @client.serialize(request_mapper,  dashboard)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Microsoft.Portal::Models::DashboardListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
