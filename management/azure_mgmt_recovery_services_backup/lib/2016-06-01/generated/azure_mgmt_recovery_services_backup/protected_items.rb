...
module Azure::RecoveryServicesBackup::Mgmt::V2016_06_01
  ...
  class ProtectedItems
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_06_01::Models::ProtectedItemResourceList.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(vault_name, resource_group_name, fabric_name, container_name, protected_item_name, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_06_01::Models::ProtectedItemResource.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(vault_name, resource_group_name, fabric_name, container_name, protected_item_name, resource_protected_item, custom_headers = nil)
      ...
      # Serialize Request
      request_content = resource_protected_item.nil? ? nil: resource_protected_item.to_json
