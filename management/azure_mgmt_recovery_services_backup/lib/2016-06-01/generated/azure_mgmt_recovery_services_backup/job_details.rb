...
module Azure::RecoveryServicesBackup::Mgmt::V2016_06_01
  ...
  class JobDetails
    ...
    def get_with_http_info(vault_name, resource_group_name, job_name, custom_headers = nil)
      get_async(vault_name, resource_group_name, job_name, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_06_01::Models::JobResource.new.from_json(parsed_response)
          rescue Exception => e
