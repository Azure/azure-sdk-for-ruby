...
module Azure::RecoveryServicesBackup::Mgmt::V2016_06_01
  ...
  class ProtectionPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_06_01::Models::ProtectionPolicyResource.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(vault_name, resource_group_name, policy_name, resource_protection_policy, custom_headers = nil)
      ...
      # Serialize Request
      request_content = resource_protection_policy.nil? ? nil: resource_protection_policy.to_json
    ...
    def list_async(vault_name, resource_group_name, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_06_01::Models::ProtectionPolicyResourceList.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
