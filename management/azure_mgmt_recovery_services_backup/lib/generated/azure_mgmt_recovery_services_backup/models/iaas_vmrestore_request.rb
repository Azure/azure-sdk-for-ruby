...
module Azure::ARM::RecoveryServicesBackup
  module Models
    ...
    class IaasVMRestoreRequest < RestoreRequest
      ...
      # @return [String] This is the ARM Id of the resource group that you
      # want to create for this Virtual machine and other artifacts.
      # For e.g. /subscriptions/{subId}/resourcegroups/{rg}
      attr_accessor :target_resource_group_id

      # @return [String] Fully qualified ARM ID of the storage account to
      ...
      # User will be validated for join action permissions in the
      # linked access.
      ...
      # @return [Boolean] Should a new cloud service be created while
      # restoring the VM. If this is false, VM will be restored to the same
