...
module Azure::ARM::RecoveryServicesBackup
  ...
  class BackupEngines
    ...
    def get_async(vault_name, resource_group_name, filter = nil, skip_token = nil, custom_headers = nil)
      ...
      path_template = '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/RecoveryServices/vaults/{vaultName}/backupEngines'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = BackupEngineBaseResourceList.mapper()
