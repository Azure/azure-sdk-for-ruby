...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  module Models
    ...
    class AzureVmWorkloadSAPAseDatabaseProtectableItem < AzureVmWorkloadProtectableItem
      ...
      #
      # Mapper for AzureVmWorkloadSAPAseDatabaseProtectableItem class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          required: false,
          serialized_name: 'SAPAseDatabase',
          type: {
            name: 'Composite',
            class_name: 'AzureVmWorkloadSAPAseDatabaseProtectableItem',
            model_properties: {
