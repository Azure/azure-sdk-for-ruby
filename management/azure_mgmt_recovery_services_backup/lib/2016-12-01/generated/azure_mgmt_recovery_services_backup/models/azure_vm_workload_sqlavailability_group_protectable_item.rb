...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  module Models
    ...
    class AzureVmWorkloadSQLAvailabilityGroupProtectableItem < AzureVmWorkloadProtectableItem
      ...
      #
      # Mapper for AzureVmWorkloadSQLAvailabilityGroupProtectableItem class as
      # Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SQLAvailabilityGroupContainer',
          type: {
            name: 'Composite',
            class_name: 'AzureVmWorkloadSQLAvailabilityGroupProtectableItem',
            model_properties: {
