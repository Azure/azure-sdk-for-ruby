...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  module Models
    ...
    class AzureVmWorkloadSAPAseDatabaseProtectedItem < AzureVmWorkloadProtectedItem
      ...
      #
      # Mapper for AzureVmWorkloadSAPAseDatabaseProtectedItem class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          required: false,
          serialized_name: 'AzureVmWorkloadSAPAseDatabase',
          type: {
            name: 'Composite',
            class_name: 'AzureVmWorkloadSAPAseDatabaseProtectedItem',
            model_properties: {
