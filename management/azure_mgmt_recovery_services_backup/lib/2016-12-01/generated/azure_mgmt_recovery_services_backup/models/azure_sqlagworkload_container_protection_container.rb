...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  module Models
    ...
    class AzureSQLAGWorkloadContainerProtectionContainer < AzureWorkloadContainer
      ...
      #
      # Mapper for AzureSQLAGWorkloadContainerProtectionContainer class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SQLAGWorkLoadContainer',
          type: {
            name: 'Composite',
            class_name: 'AzureSQLAGWorkloadContainerProtectionContainer',
            model_properties: {
              friendly_name: {
                client_side_validation: true,
                required: false,
