...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  ...
  class BackupResourceStorageConfigs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_12_01::Models::BackupResourceConfigResource.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def update(vault_name, resource_group_name, custom_headers = nil)
      response = update_async(vault_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def update_with_http_info(vault_name, resource_group_name, custom_headers = nil)
      update_async(vault_name, resource_group_name, custom_headers).value!
    end
