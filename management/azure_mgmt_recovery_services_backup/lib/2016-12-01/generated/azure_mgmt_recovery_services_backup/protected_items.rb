...
module Azure::ARM::RecoveryServicesBackup::Api_2016_12_01
  ...
  class ProtectedItems
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::RecoveryServicesBackup::Api_2016_12_01::Models::ProtectedItemResource.mapper()
    ...
    def create_or_update_async(vault_name, resource_group_name, fabric_name, container_name, protected_item_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesBackup::Api_2016_12_01::Models::ProtectedItemResource.mapper()
