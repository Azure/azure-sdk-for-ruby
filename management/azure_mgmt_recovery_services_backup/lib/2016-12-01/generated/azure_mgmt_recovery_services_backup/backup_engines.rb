...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  ...
  class BackupEngines
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_12_01::Models::BackupEngineBaseResourceList.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get(vault_name, resource_group_name, backup_engine_name, filter = nil, skip_token = nil, custom_headers = nil)
      response = get_async(vault_name, resource_group_name, backup_engine_name, filter, skip_token, custom_headers).value!
    ...
    def get_with_http_info(vault_name, resource_group_name, backup_engine_name, filter = nil, skip_token = nil, custom_headers = nil)
      get_async(vault_name, resource_group_name, backup_engine_name, filter, skip_token, custom_headers).value!
    end
    ...
    def get_async(vault_name, resource_group_name, backup_engine_name, filter = nil, skip_token = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesBackup::Mgmt::V2016_12_01::Models::BackupEngineBaseResource.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
