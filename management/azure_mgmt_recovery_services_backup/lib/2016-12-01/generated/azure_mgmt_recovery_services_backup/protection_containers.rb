...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  ...
  class ProtectionContainers
    ...
    def register(vault_name, resource_group_name, fabric_name, container_name, parameters, custom_headers = nil)
      response = register_async(vault_name, resource_group_name, fabric_name, container_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def register_with_http_info(vault_name, resource_group_name, fabric_name, container_name, parameters, custom_headers = nil)
      register_async(vault_name, resource_group_name, fabric_name, container_name, parameters, custom_headers).value!
    end
    ...
    def unregister(vault_name, resource_group_name, fabric_name, container_name, custom_headers = nil)
      response = unregister_async(vault_name, resource_group_name, fabric_name, container_name, custom_headers).value!
      nil
    end
    ...
    def unregister_with_http_info(vault_name, resource_group_name, fabric_name, container_name, custom_headers = nil)
      unregister_async(vault_name, resource_group_name, fabric_name, container_name, custom_headers).value!
    end
    ...
    def inquire(vault_name, resource_group_name, fabric_name, container_name, filter = nil, custom_headers = nil)
      response = inquire_async(vault_name, resource_group_name, fabric_name, container_name, filter, custom_headers).value!
      nil
    end
    ...
    def inquire_with_http_info(vault_name, resource_group_name, fabric_name, container_name, filter = nil, custom_headers = nil)
      inquire_async(vault_name, resource_group_name, fabric_name, container_name, filter, custom_headers).value!
    end
    ...
    def refresh(vault_name, resource_group_name, fabric_name, filter = nil, custom_headers = nil)
      response = refresh_async(vault_name, resource_group_name, fabric_name, filter, custom_headers).value!
      nil
    end
    ...
    def refresh_with_http_info(vault_name, resource_group_name, fabric_name, filter = nil, custom_headers = nil)
      refresh_async(vault_name, resource_group_name, fabric_name, filter, custom_headers).value!
    end
