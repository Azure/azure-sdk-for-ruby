...
module Azure::ARM::AnalysisServices::Api_2016_05_16
  ...
  class Servers
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::AnalysisServicesServer.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::AnalysisServicesServers.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_skus_for_new_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::SkuEnumerationForNewResourceResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_skus_for_existing_async(resource_group_name, server_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::SkuEnumerationForExistingResourceResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, server_name, server_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::AnalysisServicesServer.mapper()
    ...
    def begin_update_async(resource_group_name, server_name, server_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::AnalysisServices::Api_2016_05_16::Models::AnalysisServicesServerUpdateParameters.mapper()
