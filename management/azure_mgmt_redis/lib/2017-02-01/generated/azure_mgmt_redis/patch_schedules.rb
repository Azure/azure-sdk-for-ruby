...
module Azure::ARM::Redis::Api_2017_02_01
  ...
  class PatchSchedules
    ...
    def create_or_update_async(resource_group_name, name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Redis::Api_2017_02_01::Models::RedisPatchSchedule.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Redis::Api_2017_02_01::Models::RedisPatchSchedule.mapper()
