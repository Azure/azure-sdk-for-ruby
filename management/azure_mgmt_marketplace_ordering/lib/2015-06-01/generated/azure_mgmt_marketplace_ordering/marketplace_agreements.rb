...
module Azure::MarketplaceOrdering::Mgmt::V2015_06_01
  ...
  class MarketplaceAgreements
    ...
    def sign(publisher_id, offer_id, plan_id, custom_headers = nil)
      response = sign_async(publisher_id, offer_id, plan_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def sign_with_http_info(publisher_id, offer_id, plan_id, custom_headers = nil)
      sign_async(publisher_id, offer_id, plan_id, custom_headers).value!
    end
    ...
    def cancel(publisher_id, offer_id, plan_id, custom_headers = nil)
      response = cancel_async(publisher_id, offer_id, plan_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def cancel_with_http_info(publisher_id, offer_id, plan_id, custom_headers = nil)
      cancel_async(publisher_id, offer_id, plan_id, custom_headers).value!
    end
    ...
    def get_agreement(publisher_id, offer_id, plan_id, custom_headers = nil)
      response = get_agreement_async(publisher_id, offer_id, plan_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_agreement_with_http_info(publisher_id, offer_id, plan_id, custom_headers = nil)
      get_agreement_async(publisher_id, offer_id, plan_id, custom_headers).value!
    end
