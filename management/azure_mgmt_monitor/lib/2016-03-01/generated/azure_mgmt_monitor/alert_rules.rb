...
module Azure::Monitor::Mgmt::V2016_03_01
  ...
  class AlertRules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Monitor::Mgmt::V2016_03_01::Models::AlertRuleResource.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def update_async(resource_group_name, rule_name, alert_rules_resource, custom_headers = nil)
      ...
      # Serialize Request
      request_content = alert_rules_resource.nil? ? nil: alert_rules_resource.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Monitor::Mgmt::V2016_03_01::Models::AlertRuleResourceCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
