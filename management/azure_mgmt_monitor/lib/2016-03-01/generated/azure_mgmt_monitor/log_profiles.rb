...
module Azure::ARM::Monitor::Api_2016_03_01
  ...
  class LogProfiles
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Monitor::Api_2016_03_01::Models::LogProfileResource.mapper()
    ...
    def create_or_update_async(log_profile_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Monitor::Api_2016_03_01::Models::LogProfileResource.mapper()
    ...
    def update_async(log_profile_name, log_profiles_resource, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Monitor::Api_2016_03_01::Models::LogProfileResourcePatch.mapper()
    ...
    def list_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Monitor::Api_2016_03_01::Models::LogProfileCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
