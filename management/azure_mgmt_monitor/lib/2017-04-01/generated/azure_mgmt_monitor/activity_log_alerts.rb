...
module Azure::ARM::Monitor::Api_2017_04_01
  ...
  class ActivityLogAlerts
    ...
    def create_or_update_async(resource_group_name, activity_log_alert_name, activity_log_alert, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Monitor::Api_2017_04_01::Models::ActivityLogAlertResource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Monitor::Api_2017_04_01::Models::ActivityLogAlertResource.mapper()
    ...
    def update_async(resource_group_name, activity_log_alert_name, activity_log_alert_patch, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Monitor::Api_2017_04_01::Models::ActivityLogAlertPatchBody.mapper()
    ...
    def list_by_subscription_id_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Monitor::Api_2017_04_01::Models::ActivityLogAlertList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
