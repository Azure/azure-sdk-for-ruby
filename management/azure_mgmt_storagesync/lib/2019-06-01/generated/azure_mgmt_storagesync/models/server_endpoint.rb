...
module Azure::StorageSync::Mgmt::V2019_06_01
  module Models
    ...
    class ServerEndpoint < ProxyResource
      ...
      # @return [ServerEndpointCloudTieringStatus] Cloud tiering status. Only
      # populated if cloud tiering is enabled.
      attr_accessor :cloud_tiering_status

      # @return [ServerEndpointRecallStatus] Recall status. Only populated if
      # cloud tiering is enabled.
      attr_accessor :recall_status
