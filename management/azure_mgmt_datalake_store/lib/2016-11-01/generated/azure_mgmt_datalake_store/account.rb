...
module Azure::ARM::DataLakeStore::Api_2016_11_01
  ...
  class Account
    ...
    def create_async(resource_group_name, name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ARM::DataLakeStore::Api_2016_11_01::Models::DataLakeStoreAccount.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, filter = nil, top = nil, skip = nil, select = nil, orderby = nil, count = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DataLakeStore::Api_2016_11_01::Models::DataLakeStoreAccountListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DataLakeStore::Api_2016_11_01::Models::DataLakeStoreAccount.mapper()
    ...
    def begin_update_async(resource_group_name, name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DataLakeStore::Api_2016_11_01::Models::DataLakeStoreAccountUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
