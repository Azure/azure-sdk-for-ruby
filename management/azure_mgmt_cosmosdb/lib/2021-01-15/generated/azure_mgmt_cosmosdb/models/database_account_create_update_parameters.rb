...
module Azure::Cosmosdb::Mgmt::V2021_01_15
  module Models
    ...
    class DatabaseAccountCreateUpdateParameters < ARMResourceProperties
      ...
      # @return [NetworkAclBypass] Indicates what services are allowed to
      # bypass firewall checks. Possible values include: 'None',
      # 'AzureServices'
      attr_accessor :network_acl_bypass

      # @return [Array<String>] An array that contains the Resource Ids for
      # Network Acl Bypass for the Cosmos DB account.
      attr_accessor :network_acl_bypass_resource_ids
