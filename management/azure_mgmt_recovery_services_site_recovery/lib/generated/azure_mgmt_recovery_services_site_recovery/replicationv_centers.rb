...
module Azure::ARM::RecoveryServicesSiteRecovery
  ...
  class ReplicationvCenters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Models::VCenter.mapper()
    ...
    def list_by_replication_fabrics_async(fabric_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Models::VCenterCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(fabric_name, v_center_name, add_vcenter_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Models::AddVCenterRequest.mapper()
    ...
    def begin_update_async(fabric_name, v_center_name, update_vcenter_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Models::UpdateVCenterRequest.mapper()
