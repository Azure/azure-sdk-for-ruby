...
module Azure
  module Profiles
    module RecoveryServicesSiteRecoveryModule
    module Management
      module Profile_2016_08_10
        #
        ...
        class Client
          ...
          def initialize(options = {})
            ...
            self.recoveryservicessiterecovery = RecoveryServicesSiteRecovery::RecoveryServicesSiteRecovery.new(self, nil, nil)
          end
