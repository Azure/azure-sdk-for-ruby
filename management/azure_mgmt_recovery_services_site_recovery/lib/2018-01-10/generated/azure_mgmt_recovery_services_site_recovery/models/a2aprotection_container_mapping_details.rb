...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2018_01_10
  module Models
    ...
    class A2AProtectionContainerMappingDetails < ProtectionContainerMappingProviderSpecificDetails
      ...
      # @return [String] The schedule arm name.
      attr_accessor :schedule_name

      # @return [String] The job schedule arm name.
      attr_accessor :job_schedule_name


      #
      # Mapper for A2AProtectionContainerMappingDetails class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          type: {
            name: 'Composite',
            class_name: 'A2AProtectionContainerMappingDetails',
            model_properties: {
              instanceType: {
                client_side_validation: true,
                required: true,
