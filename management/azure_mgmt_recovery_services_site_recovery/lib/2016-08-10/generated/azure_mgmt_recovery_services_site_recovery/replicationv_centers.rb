...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10
  ...
  class ReplicationvCenters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::VCenter.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(fabric_name, v_center_name, add_vcenter_request, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::VCenter.new.from_json(parsed_response)
        end
    ...
    def list_by_replication_fabrics_async(fabric_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::VCenterCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_async(fabric_name, v_center_name, add_vcenter_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = add_vcenter_request.nil? ? nil: add_vcenter_request.to_json
    ...
    def begin_update_async(fabric_name, v_center_name, update_vcenter_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = update_vcenter_request.nil? ? nil: update_vcenter_request.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
