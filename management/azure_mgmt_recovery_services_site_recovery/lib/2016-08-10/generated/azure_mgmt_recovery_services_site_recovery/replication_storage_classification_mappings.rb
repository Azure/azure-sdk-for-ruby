...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10
  ...
  class ReplicationStorageClassificationMappings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::StorageClassificationMapping.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(fabric_name, storage_classification_name, storage_classification_mapping_name, pairing_input, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::StorageClassificationMapping.new.from_json(parsed_response)
        end
    ...
    def list_by_replication_storage_classifications_async(fabric_name, storage_classification_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::StorageClassificationMappingCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_async(fabric_name, storage_classification_name, storage_classification_mapping_name, pairing_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = pairing_input.nil? ? nil: pairing_input.to_json
