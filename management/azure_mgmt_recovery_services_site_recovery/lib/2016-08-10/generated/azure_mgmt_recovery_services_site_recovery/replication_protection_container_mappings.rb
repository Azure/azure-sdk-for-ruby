...
module Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10
  ...
  class ReplicationProtectionContainerMappings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::ProtectionContainerMapping.mapper()
    ...
    def list_by_replication_protection_containers_async(fabric_name, protection_container_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::ProtectionContainerMappingCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_delete_async(fabric_name, protection_container_name, mapping_name, removal_input, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::RemoveProtectionContainerMappingInput.mapper()
    ...
    def begin_create_async(fabric_name, protection_container_name, mapping_name, creation_input, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::CreateProtectionContainerMappingInput.mapper()
