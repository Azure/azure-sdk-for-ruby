  ...
  class ReplicationProtectionContainerMappings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainerMapping.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(fabric_name, protection_container_name, mapping_name, creation_input, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainerMapping.new.from_json(parsed_response)
        end
    ...
    def list_by_replication_protection_containers_async(fabric_name, protection_container_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainerMappingCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_delete_async(fabric_name, protection_container_name, mapping_name, removal_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = removal_input.nil? ? nil: removal_input.to_json
