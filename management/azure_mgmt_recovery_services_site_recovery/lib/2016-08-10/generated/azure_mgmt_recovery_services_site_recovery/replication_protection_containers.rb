...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10
  ...
  class ReplicationProtectionContainers
    ...
    def switch_protection_async(fabric_name, protection_container_name, switch_input, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainer.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainer.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_replication_fabrics_async(fabric_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10::Models::ProtectionContainerCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_switch_protection_async(fabric_name, protection_container_name, switch_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = switch_input.nil? ? nil: switch_input.to_json
    ...
    def begin_discover_protectable_item_async(fabric_name, protection_container_name, discover_protectable_item_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = discover_protectable_item_request.nil? ? nil: discover_protectable_item_request.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_create_async(fabric_name, protection_container_name, creation_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = creation_input.nil? ? nil: creation_input.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
