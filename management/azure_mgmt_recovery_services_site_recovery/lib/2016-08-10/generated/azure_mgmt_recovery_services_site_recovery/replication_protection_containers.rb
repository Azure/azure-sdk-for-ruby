...
module Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10
  ...
  class ReplicationProtectionContainers
    ...
    def switch_protection_async(fabric_name, protection_container_name, switch_input, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::ProtectionContainer.mapper()
    ...
    def list_by_replication_fabrics_async(fabric_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::ProtectionContainerCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_switch_protection_async(fabric_name, protection_container_name, switch_input, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::SwitchProtectionInput.mapper()
    ...
    def begin_discover_protectable_item_async(fabric_name, protection_container_name, discover_protectable_item_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::DiscoverProtectableItemRequest.mapper()
    ...
    def begin_create_async(fabric_name, protection_container_name, creation_input, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServicesSiteRecovery::Api_2016_08_10::Models::CreateProtectionContainerInput.mapper()
