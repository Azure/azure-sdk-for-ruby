...
module Azure::Network::Mgmt::V2015_05_01_preview
  ...
  class NetworkManagementClient < MsRestAzure::AzureServiceClient
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2015_05_01_preview::Models::DnsNameAvailabilityResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def add_telemetry
        ...
        if defined? Azure::Network::Mgmt::V2015_05_01_preview::VERSION
          sdk_information = "#{sdk_information}/#{Azure::Network::Mgmt::V2015_05_01_preview::VERSION}"
        end
