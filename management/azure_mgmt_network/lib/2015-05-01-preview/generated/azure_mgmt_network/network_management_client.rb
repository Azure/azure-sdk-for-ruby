...
module Azure::ARM::Network::Api_2015_05_01_preview
  ...
  class NetworkManagementClient < MsRestAzure::AzureServiceClient
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Network::Api_2015_05_01_preview::Models::DnsNameAvailabilityResult.mapper()
    ...
    def add_telemetry
        ...
        if defined? Azure::ARM::Network::Api_2015_05_01_preview::VERSION
          sdk_information = "#{sdk_information}/#{Azure::ARM::Network::Api_2015_05_01_preview::VERSION}"
        end
