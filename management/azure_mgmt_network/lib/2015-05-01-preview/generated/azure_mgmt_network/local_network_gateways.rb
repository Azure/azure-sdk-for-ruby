    ...
    def create_or_update_async(resource_group_name, local_network_gateway_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2015_05_01_preview::Models::LocalNetworkGateway.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2015_05_01_preview::Models::LocalNetworkGateway.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2015_05_01_preview::Models::LocalNetworkGatewayListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
