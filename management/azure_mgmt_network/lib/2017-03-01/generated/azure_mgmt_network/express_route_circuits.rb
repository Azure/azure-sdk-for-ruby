  ...
  class ExpressRouteCircuits
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuit.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, circuit_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuit.new.from_json(parsed_response)
        end
    ...
    def list_arp_table_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsArpTableListResult.new.from_json(parsed_response)
        end
    ...
    def list_routes_table_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsRoutesTableListResult.new.from_json(parsed_response)
        end
    ...
    def list_routes_table_summary_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsRoutesTableSummaryListResult.new.from_json(parsed_response)
        end
    ...
    def get_stats_async(resource_group_name, circuit_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitStats.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_list_arp_table_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsArpTableListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_list_routes_table_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsRoutesTableListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_list_routes_table_summary_async(resource_group_name, circuit_name, peering_name, device_path, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_03_01::Models::ExpressRouteCircuitsRoutesTableSummaryListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
