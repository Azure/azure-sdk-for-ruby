...
module Azure::ARM::Network
  ...
  class VirtualNetworkGateways
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def reset_with_http_info(resource_group_name, virtual_network_gateway_name, gateway_vip = nil, custom_headers = nil)
      reset_async(resource_group_name, virtual_network_gateway_name, gateway_vip, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def get_bgp_peer_status_with_http_info(resource_group_name, virtual_network_gateway_name, peer = nil, custom_headers = nil)
      get_bgp_peer_status_async(resource_group_name, virtual_network_gateway_name, peer, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def get_learned_routes_with_http_info(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      get_learned_routes_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def get_advertised_routes_with_http_info(resource_group_name, virtual_network_gateway_name, peer, custom_headers = nil)
      get_advertised_routes_async(resource_group_name, virtual_network_gateway_name, peer, custom_headers).value!
    end
