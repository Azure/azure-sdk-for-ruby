...
module Azure::ARM::Network
  ...
  class NetworkInterfaces
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<EffectiveRoute>] which provide lazy access to pages of the
    # response.
    #
    def get_effective_route_table(resource_group_name, network_interface_name, custom_headers = nil)
      ...
      unless response.nil?
        ...
        page.next_method = Proc.new do |next_page_link|
          get_effective_route_table_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<EffectiveNetworkSecurityGroup>] which provide lazy access to
    ...
    def list_effective_network_security_groups(resource_group_name, network_interface_name, custom_headers = nil)
      ...
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_effective_network_security_groups_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
    ...
    def begin_get_effective_route_table_as_lazy(resource_group_name, network_interface_name, custom_headers = nil)
      ...
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          begin_get_effective_route_table_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
    ...
    def begin_list_effective_network_security_groups_as_lazy(resource_group_name, network_interface_name, custom_headers = nil)
      ...
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          begin_list_effective_network_security_groups_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
