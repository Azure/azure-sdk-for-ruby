  ...
  class RouteFilters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2017_09_01::Models::RouteFilter.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2017_09_01::Models::RouteFilter.new.from_json(parsed_response)
        end
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2017_09_01::Models::RouteFilterListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = route_filter_parameters.nil? ? nil: route_filter_parameters.to_json
