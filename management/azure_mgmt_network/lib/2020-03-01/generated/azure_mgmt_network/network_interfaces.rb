  ...
  class NetworkInterfaces
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2020_03_01::Models::NetworkInterface.mapper()
    ...
    def list_all_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2020_03_01::Models::NetworkInterfaceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_effective_route_table_async(resource_group_name, network_interface_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2020_03_01::Models::EffectiveRouteListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_effective_network_security_groups_async(resource_group_name, network_interface_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2020_03_01::Models::EffectiveNetworkSecurityGroupListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def begin_create_or_update_async(resource_group_name, network_interface_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2020_03_01::Models::NetworkInterface.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
