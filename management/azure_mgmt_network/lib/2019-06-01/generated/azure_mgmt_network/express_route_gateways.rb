...
module Azure::Network::Mgmt::V2019_06_01
  ...
  class ExpressRouteGateways
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2019_06_01::Models::ExpressRouteGatewayList.mapper()
    ...
    def create_or_update_async(resource_group_name, express_route_gateway_name, put_express_route_gateway_parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2019_06_01::Models::ExpressRouteGateway.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, express_route_gateway_name, put_express_route_gateway_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2019_06_01::Models::ExpressRouteGateway.mapper()
