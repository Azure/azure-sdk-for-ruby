...
module Azure::Network::Mgmt::V2018_12_01
  ...
  class ApplicationGateways
    ...
    def update_tags(resource_group_name, application_gateway_name, parameters, custom_headers = nil)
      response = update_tags_async(resource_group_name, application_gateway_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_tags_async(resource_group_name, application_gateway_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, application_gateway_name, parameters, custom_headers)
    ...
    def backend_health_on_demand(resource_group_name, application_gateway_name, probe_request, expand = nil, custom_headers = nil)
      response = backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand = nil, custom_headers = nil)
      # Send request
      promise = begin_backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand, custom_headers)

      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ApplicationGatewayBackendHealthOnDemand.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_available_server_variables(custom_headers = nil)
      response = list_available_server_variables_async(custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_available_server_variables_with_http_info(custom_headers = nil)
      list_available_server_variables_async(custom_headers).value!
    end
    ...
    def list_available_request_headers(custom_headers = nil)
      response = list_available_request_headers_async(custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_available_request_headers_with_http_info(custom_headers = nil)
      list_available_request_headers_async(custom_headers).value!
    end
    ...
    def list_available_response_headers(custom_headers = nil)
      response = list_available_response_headers_async(custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_available_response_headers_with_http_info(custom_headers = nil)
      list_available_response_headers_async(custom_headers).value!
    end
    ...
    def begin_update_tags(resource_group_name, application_gateway_name, parameters, custom_headers = nil)
      response = begin_update_tags_async(resource_group_name, application_gateway_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_tags_with_http_info(resource_group_name, application_gateway_name, parameters, custom_headers = nil)
      begin_update_tags_async(resource_group_name, application_gateway_name, parameters, custom_headers).value!
    end
    ...
    def begin_backend_health_on_demand(resource_group_name, application_gateway_name, probe_request, expand = nil, custom_headers = nil)
      response = begin_backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_backend_health_on_demand_with_http_info(resource_group_name, application_gateway_name, probe_request, expand = nil, custom_headers = nil)
      begin_backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand, custom_headers).value!
    end
    ...
    def begin_backend_health_on_demand_async(resource_group_name, application_gateway_name, probe_request, expand = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ApplicationGatewayOnDemandProbe.mapper()
      request_content = @client.serialize(request_mapper,  probe_request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/backendHealthOnDemand'
