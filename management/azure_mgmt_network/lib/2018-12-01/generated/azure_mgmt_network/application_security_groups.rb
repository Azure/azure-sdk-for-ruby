...
module Azure::Network::Mgmt::V2018_12_01
  ...
  class ApplicationSecurityGroups
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ApplicationSecurityGroup.mapper()
    ...
    def update_tags(resource_group_name, application_security_group_name, parameters, custom_headers = nil)
      response = update_tags_async(resource_group_name, application_security_group_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_tags_async(resource_group_name, application_security_group_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, application_security_group_name, parameters, custom_headers)
    ...
    def list_all_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ApplicationSecurityGroupListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, application_security_group_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ApplicationSecurityGroup.mapper()
    ...
    def begin_update_tags(resource_group_name, application_security_group_name, parameters, custom_headers = nil)
      response = begin_update_tags_async(resource_group_name, application_security_group_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_tags_with_http_info(resource_group_name, application_security_group_name, parameters, custom_headers = nil)
      begin_update_tags_async(resource_group_name, application_security_group_name, parameters, custom_headers).value!
    end
