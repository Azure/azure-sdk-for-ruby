...
module Azure::Network::Mgmt::V2018_12_01
  ...
  class VirtualNetworkGateways
    ...
    def create_or_update_async(resource_group_name, virtual_network_gateway_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VirtualNetworkGateway.mapper()
    ...
    def list_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VirtualNetworkGatewayListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_connections_async(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VirtualNetworkGatewayListConnectionsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def reset_vpn_client_shared_key(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      response = reset_vpn_client_shared_key_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
      nil
    end
    ...
    def reset_vpn_client_shared_key_async(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      # Send request
      promise = begin_reset_vpn_client_shared_key_async(resource_group_name, virtual_network_gateway_name, custom_headers)
    ...
    def generate_vpn_profile_with_http_info(resource_group_name, virtual_network_gateway_name, parameters, custom_headers = nil)
      generate_vpn_profile_async(resource_group_name, virtual_network_gateway_name, parameters, custom_headers).value!
    end
    ...
    def generate_vpn_profile_async(resource_group_name, virtual_network_gateway_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VpnClientParameters.mapper()
    ...
    def get_bgp_peer_status_async(resource_group_name, virtual_network_gateway_name, peer = nil, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::BgpPeerStatusListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_learned_routes_async(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::GatewayRouteListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def set_vpnclient_ipsec_parameters(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers = nil)
      response = set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers = nil)
      # Send request
      promise = begin_set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers)

      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VpnClientIPsecParameters.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_vpnclient_ipsec_parameters(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      response = get_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      # Send request
      promise = begin_get_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, custom_headers)
    ...
    def vpn_device_configuration_script_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VpnDeviceScriptParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_create_or_update_async(resource_group_name, virtual_network_gateway_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VirtualNetworkGateway.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_reset_vpn_client_shared_key(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      response = begin_reset_vpn_client_shared_key_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
      nil
    end
    ...
    def begin_reset_vpn_client_shared_key_with_http_info(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      begin_reset_vpn_client_shared_key_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
    end
    ...
    def begin_set_vpnclient_ipsec_parameters(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers = nil)
      response = begin_set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_set_vpnclient_ipsec_parameters_with_http_info(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers = nil)
      begin_set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers).value!
    end
    ...
    def begin_set_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, vpnclient_ipsec_params, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::VpnClientIPsecParameters.mapper()
    ...
    def begin_get_vpnclient_ipsec_parameters(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      response = begin_get_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_get_vpnclient_ipsec_parameters_with_http_info(resource_group_name, virtual_network_gateway_name, custom_headers = nil)
      begin_get_vpnclient_ipsec_parameters_async(resource_group_name, virtual_network_gateway_name, custom_headers).value!
    end
