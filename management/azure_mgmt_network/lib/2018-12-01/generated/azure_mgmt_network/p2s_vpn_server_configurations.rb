...
module Azure::Network::Mgmt::V2018_12_01
  ...
  class P2sVpnServerConfigurations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::P2SVpnServerConfiguration.mapper()
    ...
    def list_by_virtual_wan_async(resource_group_name, virtual_wan_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ListP2SVpnServerConfigurationsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, virtual_wan_name, p2svpn_server_configuration_name, p2svpn_server_configuration_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::P2SVpnServerConfiguration.mapper()
    ...
    def list_by_virtual_wan_next(next_page_link, custom_headers = nil)
      response = list_by_virtual_wan_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_by_virtual_wan_next_with_http_info(next_page_link, custom_headers = nil)
      list_by_virtual_wan_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_by_virtual_wan_as_lazy(resource_group_name, virtual_wan_name, custom_headers = nil)
      ...
      unless response.nil?
        ...
        page.next_method = Proc.new do |next_page_link|
          list_by_virtual_wan_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
