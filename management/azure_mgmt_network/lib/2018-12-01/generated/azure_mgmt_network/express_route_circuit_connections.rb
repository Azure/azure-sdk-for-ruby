...
module Azure::Network::Mgmt::V2018_12_01
  ...
  class ExpressRouteCircuitConnections
    ...
    def delete(resource_group_name, circuit_name, peering_name, connection_name, custom_headers = nil)
      response = delete_async(resource_group_name, circuit_name, peering_name, connection_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, circuit_name, peering_name, connection_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, circuit_name, peering_name, connection_name, custom_headers)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ExpressRouteCircuitConnection.mapper()
    ...
    def create_or_update(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers = nil)
      response = create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers)
    ...
    def list_async(resource_group_name, circuit_name, peering_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ExpressRouteCircuitConnectionListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_delete(resource_group_name, circuit_name, peering_name, connection_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, circuit_name, peering_name, connection_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, circuit_name, peering_name, connection_name, custom_headers = nil)
      begin_delete_async(resource_group_name, circuit_name, peering_name, connection_name, custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers).value!
    end
    ...
    def begin_create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2018_12_01::Models::ExpressRouteCircuitConnection.mapper()
