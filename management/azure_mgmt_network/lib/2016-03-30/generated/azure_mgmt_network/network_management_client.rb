...
module Azure::Network::Mgmt::V2016_03_30
  ...
  class NetworkManagementClient < MsRestAzure::AzureServiceClient
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::DnsNameAvailabilityResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def add_telemetry
        ...
        if defined? Azure::Network::Mgmt::V2016_03_30::VERSION
          sdk_information = "#{sdk_information}/#{Azure::Network::Mgmt::V2016_03_30::VERSION}"
        end
