...
module Azure::Network::Mgmt::V2016_03_30
  ...
  class VirtualNetworkGatewayConnections
    ...
    def get_shared_key(resource_group_name, connection_shared_key_name, custom_headers:nil)
      response = get_shared_key_async(resource_group_name, connection_shared_key_name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_shared_key_with_http_info(resource_group_name, connection_shared_key_name, custom_headers:nil)
      get_shared_key_async(resource_group_name, connection_shared_key_name, custom_headers:custom_headers).value!
    end
