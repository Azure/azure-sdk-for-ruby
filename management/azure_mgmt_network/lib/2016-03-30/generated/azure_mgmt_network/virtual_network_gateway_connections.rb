  ...
  class VirtualNetworkGatewayConnections
    ...
    def create_or_update_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2016_03_30::Models::VirtualNetworkGatewayConnection.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::VirtualNetworkGatewayConnection.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_shared_key_async(resource_group_name, connection_shared_key_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::ConnectionSharedKeyResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::VirtualNetworkGatewayConnectionListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def reset_shared_key_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2016_03_30::Models::ConnectionResetSharedKey.new.from_json(parsed_response)
        end
    ...
    def set_shared_key_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2016_03_30::Models::ConnectionSharedKey.new.from_json(parsed_response)
        end
    ...
    def begin_reset_shared_key_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::ConnectionResetSharedKey.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_set_shared_key_async(resource_group_name, virtual_network_gateway_connection_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2016_03_30::Models::ConnectionSharedKey.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
