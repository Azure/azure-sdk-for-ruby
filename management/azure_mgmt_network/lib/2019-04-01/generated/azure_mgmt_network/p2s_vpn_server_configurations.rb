...
module Azure::Network::Mgmt::V2019_04_01
  ...
  class P2sVpnServerConfigurations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2019_04_01::Models::P2SVpnServerConfiguration.mapper()
    ...
    def list_by_virtual_wan_async(resource_group_name, virtual_wan_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2019_04_01::Models::ListP2SVpnServerConfigurationsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, virtual_wan_name, p2svpn_server_configuration_name, p2svpn_server_configuration_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2019_04_01::Models::P2SVpnServerConfiguration.mapper()
