...
module Azure::Network::Profiles::V2017_03_09
  module Mgmt
    ...
    class NetworkManagementClass
      attr_reader :route_tables, :routes, :usages, :virtual_networks, :subnets, :application_gateways, :network_interfaces, :public_ipaddresses, :express_route_circuit_authorizations, :express_route_circuit_peerings, :express_route_circuits, :express_route_service_providers, :load_balancers, :local_network_gateways, :virtual_network_gateways, :virtual_network_gateway_connections, :network_security_groups, :security_rules, :configurable, :base_url, :options, :model_classes
