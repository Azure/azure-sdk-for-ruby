...
module Azure::Network::Mgmt::V2017_11_01
  ...
  class NetworkManagementClient < MsRestAzure::AzureServiceClient
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2017_11_01::Models::DnsNameAvailabilityResult.mapper()
    ...
    def add_telemetry
        ...
        if defined? Azure::Network::Mgmt::V2017_11_01::VERSION
          sdk_information = "#{sdk_information}/#{Azure::Network::Mgmt::V2017_11_01::VERSION}"
        end
