  ...
  class RouteFilterRules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Network::Mgmt::V2016_12_01::Models::RouteFilterRule.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, route_filter_name, rule_name, route_filter_rule_parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Network::Mgmt::V2016_12_01::Models::RouteFilterRule.new.from_json(parsed_response)
        end
    ...
    def list_by_route_filter_async(resource_group_name, route_filter_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Network::Mgmt::V2016_12_01::Models::RouteFilterRuleListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_or_update_async(resource_group_name, route_filter_name, rule_name, route_filter_rule_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = route_filter_rule_parameters.nil? ? nil: route_filter_rule_parameters.to_json
