...
module Azure::Network::Mgmt::V2019_12_01
  ...
  class Routes
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network::Mgmt::V2019_12_01::Models::Route.mapper()
    ...
    def list_async(resource_group_name, route_table_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network::Mgmt::V2019_12_01::Models::RouteListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, route_table_name, route_name, route_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network::Mgmt::V2019_12_01::Models::Route.mapper()
