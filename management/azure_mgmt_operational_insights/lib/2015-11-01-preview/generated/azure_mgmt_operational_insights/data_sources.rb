...
module Azure::ARM::OperationalInsights::Api_2015_11_01_preview
  ...
  class DataSources
    ...
    def create_or_update_async(resource_group_name, workspace_name, data_source_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::OperationalInsights::Api_2015_11_01_preview::Models::DataSource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::OperationalInsights::Api_2015_11_01_preview::Models::DataSource.mapper()
    ...
    def list_by_workspace_async(resource_group_name, workspace_name, filter, skiptoken = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::OperationalInsights::Api_2015_11_01_preview::Models::DataSourceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
