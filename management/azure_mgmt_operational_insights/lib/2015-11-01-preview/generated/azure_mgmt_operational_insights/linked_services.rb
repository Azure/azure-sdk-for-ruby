      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::OperationalInsights::Mgmt::V2015_11_01_preview::Models::LinkedService.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_workspace_async(resource_group_name, workspace_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::OperationalInsights::Mgmt::V2015_11_01_preview::Models::LinkedServiceListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
