...
module Azure::OperationalInsights::Mgmt::V2015_03_20
  ...
  class SavedSearches
    ...
    def get_results(resource_group_name, workspace_name, saved_search_id, custom_headers:nil)
      response = get_results_async(resource_group_name, workspace_name, saved_search_id, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_results_with_http_info(resource_group_name, workspace_name, saved_search_id, custom_headers:nil)
      get_results_async(resource_group_name, workspace_name, saved_search_id, custom_headers:custom_headers).value!
    end
