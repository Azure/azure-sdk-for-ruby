...
module Azure::ARM::OperationalInsights::Api_2015_03_20
  ...
  class Workspaces
    ...
    def get_schema_async(resource_group_name, workspace_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::OperationalInsights::Api_2015_03_20::Models::SearchGetSchemaResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_get_search_results_async(resource_group_name, workspace_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::OperationalInsights::Api_2015_03_20::Models::SearchParameters.mapper()
