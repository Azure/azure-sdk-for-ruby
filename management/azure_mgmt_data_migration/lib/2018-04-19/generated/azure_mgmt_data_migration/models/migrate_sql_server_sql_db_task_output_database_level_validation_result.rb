...
module Azure::DataMigration::Mgmt::V2018_04_19
  module Models
    ...
    #
    class MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResult < MigrateSqlServerSqlDbTaskOutput
      ...
      #
      # Mapper for MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResult
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MigrationDatabaseLevelValidationOutput',
          type: {
            name: 'Composite',
            class_name: 'MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResult',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
