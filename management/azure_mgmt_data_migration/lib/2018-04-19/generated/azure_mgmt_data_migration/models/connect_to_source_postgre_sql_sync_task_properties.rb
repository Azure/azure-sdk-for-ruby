...
module Azure::DataMigration::Mgmt::V2018_04_19
  module Models
    ...
    class ConnectToSourcePostgreSqlSyncTaskProperties < ProjectTaskProperties
      ...
      # @return [ConnectToSourcePostgreSqlSyncTaskInput] Task input
      attr_accessor :input

      # @return [Array<ConnectToSourcePostgreSqlSyncTaskOutput>] Task output.
      # This is ignored if submitted.
      attr_accessor :output


      #
      # Mapper for ConnectToSourcePostgreSqlSyncTaskProperties class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ConnectToSource.PostgreSql.Sync',
          type: {
            name: 'Composite',
            class_name: 'ConnectToSourcePostgreSqlSyncTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ConnectToSourcePostgreSqlSyncTaskOutputElementType',
                      type: {
                        name: 'Composite',
