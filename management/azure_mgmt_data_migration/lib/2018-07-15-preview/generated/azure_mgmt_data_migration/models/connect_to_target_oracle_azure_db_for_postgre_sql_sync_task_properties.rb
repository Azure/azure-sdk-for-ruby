...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties < ProjectTaskProperties
      ...
      # @return [ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInput] Task
      # input
      attr_accessor :input

      # @return
      # [Array<ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutput>] Task
      # output. This is ignored if submitted.
      attr_accessor :output


      #
      # Mapper for ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ConnectToTarget.Oracle.AzureDbForPostgreSql.Sync',
          type: {
            name: 'Composite',
            class_name: 'ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputElementType',
                      type: {
                        name: 'Composite',
