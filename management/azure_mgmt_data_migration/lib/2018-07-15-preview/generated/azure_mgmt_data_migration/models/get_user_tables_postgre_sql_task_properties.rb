...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class GetUserTablesPostgreSqlTaskProperties < ProjectTaskProperties
      ...
      # @return [GetUserTablesPostgreSqlTaskInput] Task input
      attr_accessor :input

      # @return [Array<GetUserTablesPostgreSqlTaskOutput>] Task output. This is
      # ignored if submitted.
      attr_accessor :output


      #
      # Mapper for GetUserTablesPostgreSqlTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GetUserTablesPostgreSql',
          type: {
            name: 'Composite',
            class_name: 'GetUserTablesPostgreSqlTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'GetUserTablesPostgreSqlTaskOutputElementType',
                      type: {
                        name: 'Composite',
