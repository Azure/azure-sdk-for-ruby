...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class ValidateMigrationInputSqlServerSqlMITaskOutput
      ...
      # @return [Array<ReportableException>] Errors associated with existing
      # backup files.
      attr_accessor :existing_backup_errors

      # @return [DatabaseBackupInfo] Information about backup files when
      # existing backup mode is used.
      attr_accessor :database_backup_info
      ...
      def self.mapper()
        {
          ...
          type: {
            ...
            model_properties: {
              ...
              existing_backup_errors: {
                client_side_validation: true,
                required: false,
                read_only: true,
                serialized_name: 'existingBackupErrors',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
