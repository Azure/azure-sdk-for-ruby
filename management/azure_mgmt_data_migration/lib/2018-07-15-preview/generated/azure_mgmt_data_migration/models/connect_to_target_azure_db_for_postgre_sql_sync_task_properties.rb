...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class ConnectToTargetAzureDbForPostgreSqlSyncTaskProperties < ProjectTaskProperties
      ...
      # @return [ConnectToTargetAzureDbForPostgreSqlSyncTaskInput] Task input
      attr_accessor :input

      # @return [Array<ConnectToTargetAzureDbForPostgreSqlSyncTaskOutput>] Task
      # output. This is ignored if submitted.
      attr_accessor :output


      #
      # Mapper for ConnectToTargetAzureDbForPostgreSqlSyncTaskProperties class
      # as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ConnectToTarget.AzureDbForPostgreSql.Sync',
          type: {
            name: 'Composite',
            class_name: 'ConnectToTargetAzureDbForPostgreSqlSyncTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'ConnectToTargetAzureDbForPostgreSqlSyncTaskOutput'
                      }
                  }
                }
              }
