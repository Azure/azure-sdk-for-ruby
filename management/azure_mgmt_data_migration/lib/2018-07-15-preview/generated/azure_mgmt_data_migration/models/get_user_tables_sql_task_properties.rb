...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class GetUserTablesSqlTaskProperties < ProjectTaskProperties
      ...
      # @return [GetUserTablesSqlTaskInput] Task input
      attr_accessor :input

      # @return [Array<GetUserTablesSqlTaskOutput>] Task output. This is
      # ignored if submitted.
      attr_accessor :output


      #
      # Mapper for GetUserTablesSqlTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GetUserTables.Sql',
          type: {
            name: 'Composite',
            class_name: 'GetUserTablesSqlTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'GetUserTablesSqlTaskOutputElementType',
                      type: {
                        name: 'Composite',
