...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class UploadOCIDriverTaskProperties < ProjectTaskProperties
      ...
      # @return [UploadOCIDriverTaskInput]
      attr_accessor :input

      # @return [Array<UploadOCIDriverTaskOutput>] Task output. This is ignored
      # if submitted.
      attr_accessor :output


      #
      # Mapper for UploadOCIDriverTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Service.Upload.OCI',
          type: {
            name: 'Composite',
            class_name: 'UploadOCIDriverTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'UploadOCIDriverTaskOutputElementType',
                      type: {
                        name: 'Composite',
