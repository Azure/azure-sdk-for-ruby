...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class GetUserTablesOracleTaskProperties < ProjectTaskProperties
      ...
      # @return [GetUserTablesOracleTaskInput] Task input
      attr_accessor :input

      # @return [Array<GetUserTablesOracleTaskOutput>] Task output. This is
      # ignored if submitted.
      attr_accessor :output


      #
      # Mapper for GetUserTablesOracleTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GetUserTablesOracle',
          type: {
            name: 'Composite',
            class_name: 'GetUserTablesOracleTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'GetUserTablesOracleTaskOutputElementType',
                      type: {
                        name: 'Composite',
