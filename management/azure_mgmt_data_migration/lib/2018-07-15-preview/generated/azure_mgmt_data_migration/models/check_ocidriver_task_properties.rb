...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class CheckOCIDriverTaskProperties < ProjectTaskProperties
      ...
      # @return [CheckOCIDriverTaskInput]
      attr_accessor :input

      # @return [Array<CheckOCIDriverTaskOutput>] Task output. This is ignored
      # if submitted.
      attr_accessor :output


      #
      # Mapper for CheckOCIDriverTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Service.Check.OCI',
          type: {
            name: 'Composite',
            class_name: 'CheckOCIDriverTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'CheckOCIDriverTaskOutputElementType',
                      type: {
                        name: 'Composite',
