...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevel < MigrateMySqlAzureDbForMySqlSyncTaskOutput
      ...
      # @return [String] Number of applied inserts
      attr_accessor :cdc_insert_counter

      # @return [String] Number of applied updates
      attr_accessor :cdc_update_counter

      # @return [String] Number of applied deletes
      ...
      #
      # Mapper for MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevel class as
      # Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          type: {
            name: 'Composite',
            class_name: 'MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevel',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
