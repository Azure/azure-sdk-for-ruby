...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  module Models
    ...
    class MigrateMongoDbTaskProperties < ProjectTaskProperties
      ...
      # @return [Array<MongoDbProgress>]
      attr_accessor :output


      #
      # Mapper for MigrateMongoDbTaskProperties class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Migrate.MongoDb',
          type: {
            name: 'Composite',
            class_name: 'MigrateMongoDbTaskProperties',
            model_properties: {
              errors: {
                client_side_validation: true,
                required: false,
              ...
              output: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'MongoDbProgressElementType',
                      type: {
                        name: 'Composite',
