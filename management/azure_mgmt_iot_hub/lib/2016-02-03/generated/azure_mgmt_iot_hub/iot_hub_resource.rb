...
module Azure::IotHub::Mgmt::V2016_02_03
  ...
  class IotHubResource
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubDescription.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, resource_name, iot_hub_description, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubDescription.new.from_json(parsed_response)
        end
    ...
    def delete_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          ...
          parsed_response = a_new_class.new.from_json(parsed_response, result_mapper)
        end
    ...
    def list_by_subscription_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubDescriptionListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_stats_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::RegistryStatistics.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_valid_skus_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubSkuDescriptionListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_event_hub_consumer_groups_async(resource_group_name, resource_name, event_hub_endpoint_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::EventHubConsumerGroupsListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_event_hub_consumer_group_async(resource_group_name, resource_name, event_hub_endpoint_name, name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::EventHubConsumerGroupInfo.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_jobs_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::JobResponseListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_job_async(resource_group_name, resource_name, job_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::JobResponse.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_quota_metrics_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubQuotaMetricInfoListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def check_name_availability_async(operation_inputs, custom_headers = nil)
      ...
      # Serialize Request
      request_content = operation_inputs.nil? ? nil: operation_inputs.to_json
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::IotHubNameAvailabilityInfo.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_keys_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::SharedAccessSignatureAuthorizationRuleListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_keys_for_key_name_async(resource_group_name, resource_name, key_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::SharedAccessSignatureAuthorizationRule.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def export_devices_async(resource_group_name, resource_name, export_devices_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = export_devices_parameters.nil? ? nil: export_devices_parameters.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def import_devices_async(resource_group_name, resource_name, import_devices_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = import_devices_parameters.nil? ? nil: import_devices_parameters.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_create_or_update_async(resource_group_name, resource_name, iot_hub_description, custom_headers = nil)
      ...
      # Serialize Request
      request_content = iot_hub_description.nil? ? nil: iot_hub_description.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_delete_async(resource_group_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 404
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::IotHub::Mgmt::V2016_02_03::Models::ErrorDetails.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
