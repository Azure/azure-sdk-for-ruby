...
module Azure::IotHub::Management::Profile_2016_02_03
    ...
    #
    class IotHubClass
      attr_reader :iot_hub_resource, :configurable, :base_url, :options, :model_classes

      def initialize(configurable, base_url=nil, options=nil)
        @configurable, @base_url, @options = configurable, base_url, options

        client_0 = Azure::ARM::IotHub::Api_2016_02_03::IotHubClient.new(configurable.credentials, base_url, options)
      ...
      #
      def get_client(version = '2016-02-03')
        case version
          when '2016-02-03'
