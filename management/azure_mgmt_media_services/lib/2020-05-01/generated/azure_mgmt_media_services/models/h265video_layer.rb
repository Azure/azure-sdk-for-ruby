...
module Azure::MediaServices::Mgmt::V2020_05_01
  module Models
    ...
    class H265VideoLayer < Layer
      ...
      # @return [Boolean] Specifies whether or not adaptive B-frames are to be
      # used when encoding this layer. If not specified, the encoder will turn
      # it on whenever the video profile permits its use.
      attr_accessor :adaptive_bframe


      #
      # Mapper for H265VideoLayer class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: '#Microsoft.Media.H265VideoLayer',
          type: {
            name: 'Composite',
            class_name: 'H265VideoLayer',
            model_properties: {
              width: {
                client_side_validation: true,
                required: false,
