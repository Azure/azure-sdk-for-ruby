...
module Azure::MediaServices::Mgmt::V2020_05_01
  module Models
    ...
    class Job < ProxyResource
      ...
      # @return [DateTime] The UTC date and time when the customer has created
      # the Job, in 'YYYY-MM-DDThh:mm:ssZ' format.
      ...
      # @return [DateTime] The UTC date and time when the customer has last
