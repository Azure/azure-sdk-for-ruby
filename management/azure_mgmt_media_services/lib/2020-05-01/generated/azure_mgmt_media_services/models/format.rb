...
module Azure::MediaServices::Mgmt::V2020_05_01
  module Models
    ...
    class Format
      ...
      # the base name(the file suffix is not included) of the input video file
      # is less than 32 characters long, the base name of input video files
      # will be used. If the length of base name of the input video file
      ...
      # this format. {Label} - The label assigned to the codec/layer. {Index} -
