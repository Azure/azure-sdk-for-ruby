...
module Azure::MediaServices::Mgmt::V2018_07_01
  ...
  class Assets
    ...
    def list_streaming_locators(resource_group_name, account_name, asset_name, custom_headers = nil)
      response = list_streaming_locators_async(resource_group_name, account_name, asset_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_streaming_locators_with_http_info(resource_group_name, account_name, asset_name, custom_headers = nil)
      list_streaming_locators_async(resource_group_name, account_name, asset_name, custom_headers).value!
    end
