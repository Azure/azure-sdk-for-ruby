...
module Azure::MediaServices::Mgmt::V2018_07_01
  ...
  class Transforms
    ...
    def list(resource_group_name, account_name, filter = nil, orderby = nil, custom_headers = nil)
      first_page = list_as_lazy(resource_group_name, account_name, filter, orderby, custom_headers)
    ...
    def list_with_http_info(resource_group_name, account_name, filter = nil, orderby = nil, custom_headers = nil)
      list_async(resource_group_name, account_name, filter, orderby, custom_headers).value!
    end
    ...
    def list_as_lazy(resource_group_name, account_name, filter = nil, orderby = nil, custom_headers = nil)
      response = list_async(resource_group_name, account_name, filter, orderby, custom_headers).value!
      unless response.nil?
        page = response.body
