...
module Azure::MediaServices::Mgmt::V2019_05_01_preview
  ...
  class StreamingPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::StreamingPolicyCollection.mapper()
    ...
    def get_async(resource_group_name, account_name, streaming_policy_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::StreamingPolicy.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_async(resource_group_name, account_name, streaming_policy_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::StreamingPolicy.mapper()
