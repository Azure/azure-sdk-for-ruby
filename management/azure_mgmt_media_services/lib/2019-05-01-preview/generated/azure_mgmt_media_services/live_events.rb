...
module Azure::MediaServices::Mgmt::V2019_05_01_preview
  ...
  class LiveEvents
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::LiveEventListResult.mapper()
    ...
    def get_async(resource_group_name, account_name, live_event_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::LiveEvent.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, account_name, live_event_name, parameters, auto_start:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::LiveEvent.mapper()
    ...
    def begin_stop_async(resource_group_name, account_name, live_event_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2019_05_01_preview::Models::LiveEventActionInput.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
