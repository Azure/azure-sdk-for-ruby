...
module Azure::ARM::MediaServices
  ...
  class MediaServiceOperations
    ...
    def check_name_availability_async(check_name_availability_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = check_name_availability_input.to_json
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::MediaServices::Models::CheckNameAvailabilityOutput.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MediaServices::Models::MediaServiceCollection.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_async(resource_group_name, media_service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MediaServices::Models::MediaService.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_async(resource_group_name, media_service_name, media_service, custom_headers = nil)
      ...
      # Serialize Request
      request_content = media_service.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def regenerate_key_async(resource_group_name, media_service_name, regenerate_key_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = regenerate_key_input.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MediaServices::Models::RegenerateKeyOutput.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_keys_async(resource_group_name, media_service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MediaServices::Models::ServiceKeys.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def sync_storage_keys_async(resource_group_name, media_service_name, sync_storage_keys_input, custom_headers = nil)
      ...
      # Serialize Request
      request_content = sync_storage_keys_input.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
