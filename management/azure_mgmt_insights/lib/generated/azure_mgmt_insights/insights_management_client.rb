...
module Azure::ARM::Insights
  ...
  class InsightsManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [ServiceDiagnosticSettings] service_diagnostic_settings
    attr_reader :service_diagnostic_settings
    ...
    def initialize(credentials, base_url = nil, options = nil)
      ...
      @service_diagnostic_settings = ServiceDiagnosticSettings.new(self)
