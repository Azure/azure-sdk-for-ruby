...
module Azure::Relay::Mgmt::V2016_07_01
  ...
  class HybridConnections
    ...
    def list_post_authorization_rules(resource_group_name, namespace_name, hybrid_connection_name, custom_headers = nil)
      first_page = list_post_authorization_rules_as_lazy(resource_group_name, namespace_name, hybrid_connection_name, custom_headers)
      first_page.get_all_items
    end
    ...
    def list_post_authorization_rules_with_http_info(resource_group_name, namespace_name, hybrid_connection_name, custom_headers = nil)
      list_post_authorization_rules_async(resource_group_name, namespace_name, hybrid_connection_name, custom_headers).value!
    end
    ...
    def post_authorization_rule(resource_group_name, namespace_name, hybrid_connection_name, authorization_rule_name, custom_headers = nil)
      response = post_authorization_rule_async(resource_group_name, namespace_name, hybrid_connection_name, authorization_rule_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def post_authorization_rule_with_http_info(resource_group_name, namespace_name, hybrid_connection_name, authorization_rule_name, custom_headers = nil)
      post_authorization_rule_async(resource_group_name, namespace_name, hybrid_connection_name, authorization_rule_name, custom_headers).value!
    end
    ...
    def list_post_authorization_rules_as_lazy(resource_group_name, namespace_name, hybrid_connection_name, custom_headers = nil)
      response = list_post_authorization_rules_async(resource_group_name, namespace_name, hybrid_connection_name, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
