...
module Azure::ARM::Relay::Api_2017_04_01
  ...
  class HybridConnections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Relay::Api_2017_04_01::Models::HybridConnectionListResult.mapper()
    ...
    def create_or_update_async(resource_group_name, namespace_name, hybrid_connection_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Relay::Api_2017_04_01::Models::HybridConnection.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Relay::Api_2017_04_01::Models::HybridConnection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
