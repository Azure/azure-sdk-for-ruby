...
include MsRest
include MsRestAzure
include Azure::ARM::Resources::Api_2016_09_01
...
class ResourceHelper
  ...
  def initialize
    ...
    VCR.configure do |config|
      config.cassette_library_dir = "spec/2016-09-01/vcr_cassettes"
    end
  ...
  def create_resource_group
    ...
    params = Azure::ARM::Resources::Api_2016_09_01::Models::ResourceGroup.new()
