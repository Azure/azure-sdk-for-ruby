...
module Azure::Resources::Mgmt::V2017_05_10
  ...
  class Resources
    ...
    def update(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers = nil)
      response = update_async(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers)
    ...
    def update_by_id(resource_id, api_version, parameters, custom_headers = nil)
      response = update_by_id_async(resource_id, api_version, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_by_id_async(resource_id, api_version, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_by_id_async(resource_id, api_version, parameters, custom_headers)
    ...
    def begin_update(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, resource_provider_namespace, parent_resource_path, resource_type, resource_name, api_version, parameters, custom_headers).value!
    end
    ...
    def begin_update_by_id(resource_id, api_version, parameters, custom_headers = nil)
      response = begin_update_by_id_async(resource_id, api_version, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_by_id_with_http_info(resource_id, api_version, parameters, custom_headers = nil)
      begin_update_by_id_async(resource_id, api_version, parameters, custom_headers).value!
    end
