...
module Azure::ARM::MobileEngagement
  ...
  class ExportTasks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::MobileEngagement::Models::ExportTaskListResult.mapper()
    ...
    def get_async(resource_group_name, app_collection, app_name, id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MobileEngagement::Models::ExportTaskResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_activities_task_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Models::DateRangeExportTaskParameter.mapper()
    ...
    def create_tags_task_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Models::ExportTaskParameter.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_feedback_task_by_date_range_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Models::FeedbackByDateRangeParameter.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def create_feedback_task_by_campaign_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Models::FeedbackByCampaignParameter.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
