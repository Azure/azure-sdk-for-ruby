...
module Azure::ARM::MobileEngagement
  module Models
    ...
    class DevicesQueryResult
      ...
      # @return [Array<DeviceQueryResult>] The list of devices.
      attr_accessor :value

      # @return [String] If partial results are returned, this property
      ...
      #
      # @return [DevicesQueryResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for DevicesQueryResult class as Ruby Hash.
