...
module Azure::ARM::MobileEngagement::Api_2014_12_01
  ...
  class ImportTasks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::ImportTaskListResult.mapper()
    ...
    def create_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::ImportTask.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::ImportTaskResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
