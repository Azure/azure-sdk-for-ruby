...
module Azure::ARM::MobileEngagement::Api_2014_12_01
  ...
  class Devices
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::DevicesQueryResult.mapper()
    ...
    def get_by_device_id_async(resource_group_name, app_collection, app_name, device_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::Device.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def tag_by_device_id_async(resource_group_name, app_collection, app_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::DeviceTagsParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MobileEngagement::Api_2014_12_01::Models::DeviceTagsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
