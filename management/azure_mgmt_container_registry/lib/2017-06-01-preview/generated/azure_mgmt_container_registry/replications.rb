...
module Azure::ContainerRegistry::Mgmt::V2017_06_01_preview
  ...
  class Replications
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ContainerRegistry::Mgmt::V2017_06_01_preview::Models::Replication.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(resource_group_name, registry_name, replication_name, replication, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::ContainerRegistry::Mgmt::V2017_06_01_preview::Models::Replication.new.from_json(parsed_response)
        end
    ...
    def list_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ContainerRegistry::Mgmt::V2017_06_01_preview::Models::ReplicationListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_async(resource_group_name, registry_name, replication_name, replication, custom_headers = nil)
      ...
      # Serialize Request
      request_content = replication.nil? ? nil: replication.to_json
    ...
    def begin_update_async(resource_group_name, registry_name, replication_name, replication_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = replication_update_parameters.nil? ? nil: replication_update_parameters.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
