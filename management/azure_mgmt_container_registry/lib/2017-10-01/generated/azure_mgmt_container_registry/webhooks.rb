...
module Azure::ARM::ContainerRegistry::Api_2017_10_01
  ...
  class Webhooks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::Webhook.mapper()
    ...
    def list_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::WebhookListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def ping_async(resource_group_name, registry_name, webhook_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::EventInfo.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_callback_config_async(resource_group_name, registry_name, webhook_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::CallbackConfig.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_events_async(resource_group_name, registry_name, webhook_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::EventListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, registry_name, webhook_name, webhook_create_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::WebhookCreateParameters.mapper()
    ...
    def begin_update_async(resource_group_name, registry_name, webhook_name, webhook_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::WebhookUpdateParameters.mapper()
