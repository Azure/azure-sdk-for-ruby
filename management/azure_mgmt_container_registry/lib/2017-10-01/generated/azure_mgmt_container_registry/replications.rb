...
module Azure::ARM::ContainerRegistry::Api_2017_10_01
  ...
  class Replications
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::Replication.mapper()
    ...
    def list_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::ReplicationListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, registry_name, replication_name, replication, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::Replication.mapper()
    ...
    def begin_update_async(resource_group_name, registry_name, replication_name, replication_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::ReplicationUpdateParameters.mapper()
