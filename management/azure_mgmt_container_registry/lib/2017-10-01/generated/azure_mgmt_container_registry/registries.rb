...
module Azure::ARM::ContainerRegistry::Api_2017_10_01
  ...
  class Registries
    ...
    def check_name_availability_async(registry_name_check_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryNameCheckRequest.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryNameStatus.mapper()
    ...
    def get_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::Registry.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_credentials_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryListCredentialsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_credential_async(resource_group_name, registry_name, regenerate_credential_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegenerateCredentialParameters.mapper()
    ...
    def list_usages_async(resource_group_name, registry_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryUsageListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, registry_name, registry, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::Registry.mapper()
    ...
    def begin_update_async(resource_group_name, registry_name, registry_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerRegistry::Api_2017_10_01::Models::RegistryUpdateParameters.mapper()
