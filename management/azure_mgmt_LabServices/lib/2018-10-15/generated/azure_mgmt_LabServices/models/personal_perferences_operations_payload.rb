...
module Azure::LabServices::Mgmt::V2018_10_15
  module Models
    ...
    class PersonalPerferencesOperationsPayload
      ...
      #
      # Mapper for PersonalPerferencesOperationsPayload class as Ruby Hash.
      # This will be used for serialization/deserialization.
      #
      def self.mapper()
        {
          required: false,
          serialized_name: 'PersonalPerferencesOperationsPayload',
          type: {
            name: 'Composite',
            class_name: 'PersonalPerferencesOperationsPayload',
            model_properties: {
