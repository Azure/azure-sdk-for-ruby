...
module Azure::LabServices::Mgmt::V2018_10_15
  ...
  class Labs
    ...
    def get(resource_group_name, lab_account_name, lab_name, expand = nil, custom_headers = nil)
      response = get_async(resource_group_name, lab_account_name, lab_name, expand, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, lab_account_name, lab_name, expand = nil, custom_headers = nil)
      get_async(resource_group_name, lab_account_name, lab_name, expand, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, lab_account_name, lab_name, lab, custom_headers = nil)
      response = create_or_update_async(resource_group_name, lab_account_name, lab_name, lab, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, lab_account_name, lab_name, lab, custom_headers = nil)
      create_or_update_async(resource_group_name, lab_account_name, lab_name, lab, custom_headers).value!
    end
    ...
    def delete(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      response = delete_async(resource_group_name, lab_account_name, lab_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, lab_account_name, lab_name, custom_headers)
    ...
    def update(resource_group_name, lab_account_name, lab_name, lab, custom_headers = nil)
      response = update_async(resource_group_name, lab_account_name, lab_name, lab, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(resource_group_name, lab_account_name, lab_name, lab, custom_headers = nil)
      update_async(resource_group_name, lab_account_name, lab_name, lab, custom_headers).value!
    end
    ...
    def add_users(resource_group_name, lab_account_name, lab_name, add_users_payload, custom_headers = nil)
      response = add_users_async(resource_group_name, lab_account_name, lab_name, add_users_payload, custom_headers).value!
      nil
    end
    ...
    def add_users_with_http_info(resource_group_name, lab_account_name, lab_name, add_users_payload, custom_headers = nil)
      add_users_async(resource_group_name, lab_account_name, lab_name, add_users_payload, custom_headers).value!
    end
    ...
    def register(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      response = register_async(resource_group_name, lab_account_name, lab_name, custom_headers).value!
      nil
    end
    ...
    def register_with_http_info(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      register_async(resource_group_name, lab_account_name, lab_name, custom_headers).value!
    end
    ...
    def begin_delete(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, lab_account_name, lab_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, lab_account_name, lab_name, custom_headers = nil)
      begin_delete_async(resource_group_name, lab_account_name, lab_name, custom_headers).value!
    end
