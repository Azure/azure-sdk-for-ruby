...
module Azure::ARM::Locks::Api_2016_09_01
  ...
  class ManagementLocks
    ...
    def create_or_update_at_resource_group_level_async(resource_group_name, lock_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Locks::Api_2016_09_01::Models::ManagementLockObject.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Locks::Api_2016_09_01::Models::ManagementLockObject.mapper()
    ...
    def list_at_resource_group_level_async(resource_group_name, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Locks::Api_2016_09_01::Models::ManagementLockListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
