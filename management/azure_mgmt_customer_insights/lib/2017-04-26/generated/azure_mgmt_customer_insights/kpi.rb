    ...
    def create_or_update_async(resource_group_name, hub_name, kpi_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::KpiResourceFormat.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::KpiResourceFormat.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_hub_async(resource_group_name, hub_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::KpiListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
