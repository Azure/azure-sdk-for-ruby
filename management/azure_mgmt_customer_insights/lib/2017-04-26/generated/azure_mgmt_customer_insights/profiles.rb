...
module Azure::ARM::CustomerInsights::Api_2017_04_26
  ...
  class Profiles
    ...
    def create_or_update_async(resource_group_name, hub_name, profile_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ARM::CustomerInsights::Api_2017_04_26::Models::ProfileResourceFormat.mapper()
    ...
    def list_by_hub_async(resource_group_name, hub_name, locale_code = 'en-us', custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::CustomerInsights::Api_2017_04_26::Models::ProfileListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, hub_name, profile_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::CustomerInsights::Api_2017_04_26::Models::ProfileResourceFormat.mapper()
