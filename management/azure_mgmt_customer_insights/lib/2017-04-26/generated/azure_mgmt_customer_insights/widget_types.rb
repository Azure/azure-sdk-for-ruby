...
module Azure::CustomerInsights::Mgmt::V2017_04_26
  ...
  class WidgetTypes
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::WidgetTypeListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get(resource_group_name, hub_name, widget_type_name, custom_headers = nil)
      response = get_async(resource_group_name, hub_name, widget_type_name, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, hub_name, widget_type_name, custom_headers = nil)
      get_async(resource_group_name, hub_name, widget_type_name, custom_headers).value!
    end
    ...
    def get_async(resource_group_name, hub_name, widget_type_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::WidgetTypeResourceFormat.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
