...
module Azure::ARM::ContainerInsights
  ...
  class Images
    ...
    def get_upload_url_for_entity_type_async(resource_group_name, hub_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ContainerInsights::Models::GetImageUploadUrlInput.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ContainerInsights::Models::ImageDefinition.mapper()
