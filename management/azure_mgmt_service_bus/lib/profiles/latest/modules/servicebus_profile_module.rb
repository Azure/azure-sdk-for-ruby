...
module Azure::ServiceBus::Profiles::Latest
  module Mgmt
    ...
    class ServiceBusManagementClass
      attr_reader :subscriptions, :operations, :namespaces, :disaster_recovery_configs, :migration_configs, :queues, :topics, :rules, :regions, :premium_messaging_regions_operations, :event_hubs, :configurable, :base_url, :options, :model_classes
