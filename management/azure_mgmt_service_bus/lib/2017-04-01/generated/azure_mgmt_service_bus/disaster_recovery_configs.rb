...
module Azure::ServiceBus::Mgmt::V2017_04_01
  ...
  class DisasterRecoveryConfigs
    ...
    def check_name_availability_method(resource_group_name, namespace_name, parameters, custom_headers = nil)
      response = check_name_availability_method_async(resource_group_name, namespace_name, parameters, custom_headers).value!
    ...
    def check_name_availability_method_with_http_info(resource_group_name, namespace_name, parameters, custom_headers = nil)
      check_name_availability_method_async(resource_group_name, namespace_name, parameters, custom_headers).value!
    end
