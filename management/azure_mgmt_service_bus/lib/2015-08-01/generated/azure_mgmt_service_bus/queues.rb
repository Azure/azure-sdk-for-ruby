...
module Azure::ServiceBus::Mgmt::V2015_08_01
  ...
  class Queues
    ...
    def post_authorization_rule(resource_group_name, namespace_name, queue_name, authorization_rule_name, custom_headers = nil)
      response = post_authorization_rule_async(resource_group_name, namespace_name, queue_name, authorization_rule_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def post_authorization_rule_with_http_info(resource_group_name, namespace_name, queue_name, authorization_rule_name, custom_headers = nil)
      post_authorization_rule_async(resource_group_name, namespace_name, queue_name, authorization_rule_name, custom_headers).value!
    end
