...
module Azure::ARM::ServiceBus::Api_2015_08_01
  ...
  class Topics
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ServiceBus::Api_2015_08_01::Models::TopicListResult.mapper()
    ...
    def create_or_update_async(resource_group_name, namespace_name, topic_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ServiceBus::Api_2015_08_01::Models::TopicCreateOrUpdateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ServiceBus::Api_2015_08_01::Models::TopicResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
