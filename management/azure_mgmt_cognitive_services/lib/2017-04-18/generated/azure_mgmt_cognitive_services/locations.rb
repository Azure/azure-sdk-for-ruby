...
module Azure::CognitiveServices::Mgmt::V2017_04_18
  ...
  class Locations
    ...
    #
    def check_domain_availability_post(location, subdomain_name, type, custom_headers = nil)
      response = check_domain_availability_post_async(location, subdomain_name, type, custom_headers).value!
    ...
    #
    def check_domain_availability_post_with_http_info(location, subdomain_name, type, custom_headers = nil)
      check_domain_availability_post_async(location, subdomain_name, type, custom_headers).value!
    end
    ...
    #
    def check_domain_availability_post_async(location, subdomain_name, type, custom_headers = nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/checkDomainAvailability'
