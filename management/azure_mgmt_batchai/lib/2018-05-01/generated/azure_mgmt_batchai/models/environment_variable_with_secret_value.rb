...
module Azure::BatchAI::Mgmt::V2018_05_01
  module Models
    ...
    class EnvironmentVariableWithSecretValue
      ...
      # @return [String] Name. The name of the environment variable to store
      # the secret value.
      attr_accessor :name

      # @return [String] Value. The value of the environment variable. This
      # value will never be reported back by Batch AI.
      attr_accessor :value

      # @return [KeyVaultSecretReference] KeyVault secret reference. KeyVault
