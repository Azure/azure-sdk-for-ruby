...
module Azure::BatchAI::Mgmt::V2018_05_01
  module Models
    ...
    class AppInsightsReference
      ...
      # @return [ResourceId] Component ID. Azure Application Insights component
      # resource ID.
      attr_accessor :component

      # @return [String] Instrumentation Key. Value of the Azure Application
      # Insights instrumentation key.
      attr_accessor :instrumentation_key

      # @return [KeyVaultSecretReference] Instrumentation key KeyVault Secret
      # reference. KeyVault Store and Secret which contains Azure Application
