...
module Azure::BatchAI::Mgmt::V2018_05_01
  module Models
    ...
    class JobPropertiesExecutionInfo
      ...
      # @return [DateTime] Start time. The time at which the job started
      # running. 'Running' corresponds to the running state. If the job has
      # been restarted or retried, this is the most recent time at which the
      # job started running. This property is present only for job that are in
      # the running or completed state.
      attr_accessor :start_time

      # @return [DateTime] End time. The time at which the job completed. This
      # property is only returned if the job is in completed state.
      attr_accessor :end_time

      # @return [Integer] Exit code. The exit code of the job. This property is
      # only returned if the job is in completed state.
      attr_accessor :exit_code

      # @return [Array<BatchAIError>] Errors. A collection of errors
