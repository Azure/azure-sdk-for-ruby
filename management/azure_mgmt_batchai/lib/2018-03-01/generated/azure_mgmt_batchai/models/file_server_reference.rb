...
module Azure::BatchAI::Mgmt::V2018_03_01
  module Models
    ...
    class FileServerReference
      ...
      # the File Server will be mounted. Note that all cluster level file
      # servers will be mounted under $AZ_BATCHAI_MOUNT_ROOT location and job
      # level file servers will be mounted under $AZ_BATCHAI_JOB_MOUNT_ROOT.
