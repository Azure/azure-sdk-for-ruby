...
module Azure::EventHub::Mgmt::V2017_04_01
  ...
  class Namespaces
    ...
    def create_or_update_network_rule_set_async(resource_group_name, namespace_name, parameters, custom_headers = nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/networkRuleSet/default'
