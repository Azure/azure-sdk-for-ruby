...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  ...
  class VirtualMachines
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ResponseWithContinuationLabVirtualMachine.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, lab_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::LabVirtualMachine.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, lab_name, name, lab_virtual_machine, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::LabVirtualMachine.new.from_json(parsed_response)
        end
    ...
    def update_async(resource_group_name, lab_name, name, lab_virtual_machine, custom_headers = nil)
      ...
      # Serialize Request
      request_content = lab_virtual_machine.nil? ? nil: lab_virtual_machine.to_json
    ...
    def list_applicable_schedules_async(resource_group_name, lab_name, name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ApplicableSchedule.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_add_data_disk_async(resource_group_name, lab_name, name, data_disk_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = data_disk_properties.nil? ? nil: data_disk_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_apply_artifacts_async(resource_group_name, lab_name, name, apply_artifacts_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = apply_artifacts_request.nil? ? nil: apply_artifacts_request.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_detach_data_disk_async(resource_group_name, lab_name, name, detach_data_disk_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = detach_data_disk_properties.nil? ? nil: detach_data_disk_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
