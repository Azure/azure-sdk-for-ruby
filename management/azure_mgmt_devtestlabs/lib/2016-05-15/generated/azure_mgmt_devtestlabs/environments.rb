...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  ...
  class Environments
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ResponseWithContinuationDtlEnvironment.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, lab_name, user_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::DtlEnvironment.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::DtlEnvironment.new.from_json(parsed_response)
        end
    ...
    def begin_create_or_update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers = nil)
      ...
      # Serialize Request
      request_content = dtl_environment.nil? ? nil: dtl_environment.to_json
