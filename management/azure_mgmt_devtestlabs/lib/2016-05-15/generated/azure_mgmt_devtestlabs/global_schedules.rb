...
module Azure::ARM::DevTestLabs::Api_2016_05_15
  ...
  class GlobalSchedules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::ResponseWithContinuationSchedule.mapper()
    ...
    def get_async(resource_group_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::Schedule.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, name, schedule, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::Schedule.mapper()
    ...
    def update_async(resource_group_name, name, schedule, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::ScheduleFragment.mapper()
      request_content = @client.serialize(request_mapper,  schedule)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_retarget_async(resource_group_name, name, retarget_schedule_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::RetargetScheduleProperties.mapper()
