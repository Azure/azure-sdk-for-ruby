...
module Azure::ARM::DevTestLabs::Api_2016_05_15
  ...
  class VirtualNetworks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::ResponseWithContinuationVirtualNetwork.mapper()
    ...
    def get_async(resource_group_name, lab_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::VirtualNetwork.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, lab_name, name, virtual_network, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::VirtualNetworkFragment.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, lab_name, name, virtual_network, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Api_2016_05_15::Models::VirtualNetwork.mapper()
      request_content = @client.serialize(request_mapper,  virtual_network)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
