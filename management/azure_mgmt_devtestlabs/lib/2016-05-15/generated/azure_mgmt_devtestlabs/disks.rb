...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  ...
  class Disks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ResponseWithContinuationDisk.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, lab_name, user_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::Disk.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, lab_name, user_name, name, disk, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::Disk.new.from_json(parsed_response)
        end
    ...
    def begin_attach_async(resource_group_name, lab_name, user_name, name, attach_disk_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = attach_disk_properties.nil? ? nil: attach_disk_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_detach_async(resource_group_name, lab_name, user_name, name, detach_disk_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = detach_disk_properties.nil? ? nil: detach_disk_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
