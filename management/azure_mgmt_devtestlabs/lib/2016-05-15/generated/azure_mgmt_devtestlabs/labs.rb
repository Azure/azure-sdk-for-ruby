...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  ...
  class Labs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ResponseWithContinuationLab.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::Lab.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, name, lab, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::Lab.new.from_json(parsed_response)
        end
    ...
    def update_async(resource_group_name, name, lab, custom_headers = nil)
      ...
      # Serialize Request
      request_content = lab.nil? ? nil: lab.to_json
    ...
    def generate_upload_uri_async(resource_group_name, name, generate_upload_uri_parameter, custom_headers = nil)
      ...
      # Serialize Request
      request_content = generate_upload_uri_parameter.nil? ? nil: generate_upload_uri_parameter.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::GenerateUploadUriResponse.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_vhds_async(resource_group_name, name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::DevTestLabs::Mgmt::V2016_05_15::Models::ResponseWithContinuationLabVhd.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_environment_async(resource_group_name, name, lab_virtual_machine_creation_parameter, custom_headers = nil)
      ...
      # Serialize Request
      request_content = lab_virtual_machine_creation_parameter.nil? ? nil: lab_virtual_machine_creation_parameter.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_export_resource_usage_async(resource_group_name, name, export_resource_usage_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = export_resource_usage_parameters.nil? ? nil: export_resource_usage_parameters.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
