...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Disks
    ...
    def update(resource_group_name, lab_name, user_name, name, disk, custom_headers = nil)
      response = update_async(resource_group_name, lab_name, user_name, name, disk, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(resource_group_name, lab_name, user_name, name, disk, custom_headers = nil)
      update_async(resource_group_name, lab_name, user_name, name, disk, custom_headers).value!
    end
