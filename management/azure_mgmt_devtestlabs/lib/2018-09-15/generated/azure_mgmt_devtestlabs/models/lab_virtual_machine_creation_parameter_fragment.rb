...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  module Models
    ...
    class LabVirtualMachineCreationParameterFragment
      ...
      # @return [BulkCreationParametersFragment] The number of virtual machine
      # instances to create.
      ...
      #
      # Mapper for LabVirtualMachineCreationParameterFragment class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          required: false,
          serialized_name: 'LabVirtualMachineCreationParameterFragment',
          type: {
            name: 'Composite',
