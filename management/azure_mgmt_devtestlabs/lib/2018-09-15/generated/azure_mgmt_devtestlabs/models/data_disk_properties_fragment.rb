...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  module Models
    ...
    class DataDiskPropertiesFragment
      ...
      # @return [AttachNewDataDiskOptionsFragment] Specifies options to attach
      ...
      #
      # Mapper for DataDiskPropertiesFragment class as Ruby Hash.
      # This will be used for serialization/deserialization.
      #
      def self.mapper()
        {
          required: false,
          serialized_name: 'DataDiskPropertiesFragment',
          type: {
            name: 'Composite',
