...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Labs
    ...
    def import_virtual_machine(resource_group_name, name, import_lab_virtual_machine_request, custom_headers = nil)
      response = import_virtual_machine_async(resource_group_name, name, import_lab_virtual_machine_request, custom_headers).value!
      nil
    end
    ...
    def import_virtual_machine_async(resource_group_name, name, import_lab_virtual_machine_request, custom_headers = nil)
      # Send request
      promise = begin_import_virtual_machine_async(resource_group_name, name, import_lab_virtual_machine_request, custom_headers)
    ...
    def begin_import_virtual_machine(resource_group_name, name, import_lab_virtual_machine_request, custom_headers = nil)
      response = begin_import_virtual_machine_async(resource_group_name, name, import_lab_virtual_machine_request, custom_headers).value!
      nil
    end
    ...
    def begin_import_virtual_machine_with_http_info(resource_group_name, name, import_lab_virtual_machine_request, custom_headers = nil)
      begin_import_virtual_machine_async(resource_group_name, name, import_lab_virtual_machine_request, custom_headers).value!
    end
