...
module Azure::ARM::DevTestLabs
  ...
  class Policies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DevTestLabs::Models::ResponseWithContinuationPolicy.mapper()
    ...
    def get_async(resource_group_name, lab_name, policy_set_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DevTestLabs::Models::Policy.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, lab_name, policy_set_name, name, policy, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Models::Policy.mapper()
    ...
    def update_async(resource_group_name, lab_name, policy_set_name, name, policy, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Models::PolicyFragment.mapper()
      request_content = @client.serialize(request_mapper,  policy)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
