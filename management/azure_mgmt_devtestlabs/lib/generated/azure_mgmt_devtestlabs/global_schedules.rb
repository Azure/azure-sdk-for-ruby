...
module Azure::ARM::DevTestLabs
  ...
  class GlobalSchedules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::DevTestLabs::Models::ResponseWithContinuationSchedule.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::DevTestLabs::Models::Schedule.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, name, schedule, custom_headers = nil)
      ...
      # Serialize Request
      request_content = schedule.to_json
    ...
    def begin_retarget_async(resource_group_name, name, retarget_schedule_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = retarget_schedule_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
