...
module Azure::ARM::DevTestLabs
  ...
  class ServiceRunners
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DevTestLabs::Models::ResponseWithContinuationServiceRunner.mapper()
    ...
    def get_async(resource_group_name, lab_name, name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DevTestLabs::Models::ServiceRunner.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, lab_name, name, service_runner, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DevTestLabs::Models::ServiceRunner.mapper()
      request_content = @client.serialize(request_mapper,  service_runner, 'service_runner')
