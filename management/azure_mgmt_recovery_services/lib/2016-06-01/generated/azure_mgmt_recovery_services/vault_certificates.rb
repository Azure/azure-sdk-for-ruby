...
module Azure::RecoveryServices::Mgmt::V2016_06_01
  ...
  class VaultCertificates
    ...
    def create_async(resource_group_name, vault_name, certificate_name, certificate_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = certificate_request.nil? ? nil: certificate_request.to_json
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServices::Mgmt::V2016_06_01::Models::VaultCertificateResponse.new.from_json(parsed_response)
          rescue Exception => e
