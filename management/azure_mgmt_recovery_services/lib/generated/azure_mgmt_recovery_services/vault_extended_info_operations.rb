...
module Azure::ARM::RecoveryServices
  ...
  class VaultExtendedInfoOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::RecoveryServices::Models::VaultExtendedInfoResource.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, vault_name, resource_resource_extended_info_details, custom_headers = nil)
      ...
      # Serialize Request
      request_content = resource_resource_extended_info_details.to_json
