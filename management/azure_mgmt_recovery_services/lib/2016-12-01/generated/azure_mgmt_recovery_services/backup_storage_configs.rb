...
module Azure::ARM::RecoveryServices::Api_2016_12_01
  ...
  class BackupStorageConfigs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::RecoveryServices::Api_2016_12_01::Models::BackupStorageConfig.mapper()
    ...
    def update_async(resource_group_name, vault_name, backup_storage_config, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::RecoveryServices::Api_2016_12_01::Models::BackupStorageConfig.mapper()
