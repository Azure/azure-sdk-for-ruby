...
module Azure::RecoveryServices::Mgmt::V2016_12_01
  ...
  class BackupStorageConfigs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::RecoveryServices::Mgmt::V2016_12_01::Models::BackupStorageConfig.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def update_async(resource_group_name, vault_name, backup_storage_config, custom_headers = nil)
      ...
      # Serialize Request
      request_content = backup_storage_config.nil? ? nil: backup_storage_config.to_json
