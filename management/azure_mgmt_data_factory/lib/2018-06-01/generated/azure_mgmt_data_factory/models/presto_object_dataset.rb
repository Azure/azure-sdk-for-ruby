...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class PrestoObjectDataset < Dataset
      ...
      # @return The table name of the Presto. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Presto. Type: string (or Expression with
      # resultType string).
      attr_accessor :presto_object_dataset_schema


      #
      # Mapper for PrestoObjectDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PrestoObject',
          type: {
            name: 'Composite',
            class_name: 'PrestoObjectDataset',
            model_properties: {
