...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class DelimitedTextSink < CopySink
      ...
      # @return [StoreWriteSettings] DelimitedText store settings.
      attr_accessor :store_settings

      # @return [DelimitedTextWriteSettings] DelimitedText format settings.
      attr_accessor :format_settings


      #
      # Mapper for DelimitedTextSink class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DelimitedTextSink',
          type: {
            name: 'Composite',
            class_name: 'DelimitedTextSink',
            model_properties: {
