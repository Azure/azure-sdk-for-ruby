...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class ImpalaObjectDataset < Dataset
      ...
      # @return The table name of the Impala. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Impala. Type: string (or Expression with
      # resultType string).
      attr_accessor :impala_object_dataset_schema


      #
      # Mapper for ImpalaObjectDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ImpalaObject',
          type: {
            name: 'Composite',
            class_name: 'ImpalaObjectDataset',
            model_properties: {
