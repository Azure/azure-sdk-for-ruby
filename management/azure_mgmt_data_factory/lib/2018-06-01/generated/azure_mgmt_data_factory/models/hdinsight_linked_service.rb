...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class HDInsightLinkedService < LinkedService
      ...
      # @return Specify if the HDInsight is created with ESP (Enterprise
      # Security Package). Type: Boolean.
      attr_accessor :is_esp_enabled

      # @return Specify the FileSystem if the main storage for the HDInsight is
          ...
          type: {
            ...
            model_properties: {
              ...
              is_esp_enabled: {
                client_side_validation: true,
                required: false,
                serialized_name: 'typeProperties.isEspEnabled',
                type: {
                  name: 'Object'
                }
              },
              file_system: {
                client_side_validation: true,
                required: false,
                serialized_name: 'typeProperties.fileSystem',
                type: {
                  name: 'Object'
                }
              }
