...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class NetezzaTableDataset < Dataset
      ...
      # @return The table name of the Netezza. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Netezza. Type: string (or Expression
      # with resultType string).
      attr_accessor :netezza_table_dataset_schema
