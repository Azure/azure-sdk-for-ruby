...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class DynamicsCrmSource < CopySource
      ...
      # Microsoft Dynamics CRM (online & on-premises). Type: string (or
      ...
      #
      # Mapper for DynamicsCrmSource class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DynamicsCrmSource',
          type: {
            name: 'Composite',
            class_name: 'DynamicsCrmSource',
            model_properties: {
