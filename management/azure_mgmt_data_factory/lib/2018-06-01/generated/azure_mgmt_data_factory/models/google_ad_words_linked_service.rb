...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class GoogleAdWordsLinkedService < LinkedService
      ...
      # @return The Client customer ID of the AdWords account that you want to
      # fetch report data for.
      attr_accessor :client_customer_id

      # @return [SecretBase] The developer token associated with the manager
      # account that you use to grant access to the AdWords API.
      attr_accessor :developer_token

      # @return [GoogleAdWordsAuthenticationType] The OAuth 2.0 authentication
      ...
      #
      # Mapper for GoogleAdWordsLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GoogleAdWords',
          type: {
            name: 'Composite',
            class_name: 'GoogleAdWordsLinkedService',
            model_properties: {
              ...
              client_customer_id: {
                client_side_validation: true,
                required: true,
                serialized_name: 'typeProperties.clientCustomerID',
                type: {
                  name: 'Object'
                }
              },
              developer_token: {
                client_side_validation: true,
                required: true,
                serialized_name: 'typeProperties.developerToken',
                type: {
                  name: 'Composite',
