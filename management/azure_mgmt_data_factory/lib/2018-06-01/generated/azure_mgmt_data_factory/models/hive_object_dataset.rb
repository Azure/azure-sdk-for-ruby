...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class HiveObjectDataset < Dataset
      ...
      # @return The table name of the Hive. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Hive. Type: string (or Expression with
      # resultType string).
      attr_accessor :hive_object_dataset_schema


      #
      # Mapper for HiveObjectDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HiveObject',
          type: {
            name: 'Composite',
            class_name: 'HiveObjectDataset',
            model_properties: {
