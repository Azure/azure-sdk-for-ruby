...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class TeradataPartitionSettings
      ...
      # or hash partitioning. Type: string (or Expression with resultType
      # string).
      ...
      #
      # Mapper for TeradataPartitionSettings class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'TeradataPartitionSettings',
          type: {
            name: 'Composite',
