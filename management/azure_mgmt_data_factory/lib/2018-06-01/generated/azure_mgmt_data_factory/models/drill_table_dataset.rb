...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class DrillTableDataset < Dataset
      ...
      # @return The table name of the Drill. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Drill. Type: string (or Expression with
      # resultType string).
      attr_accessor :drill_table_dataset_schema


      #
      # Mapper for DrillTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DrillTable',
          type: {
            name: 'Composite',
            class_name: 'DrillTableDataset',
            model_properties: {
