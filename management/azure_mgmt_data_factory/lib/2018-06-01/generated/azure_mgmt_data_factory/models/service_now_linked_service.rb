...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class ServiceNowLinkedService < LinkedService
      ...
      # @return The endpoint of the ServiceNow server. (i.e.
      # <instance>.service-now.com)
      attr_accessor :endpoint

      # @return [ServiceNowAuthenticationType] The authentication type to use.
      # Possible values include: 'Basic', 'OAuth2'
      attr_accessor :authentication_type

      # @return The user name used to connect to the ServiceNow server for
      # Basic and OAuth2 authentication.
      attr_accessor :username

      # @return [SecretBase] The password corresponding to the user name for
      # Basic and OAuth2 authentication.
      ...
      # @return [SecretBase] The client secret for OAuth2 authentication.
      ...
      #
      # Mapper for ServiceNowLinkedService class as Ruby Hash.
