...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class VerticaTableDataset < Dataset
      ...
      # @return The table name of the Vertica. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Vertica. Type: string (or Expression
      # with resultType string).
      attr_accessor :vertica_table_dataset_schema


      #
      # Mapper for VerticaTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'VerticaTable',
          type: {
            name: 'Composite',
            class_name: 'VerticaTableDataset',
            model_properties: {
