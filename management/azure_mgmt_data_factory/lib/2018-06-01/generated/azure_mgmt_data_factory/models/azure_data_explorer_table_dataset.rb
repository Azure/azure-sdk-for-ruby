...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class AzureDataExplorerTableDataset < Dataset
      ...
      # @return The table name of the Azure Data Explorer database. Type:
      # string (or Expression with resultType string).
      attr_accessor :table


      #
      # Mapper for AzureDataExplorerTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureDataExplorerTable',
          type: {
            name: 'Composite',
            class_name: 'AzureDataExplorerTableDataset',
            model_properties: {
