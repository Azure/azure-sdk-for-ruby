...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class SftpReadSettings < StoreReadSettings
      ...
      # @return Sftp wildcardFolderPath. Type: string (or Expression with
      # resultType string).
      attr_accessor :wildcard_folder_path

      # @return Sftp wildcardFileName. Type: string (or Expression with
      # resultType string).
      ...
      #
      # Mapper for SftpReadSettings class as Ruby Hash.
