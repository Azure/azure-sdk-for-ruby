...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class OdbcTableDataset < Dataset
      ...
      # @return The ODBC table name. Type: string (or Expression with
      # resultType string).
      attr_accessor :table_name


      #
      # Mapper for OdbcTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'OdbcTable',
          type: {
            name: 'Composite',
            class_name: 'OdbcTableDataset',
            model_properties: {
