...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class AzureMariaDBLinkedService < LinkedService
      ...
      #
      # Mapper for AzureMariaDBLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureMariaDB',
          type: {
            name: 'Composite',
            class_name: 'AzureMariaDBLinkedService',
            model_properties: {
              ...
              pwd: {
                client_side_validation: true,
                required: false,
                serialized_name: 'typeProperties.pwd',
                type: {
                  name: 'Composite',
