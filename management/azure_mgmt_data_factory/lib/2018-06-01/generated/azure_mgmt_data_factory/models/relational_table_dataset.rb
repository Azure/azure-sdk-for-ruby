...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class RelationalTableDataset < Dataset
      ...
      # @return The relational table name. Type: string (or Expression with
      # resultType string).
      attr_accessor :table_name


      #
      # Mapper for RelationalTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RelationalTable',
          type: {
            name: 'Composite',
            class_name: 'RelationalTableDataset',
            model_properties: {
