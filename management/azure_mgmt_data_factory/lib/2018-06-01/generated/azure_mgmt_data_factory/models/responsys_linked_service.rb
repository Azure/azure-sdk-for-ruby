...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class ResponsysLinkedService < LinkedService
      ...
      # @return The client ID associated with the Responsys application. Type:
      # string (or Expression with resultType string).
      attr_accessor :client_id

      # @return [SecretBase] The client secret associated with the Responsys
      ...
      #
      # Mapper for ResponsysLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Responsys',
          type: {
            name: 'Composite',
            class_name: 'ResponsysLinkedService',
            model_properties: {
