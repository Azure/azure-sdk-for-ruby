...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class GoogleCloudStorageReadSettings < StoreReadSettings
      ...
      # @return Google Cloud Storage wildcardFolderPath. Type: string (or
      # Expression with resultType string).
      attr_accessor :wildcard_folder_path

      # @return Google Cloud Storage wildcardFileName. Type: string (or
      # Expression with resultType string).
      attr_accessor :wildcard_file_name

      # @return The prefix filter for the Google Cloud Storage object name.
      ...
      #
      # Mapper for GoogleCloudStorageReadSettings class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GoogleCloudStorageReadSettings',
          type: {
            name: 'Composite',
            class_name: 'GoogleCloudStorageReadSettings',
            model_properties: {
