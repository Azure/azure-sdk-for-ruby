...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class SapTableResourceDataset < Dataset
      ...
      # @return The name of the SAP Table. Type: string (or Expression with
      # resultType string).
      attr_accessor :table_name


      #
      # Mapper for SapTableResourceDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SapTableResource',
          type: {
            name: 'Composite',
            class_name: 'SapTableResourceDataset',
            model_properties: {
