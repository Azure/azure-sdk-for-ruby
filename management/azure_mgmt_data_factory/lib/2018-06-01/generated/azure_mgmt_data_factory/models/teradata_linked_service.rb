...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class TeradataLinkedService < LinkedService
      ...
      # @return [TeradataAuthenticationType] AuthenticationType to be used for
      ...
      #
      # Mapper for TeradataLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Teradata',
          type: {
            name: 'Composite',
            class_name: 'TeradataLinkedService',
            model_properties: {
