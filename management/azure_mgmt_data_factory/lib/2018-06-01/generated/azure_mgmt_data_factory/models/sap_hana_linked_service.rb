...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class SapHanaLinkedService < LinkedService
      ...
      # @return SAP HANA ODBC connection string. Type: string, SecureString or
      # AzureKeyVaultSecretReference.
      attr_accessor :connection_string

      # @return Host name of the SAP HANA server. Type: string (or Expression
      # with resultType string).
      attr_accessor :server

      # @return [SapHanaAuthenticationType] The authentication type to be used
      # to connect to the SAP HANA server. Possible values include: 'Basic',
      # 'Windows'
      attr_accessor :authentication_type

      # @return Username to access the SAP HANA server. Type: string (or
      # Expression with resultType string).
      attr_accessor :user_name

      # @return [SecretBase] Password to access the SAP HANA server.
      ...
      #
      # Mapper for SapHanaLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SapHana',
          type: {
            name: 'Composite',
            class_name: 'SapHanaLinkedService',
            model_properties: {
