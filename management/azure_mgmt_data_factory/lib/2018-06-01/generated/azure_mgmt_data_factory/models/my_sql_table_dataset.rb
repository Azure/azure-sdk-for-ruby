...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class MySqlTableDataset < Dataset
      ...
      # @return The MySQL table name. Type: string (or Expression with
      # resultType string).
      attr_accessor :table_name


      #
      # Mapper for MySqlTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MySqlTable',
          type: {
            name: 'Composite',
            class_name: 'MySqlTableDataset',
            model_properties: {
