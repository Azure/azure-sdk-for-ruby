...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class MicrosoftAccessLinkedService < LinkedService
      ...
      # @return Type of authentication used to connect to the Microsoft Access
      ...
      #
      # Mapper for MicrosoftAccessLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MicrosoftAccess',
          type: {
            name: 'Composite',
            class_name: 'MicrosoftAccessLinkedService',
            model_properties: {
