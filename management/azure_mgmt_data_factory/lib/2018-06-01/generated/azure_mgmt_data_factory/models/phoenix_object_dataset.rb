...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class PhoenixObjectDataset < Dataset
      ...
      # @return The table name of the Phoenix. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The schema name of the Phoenix. Type: string (or Expression
      # with resultType string).
      attr_accessor :phoenix_object_dataset_schema


      #
      # Mapper for PhoenixObjectDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PhoenixObject',
          type: {
            name: 'Composite',
            class_name: 'PhoenixObjectDataset',
            model_properties: {
