...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class PostgreSqlTableDataset < Dataset
      ...
      # @return The PostgreSQL table name. Type: string (or Expression with
      # resultType string).
      attr_accessor :table

      # @return The PostgreSQL schema name. Type: string (or Expression with
      # resultType string).
      attr_accessor :postgre_sql_table_dataset_schema


      #
      # Mapper for PostgreSqlTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PostgreSqlTable',
          type: {
            name: 'Composite',
            class_name: 'PostgreSqlTableDataset',
            model_properties: {
              ...
              postgre_sql_table_dataset_schema: {
                client_side_validation: true,
                required: false,
