...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class AzureSqlDWTableDataset < Dataset
      ...
      # @return The schema name of the Azure SQL Data Warehouse. Type: string
      # (or Expression with resultType string).
      attr_accessor :azure_sql_dwtable_dataset_schema

      # @return The table name of the Azure SQL Data Warehouse. Type: string
      # (or Expression with resultType string).
      attr_accessor :table


      #
      # Mapper for AzureSqlDWTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureSqlDWTable',
          type: {
            name: 'Composite',
            class_name: 'AzureSqlDWTableDataset',
            model_properties: {
              ...
              azure_sql_dwtable_dataset_schema: {
                client_side_validation: true,
                required: false,
