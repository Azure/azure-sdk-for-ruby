...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class DynamicsCrmLinkedService < LinkedService
      ...
      # @return [DynamicsDeploymentType] The deployment type of the Dynamics
      # CRM instance. 'Online' for Dynamics CRM Online and 'OnPremisesWithIfd'
      # for Dynamics CRM on-premises with Ifd. Type: string (or Expression with
      # resultType string). Possible values include: 'Online',
      # 'OnPremisesWithIfd'
      attr_accessor :deployment_type

      # @return The host name of the on-premises Dynamics CRM server. The
      # property is required for on-prem and not allowed for online. Type:
      # string (or Expression with resultType string).
      attr_accessor :host_name

      # @return The port of on-premises Dynamics CRM server. The property is
      # required for on-prem and not allowed for online. Default is 443. Type:
      # integer (or Expression with resultType integer), minimum: 0.
      attr_accessor :port

      # @return The URL to the Microsoft Dynamics CRM server. The property is
      # required for on-line and not allowed for on-prem. Type: string (or
      # Expression with resultType string).
      attr_accessor :service_uri

      # @return The organization name of the Dynamics CRM instance. The
      # property is required for on-prem and required for online when there are
      # more than one Dynamics CRM instances associated with the user. Type:
      # string (or Expression with resultType string).
      ...
      # @return User name to access the Dynamics CRM instance. Type: string (or
      # Expression with resultType string).
      attr_accessor :username

      # @return [SecretBase] Password to access the Dynamics CRM instance.
      ...
      #
      # Mapper for DynamicsCrmLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DynamicsCrm',
          type: {
            name: 'Composite',
            class_name: 'DynamicsCrmLinkedService',
            model_properties: {
