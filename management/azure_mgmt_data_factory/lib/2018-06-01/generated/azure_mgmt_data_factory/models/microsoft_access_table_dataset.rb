...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class MicrosoftAccessTableDataset < Dataset
      ...
      # @return The Microsoft Access table name. Type: string (or Expression
      # with resultType string).
      attr_accessor :table_name


      #
      # Mapper for MicrosoftAccessTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MicrosoftAccessTable',
          type: {
            name: 'Composite',
            class_name: 'MicrosoftAccessTableDataset',
            model_properties: {
