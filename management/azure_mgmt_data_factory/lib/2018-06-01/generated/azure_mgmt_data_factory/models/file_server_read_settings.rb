...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class FileServerReadSettings < StoreReadSettings
      ...
      # @return FileServer wildcardFolderPath. Type: string (or Expression with
      # resultType string).
      attr_accessor :wildcard_folder_path

      # @return FileServer wildcardFileName. Type: string (or Expression with
      # resultType string).
      ...
      #
      # Mapper for FileServerReadSettings class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'FileServerReadSettings',
          type: {
            name: 'Composite',
            class_name: 'FileServerReadSettings',
            model_properties: {
