...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class HubspotLinkedService < LinkedService
      ...
      # @return [SecretBase] The client secret associated with your Hubspot
      # application.
      attr_accessor :client_secret

      # @return [SecretBase] The access token obtained when initially
      # authenticating your OAuth integration.
      attr_accessor :access_token

      # @return [SecretBase] The refresh token obtained when initially
      # authenticating your OAuth integration.
      ...
      #
      # Mapper for HubspotLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Hubspot',
          type: {
            name: 'Composite',
            class_name: 'HubspotLinkedService',
            model_properties: {
