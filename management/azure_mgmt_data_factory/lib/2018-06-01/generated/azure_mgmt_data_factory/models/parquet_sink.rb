...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class ParquetSink < CopySink
      ...
      # @return [StoreWriteSettings] Parquet store settings.
      attr_accessor :store_settings

      # @return [ParquetWriteSettings] Parquet format settings.
      attr_accessor :format_settings


      #
      # Mapper for ParquetSink class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ParquetSink',
          type: {
            name: 'Composite',
            class_name: 'ParquetSink',
            model_properties: {
