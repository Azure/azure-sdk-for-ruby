...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class AzureSqlTableDataset < Dataset
      ...
      # @return The schema name of the Azure SQL database. Type: string (or
      # Expression with resultType string).
      attr_accessor :azure_sql_table_dataset_schema

      # @return The table name of the Azure SQL database. Type: string (or
      # Expression with resultType string).
      attr_accessor :table


      #
      # Mapper for AzureSqlTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureSqlTable',
          type: {
            name: 'Composite',
            class_name: 'AzureSqlTableDataset',
            model_properties: {
