...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class SybaseTableDataset < Dataset
      ...
      # @return The Sybase table name. Type: string (or Expression with
      # resultType string).
      attr_accessor :table_name


      #
      # Mapper for SybaseTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SybaseTable',
          type: {
            name: 'Composite',
            class_name: 'SybaseTableDataset',
            model_properties: {
