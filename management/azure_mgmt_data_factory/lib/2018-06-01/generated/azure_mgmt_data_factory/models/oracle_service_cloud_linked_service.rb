...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class OracleServiceCloudLinkedService < LinkedService
      ...
      # @return The user name that you use to access Oracle Service Cloud
      # server.
      ...
      #
      # Mapper for OracleServiceCloudLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'OracleServiceCloud',
          type: {
            name: 'Composite',
            class_name: 'OracleServiceCloudLinkedService',
            model_properties: {
