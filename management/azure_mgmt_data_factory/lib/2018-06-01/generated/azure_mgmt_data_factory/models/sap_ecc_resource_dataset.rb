...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class SapEccResourceDataset < Dataset
      ...
      # @return The path of the SAP ECC OData entity. Type: string (or
      # Expression with resultType string).
      attr_accessor :path


      #
      # Mapper for SapEccResourceDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SapEccResource',
          type: {
            name: 'Composite',
            class_name: 'SapEccResourceDataset',
            model_properties: {
