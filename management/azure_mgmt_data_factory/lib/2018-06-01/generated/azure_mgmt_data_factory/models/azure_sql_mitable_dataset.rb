...
module Azure::DataFactory::Mgmt::V2018_06_01
  module Models
    ...
    class AzureSqlMITableDataset < Dataset
      ...
      # @return The schema name of the Azure SQL Managed Instance. Type: string
      # (or Expression with resultType string).
      attr_accessor :azure_sql_mitable_dataset_schema

      # @return The table name of the Azure SQL Managed Instance dataset. Type:
      # string (or Expression with resultType string).
      attr_accessor :table


      #
      # Mapper for AzureSqlMITableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureSqlMITable',
          type: {
            name: 'Composite',
            class_name: 'AzureSqlMITableDataset',
            model_properties: {
              ...
              azure_sql_mitable_dataset_schema: {
                client_side_validation: true,
                required: false,
