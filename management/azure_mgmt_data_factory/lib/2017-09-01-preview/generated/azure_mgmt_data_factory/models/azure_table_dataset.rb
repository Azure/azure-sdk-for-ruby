...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class AzureTableDataset < Dataset
      ...
      # @return The table name of the Azure Table storage. Type: string (or
      # Expression with resultType string).
      attr_accessor :table_name


      #
      # Mapper for AzureTableDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AzureTable',
          type: {
            name: 'Composite',
            class_name: 'AzureTableDataset',
            model_properties: {
