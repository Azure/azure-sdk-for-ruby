...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class ZohoLinkedService < LinkedService
      ...
      # @return [SecretBase] The access token for Zoho authentication.
      ...
      #
      # Mapper for ZohoLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Zoho',
          type: {
            name: 'Composite',
            class_name: 'ZohoLinkedService',
            model_properties: {
