...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class MarketoLinkedService < LinkedService
      ...
      # @return The endpoint of the Marketo server. (i.e.
      ...
      # @return [SecretBase] The client secret of your Marketo service.
      ...
      #
      # Mapper for MarketoLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Marketo',
          type: {
            name: 'Composite',
            class_name: 'MarketoLinkedService',
            model_properties: {
