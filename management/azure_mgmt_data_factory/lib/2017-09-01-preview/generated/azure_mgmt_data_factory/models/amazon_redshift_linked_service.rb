...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class AmazonRedshiftLinkedService < LinkedService
      ...
      # @return The name of the Amazon Redshift server. Type: string (or
      # Expression with resultType string).
      attr_accessor :server

      # @return The username of the Amazon Redshift source. Type: string (or
      # Expression with resultType string).
      attr_accessor :username

      # @return [SecretBase] The password of the Amazon Redshift source.
      attr_accessor :password

      # @return The database name of the Amazon Redshift source. Type: string
      # (or Expression with resultType string).
      attr_accessor :database

      # @return The TCP port number that the Amazon Redshift server uses to
      ...
      #
      # Mapper for AmazonRedshiftLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AmazonRedshift',
          type: {
            name: 'Composite',
            class_name: 'AmazonRedshiftLinkedService',
            model_properties: {
