...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class CopyActivity < ExecutionActivity
      ...
      # @return Maximum number of cloud data movement units that can be used to
      # perform this data movement. Type: integer (or Expression with
      # resultType integer), minimum: 0.
      attr_accessor :cloud_data_movement_units
          ...
          type: {
            ...
            model_properties: {
              ...
              cloud_data_movement_units: {
                client_side_validation: true,
                required: false,
                serialized_name: 'typeProperties.cloudDataMovementUnits',
                type: {
                  name: 'Object'
                }
              },
