...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class OdbcLinkedService < LinkedService
      ...
      # @return Type of authentication used to connect to the ODBC data store.
      # Possible values are: Anonymous and Basic. Type: string (or Expression
      ...
      #
      # Mapper for OdbcLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'Odbc',
          type: {
            name: 'Composite',
            class_name: 'OdbcLinkedService',
            model_properties: {
