...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class SalesforceMarketingCloudObjectDataset < Dataset
      ...
      #
      # Mapper for SalesforceMarketingCloudObjectDataset class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SalesforceMarketingCloudObject',
          type: {
            name: 'Composite',
            class_name: 'SalesforceMarketingCloudObjectDataset',
            model_properties: {
