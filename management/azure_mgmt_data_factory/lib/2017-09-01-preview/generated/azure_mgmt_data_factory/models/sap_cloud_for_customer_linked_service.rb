...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class SapCloudForCustomerLinkedService < LinkedService
      ...
      # @return The URL of SAP Cloud for Customer OData API. For example,
      # '[https://[tenantname].crm.ondemand.com/sap/c4c/odata/v1]'. Type:
      # string (or Expression with resultType string).
      attr_accessor :url

      # @return The username for Basic authentication. Type: string (or
      ...
      #
      # Mapper for SapCloudForCustomerLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SapCloudForCustomer',
          type: {
            name: 'Composite',
            class_name: 'SapCloudForCustomerLinkedService',
            model_properties: {
