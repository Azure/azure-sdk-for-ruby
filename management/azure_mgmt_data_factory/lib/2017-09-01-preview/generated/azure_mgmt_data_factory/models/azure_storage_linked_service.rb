...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  module Models
    ...
    class AzureStorageLinkedService < LinkedService
      ...
      # @return [SecretBase] SAS URI of the Azure Storage resource. It is
      ...
      #
      # Mapper for AzureStorageLinkedService class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          type: {
            name: 'Composite',
            class_name: 'AzureStorageLinkedService',
            model_properties: {
