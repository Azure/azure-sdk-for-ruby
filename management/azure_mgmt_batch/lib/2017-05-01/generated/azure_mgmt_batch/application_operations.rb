      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result.body = Azure::Batch::Mgmt::V2017_05_01::Models::Application.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_async(resource_group_name, account_name, maxresults = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Batch::Mgmt::V2017_05_01::Models::ListApplicationsResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
