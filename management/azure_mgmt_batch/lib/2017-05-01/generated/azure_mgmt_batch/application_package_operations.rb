...
module Azure::ARM::Batch::Api_2017_05_01
  ...
  class ApplicationPackageOperations
    ...
    def activate_async(resource_group_name, account_name, application_id, version, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Batch::Api_2017_05_01::Models::ActivateApplicationPackageParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::ARM::Batch::Api_2017_05_01::Models::ApplicationPackage.mapper()
