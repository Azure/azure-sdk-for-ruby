...
module Azure::Batch::Mgmt::V2019_08_01
  module Models
    ...
    class Pool < ProxyResource
      ...
      # @return [Array<MountConfiguration>] A list of file systems to mount on
      # each node in the pool. This supports Azure Files, NFS, CIFS/SMB, and
      # Blobfuse.
      attr_accessor :mount_configuration
          ...
          type: {
            ...
            model_properties: {
              ...
              mount_configuration: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.mountConfiguration',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'MountConfigurationElementType',
                      type: {
                        name: 'Composite',
