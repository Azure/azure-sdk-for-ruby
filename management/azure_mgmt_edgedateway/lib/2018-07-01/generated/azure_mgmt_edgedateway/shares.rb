...
module Azure::Compute::Mgmt::V2018_07_01
  ...
  class Shares
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::ShareList.mapper()
    ...
    def get_async(device_name, name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::Share.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # @param device_name [String] Name of the device.
    # @param name [String] Name of the share which needs to be added/updated.
    # @param share [Share] The share object containing the share details.
    # @param resource_group_name [String] The resource group name.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    def create_or_update(device_name, name, share, resource_group_name, custom_headers = nil)
      response = create_or_update_async(device_name, name, share, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(device_name, name, share, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(device_name, name, share, resource_group_name, custom_headers)
    ...
    #
    # @param device_name [String] Name of the device.
    # @param name [String] Name of the share which needs to be deleted.
    # @param resource_group_name [String] The resource group name.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    def delete(device_name, name, resource_group_name, custom_headers = nil)
      response = delete_async(device_name, name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(device_name, name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(device_name, name, resource_group_name, custom_headers)
    ...
    #
    # Triggers a manual refresh of the share metadata with the actual cloud storage
    # account.
    #
    # @param device_name [String] Name of the device.
    # @param name [String] Name of the share.
    ...
    def refresh(device_name, name, resource_group_name, custom_headers = nil)
      response = refresh_async(device_name, name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def refresh_async(device_name, name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_refresh_async(device_name, name, resource_group_name, custom_headers)
    ...
    def begin_create_or_update(device_name, name, share, resource_group_name, custom_headers = nil)
      response = begin_create_or_update_async(device_name, name, share, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(device_name, name, share, resource_group_name, custom_headers = nil)
      begin_create_or_update_async(device_name, name, share, resource_group_name, custom_headers).value!
    end
    ...
    def begin_create_or_update_async(device_name, name, share, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::Share.mapper()
    ...
    def begin_delete(device_name, name, resource_group_name, custom_headers = nil)
      response = begin_delete_async(device_name, name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(device_name, name, resource_group_name, custom_headers = nil)
      begin_delete_async(device_name, name, resource_group_name, custom_headers).value!
    end
    ...
    def begin_refresh(device_name, name, resource_group_name, custom_headers = nil)
      response = begin_refresh_async(device_name, name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_refresh_with_http_info(device_name, name, resource_group_name, custom_headers = nil)
      begin_refresh_async(device_name, name, resource_group_name, custom_headers).value!
    end
