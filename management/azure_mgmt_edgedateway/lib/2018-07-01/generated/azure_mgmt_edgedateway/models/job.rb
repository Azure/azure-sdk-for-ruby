...
module Azure::Compute::Mgmt::V2018_07_01
  module Models
    ...
    class Job
      ...
      # @return [DateTime] The UTC datetime at which the job was started.
      attr_accessor :start_time

      # @return [DateTime] The UTC datetime at which the job completed.
      ...
      # @return [String] ARM id of the Share on which the Refresh operation was
      # done.
      attr_accessor :share_id

      # @return [String] If only subfolders need to be refreshed, then the sub
