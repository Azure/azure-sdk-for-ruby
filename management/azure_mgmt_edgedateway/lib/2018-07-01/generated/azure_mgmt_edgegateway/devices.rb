...
module Azure::Compute::Mgmt::V2018_07_01
  ...
  class Devices
    ...
    def list_by_subscription(expand = nil, custom_headers = nil)
      first_page = list_by_subscription_as_lazy(expand, custom_headers)
    ...
    def list_by_subscription_with_http_info(expand = nil, custom_headers = nil)
      list_by_subscription_async(expand, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDeviceList.mapper()
    ...
    def get(device_name, resource_group_name, custom_headers = nil)
      response = get_async(device_name, resource_group_name, custom_headers).value!
    ...
    def get_with_http_info(device_name, resource_group_name, custom_headers = nil)
      get_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def get_async(device_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDevice.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(device_name, data_box_edge_device, resource_group_name, custom_headers = nil)
      response = create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers)
    ...
    def delete(device_name, resource_group_name, custom_headers = nil)
      response = delete_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(device_name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(device_name, resource_group_name, custom_headers)
    ...
    #
    # @param device_name [String] The device name.
    # @param parameters [DataBoxEdgeDevicePatch] The device update parameters.
    # @param resource_group_name [String] The resource group name.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    def update(device_name, parameters, resource_group_name, custom_headers = nil)
      response = update_async(device_name, parameters, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(device_name, parameters, resource_group_name, custom_headers = nil)
      update_async(device_name, parameters, resource_group_name, custom_headers).value!
    end
    ...
    def update_async(device_name, parameters, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDevicePatch.mapper()
    ...
    def download_updates(device_name, resource_group_name, custom_headers = nil)
      response = download_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def download_updates_async(device_name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_download_updates_async(device_name, resource_group_name, custom_headers)
    ...
    #
    # @param device_name [String] The device name.
    # @param parameters [DataBoxEdgeDeviceExtendedInfo] The device extended
    # information.
    # @param resource_group_name [String] The resource group name.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    ...
    def create_or_update_extended_info(device_name, parameters, resource_group_name, custom_headers = nil)
      response = create_or_update_extended_info_async(device_name, parameters, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_extended_info_with_http_info(device_name, parameters, resource_group_name, custom_headers = nil)
      create_or_update_extended_info_async(device_name, parameters, resource_group_name, custom_headers).value!
    end
    ...
    def create_or_update_extended_info_async(device_name, parameters, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDeviceExtendedInfo.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDeviceExtendedInfo.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_extended_information(device_name, resource_group_name, custom_headers = nil)
      response = get_extended_information_async(device_name, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_extended_information_with_http_info(device_name, resource_group_name, custom_headers = nil)
      get_extended_information_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def install_updates(device_name, resource_group_name, custom_headers = nil)
      response = install_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def install_updates_async(device_name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_install_updates_async(device_name, resource_group_name, custom_headers)
    ...
    def get_network_settings(device_name, resource_group_name, custom_headers = nil)
      response = get_network_settings_async(device_name, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_network_settings_with_http_info(device_name, resource_group_name, custom_headers = nil)
      get_network_settings_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def get_network_settings_async(device_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::NetworkSettings.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def scan_for_updates(device_name, resource_group_name, custom_headers = nil)
      response = scan_for_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def scan_for_updates_async(device_name, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_scan_for_updates_async(device_name, resource_group_name, custom_headers)
    ...
    def create_or_update_security_settings(device_name, security_settings, resource_group_name, custom_headers = nil)
      response = create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers)
    ...
    # done on the device. It also returns information about any ongoing download or
    ...
    def get_update_summary(device_name, resource_group_name, custom_headers = nil)
      response = get_update_summary_async(device_name, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_update_summary_with_http_info(device_name, resource_group_name, custom_headers = nil)
      get_update_summary_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def get_update_summary_async(device_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::UpdateSummary.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def upload_certificate(device_name, parameters, resource_group_name, custom_headers = nil)
      response = upload_certificate_async(device_name, parameters, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def upload_certificate_with_http_info(device_name, parameters, resource_group_name, custom_headers = nil)
      upload_certificate_async(device_name, parameters, resource_group_name, custom_headers).value!
    end
    ...
    def upload_certificate_async(device_name, parameters, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::UploadCertificateRequest.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::UploadCertificateResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update(device_name, data_box_edge_device, resource_group_name, custom_headers = nil)
      response = begin_create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(device_name, data_box_edge_device, resource_group_name, custom_headers = nil)
      begin_create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers).value!
    end
    ...
    def begin_create_or_update_async(device_name, data_box_edge_device, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::DataBoxEdgeDevice.mapper()
    ...
    def begin_delete(device_name, resource_group_name, custom_headers = nil)
      response = begin_delete_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(device_name, resource_group_name, custom_headers = nil)
      begin_delete_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def begin_download_updates(device_name, resource_group_name, custom_headers = nil)
      response = begin_download_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_download_updates_with_http_info(device_name, resource_group_name, custom_headers = nil)
      begin_download_updates_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def begin_install_updates(device_name, resource_group_name, custom_headers = nil)
      response = begin_install_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_install_updates_with_http_info(device_name, resource_group_name, custom_headers = nil)
      begin_install_updates_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def begin_scan_for_updates(device_name, resource_group_name, custom_headers = nil)
      response = begin_scan_for_updates_async(device_name, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_scan_for_updates_with_http_info(device_name, resource_group_name, custom_headers = nil)
      begin_scan_for_updates_async(device_name, resource_group_name, custom_headers).value!
    end
    ...
    def begin_create_or_update_security_settings(device_name, security_settings, resource_group_name, custom_headers = nil)
      response = begin_create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers).value!
      nil
    end
    ...
    def begin_create_or_update_security_settings_with_http_info(device_name, security_settings, resource_group_name, custom_headers = nil)
      begin_create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers).value!
    end
    ...
    def begin_create_or_update_security_settings_async(device_name, security_settings, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::SecuritySettings.mapper()
    ...
    def list_by_subscription_as_lazy(expand = nil, custom_headers = nil)
      response = list_by_subscription_async(expand, custom_headers).value!
      unless response.nil?
        page = response.body
