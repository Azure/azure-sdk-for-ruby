...
module Azure::Compute::Mgmt::V2018_07_01
  ...
  class Orders
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::OrderList.mapper()
    ...
    def get_async(device_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::Order.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # @param device_name [String] Name of the edge device for which order needs to
    # be added or updated.
    ...
    def create_or_update(device_name, order, resource_group_name, custom_headers = nil)
      response = create_or_update_async(device_name, order, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(device_name, order, resource_group_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(device_name, order, resource_group_name, custom_headers)
    ...
    def begin_create_or_update(device_name, order, resource_group_name, custom_headers = nil)
      response = begin_create_or_update_async(device_name, order, resource_group_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(device_name, order, resource_group_name, custom_headers = nil)
      begin_create_or_update_async(device_name, order, resource_group_name, custom_headers).value!
    end
    ...
    def begin_create_or_update_async(device_name, order, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_07_01::Models::Order.mapper()
