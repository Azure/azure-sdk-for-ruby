...
module Azure::ARM::StorSimple8000Series
  ...
  class BackupSchedules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StorSimple8000Series::Models::BackupScheduleList.mapper()
    ...
    def get_async(device_name, backup_policy_name, backup_schedule_name, resource_group_name, manager_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::StorSimple8000Series::Models::BackupSchedule.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(device_name, backup_policy_name, backup_schedule_name, parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StorSimple8000Series::Models::BackupSchedule.mapper()
