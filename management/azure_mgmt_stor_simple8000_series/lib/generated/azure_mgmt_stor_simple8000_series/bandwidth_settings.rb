...
module Azure::ARM::StorSimple8000Series
  ...
  class BandwidthSettings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StorSimple8000Series::Models::BandwidthSettingList.mapper()
    ...
    def get_async(bandwidth_setting_name, resource_group_name, manager_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::StorSimple8000Series::Models::BandwidthSetting.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(bandwidth_setting_name, parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StorSimple8000Series::Models::BandwidthSetting.mapper()
