...
module Azure::ARM::StorSimple8000Series::Api_2017_06_01
  ...
  class HardwareComponentGroups
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::HardwareComponentGroupList.mapper()
    ...
    def begin_change_controller_power_state_async(device_name, hardware_component_group_name, parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::ControllerPowerStateChangeRequest.mapper()
