      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::StorSimple8000Series::Mgmt::V2017_06_01::Models::VolumeContainerList.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(device_name, volume_container_name, resource_group_name, manager_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::StorSimple8000Series::Mgmt::V2017_06_01::Models::VolumeContainer.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(device_name, volume_container_name, parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::StorSimple8000Series::Mgmt::V2017_06_01::Models::VolumeContainer.new.from_json(parsed_response)
        end
