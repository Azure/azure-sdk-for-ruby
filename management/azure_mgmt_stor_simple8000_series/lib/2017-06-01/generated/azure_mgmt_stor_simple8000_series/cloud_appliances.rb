...
module Azure::ARM::StorSimple8000Series::Api_2017_06_01
  ...
  class CloudAppliances
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::CloudApplianceConfigurationList.mapper()
    ...
    def begin_provision_async(parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::CloudAppliance.mapper()
