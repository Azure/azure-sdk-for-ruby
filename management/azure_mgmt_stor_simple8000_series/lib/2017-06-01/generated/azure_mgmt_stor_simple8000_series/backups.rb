...
module Azure::ARM::StorSimple8000Series::Api_2017_06_01
  ...
  class Backups
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::BackupList.mapper()
    ...
    def begin_clone_async(device_name, backup_name, backup_element_name, parameters, resource_group_name, manager_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StorSimple8000Series::Api_2017_06_01::Models::CloneRequest.mapper()
