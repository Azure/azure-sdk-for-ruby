...
module Azure::PolicyInsights::Mgmt::V2017_08_09_preview
  module Models
    ...
    #
    class PolicyEventsQueryResultsTableColumns
      ...
      # @return [Column] Timestamp for the policy event record.
      ...
      # @return [Column] Tenant ID for the policy event record.
      attr_accessor :tenant_id

      # @return [Column] Principal object ID for the user who initiated the
      # resource operation that triggered the policy event.
      attr_accessor :principal_oid


      #
      # Mapper for PolicyEventsQueryResultsTableColumns class as Ruby Hash.
