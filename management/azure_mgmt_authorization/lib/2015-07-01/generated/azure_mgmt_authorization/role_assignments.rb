      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Authorization::Mgmt::V2015_07_01::Models::RoleAssignmentListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def delete_async(scope, role_assignment_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Authorization::Mgmt::V2015_07_01::Models::RoleAssignment.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
