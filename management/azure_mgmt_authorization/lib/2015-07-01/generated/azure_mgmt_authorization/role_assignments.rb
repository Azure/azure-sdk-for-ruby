...
module Azure::ARM::Authorization
  ...
  class RoleAssignments
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleAssignmentListResult.mapper()
    ...
    def delete_async(scope, role_assignment_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleAssignment.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_async(scope, role_assignment_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleAssignmentCreateParameters.mapper()
