...
module Azure::ARM::Authorization::Api_2015_07_01
  ...
  class RoleDefinitions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleDefinition.mapper()
    ...
    def create_or_update_async(scope, role_definition_id, role_definition, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleDefinition.mapper()
    ...
    def list_async(scope, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Authorization::Api_2015_07_01::Models::RoleDefinitionListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
