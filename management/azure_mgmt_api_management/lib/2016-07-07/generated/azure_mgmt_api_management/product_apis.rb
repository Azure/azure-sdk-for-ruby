...
module Azure::ApiManagement::Mgmt::V2016_07_07
  ...
  class ProductApis
    ...
    def add(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      response = add_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
      nil
    end
    ...
    def add_with_http_info(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      add_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
    end
    ...
    def remove(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      response = remove_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
      nil
    end
    ...
    def remove_with_http_info(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      remove_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
    end
