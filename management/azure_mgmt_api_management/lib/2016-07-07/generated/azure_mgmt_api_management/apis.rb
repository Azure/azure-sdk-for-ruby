...
module Azure::ApiManagement::Mgmt::V2016_07_07
  ...
  class Apis
    ...
    def export(resource_group_name, service_name, api_id, custom_headers = nil)
      response = export_async(resource_group_name, service_name, api_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def export_with_http_info(resource_group_name, service_name, api_id, custom_headers = nil)
      export_async(resource_group_name, service_name, api_id, custom_headers).value!
    end
