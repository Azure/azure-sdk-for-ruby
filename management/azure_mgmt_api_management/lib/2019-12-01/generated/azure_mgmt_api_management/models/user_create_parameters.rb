...
module Azure::ApiManagement::Mgmt::V2019_12_01
  module Models
    ...
    class UserCreateParameters
      ...
      # @return [AppType] Determines the type of application which send the
      # create user request. Default is old publisher portal. Possible values
          ...
          type: {
            ...
            model_properties: {
              ...
              app_type: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.appType',
                type: {
                  name: 'String'
                }
              },
