...
module Azure::ApiManagement::Mgmt::V2019_12_01
  module Models
    ...
    class IdentityProviderCreateContract < Resource
      ...
      # 'aad', 'aadB2C'
      attr_accessor :identity_provider_create_contract_type

      # @return [String] The TenantId to use instead of Common when logging
      # into Active Directory
      attr_accessor :signin_tenant
      ...
      #
      # Mapper for IdentityProviderCreateContract class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'IdentityProviderCreateContract',
          type: {
            name: 'Composite',
            class_name: 'IdentityProviderCreateContract',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
              ...
              identity_provider_create_contract_type: {
                client_side_validation: true,
                required: false,
              ...
              signin_tenant: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.signinTenant',
                type: {
                  name: 'String'
                }
              },
