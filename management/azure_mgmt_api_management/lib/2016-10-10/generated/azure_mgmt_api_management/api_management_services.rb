...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class ApiManagementServices
    ...
    def manage_deployments(resource_group_name, service_name, parameters, custom_headers = nil)
      response = manage_deployments_async(resource_group_name, service_name, parameters, custom_headers).value!
    ...
    def manage_deployments_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_manage_deployments_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def apply_network_configuration_updates(resource_group_name, service_name, custom_headers = nil)
      response = apply_network_configuration_updates_async(resource_group_name, service_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def apply_network_configuration_updates_async(resource_group_name, service_name, custom_headers = nil)
      # Send request
      promise = begin_apply_network_configuration_updates_async(resource_group_name, service_name, custom_headers)
    ...
    def begin_manage_deployments(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_manage_deployments_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_manage_deployments_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_manage_deployments_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_apply_network_configuration_updates(resource_group_name, service_name, custom_headers = nil)
      response = begin_apply_network_configuration_updates_async(resource_group_name, service_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_apply_network_configuration_updates_with_http_info(resource_group_name, service_name, custom_headers = nil)
      begin_apply_network_configuration_updates_async(resource_group_name, service_name, custom_headers).value!
    end
