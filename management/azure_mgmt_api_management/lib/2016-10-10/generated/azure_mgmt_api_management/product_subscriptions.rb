...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class ProductSubscriptions
    ...
    def list_by_products(resource_group_name, service_name, product_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_by_products_as_lazy(resource_group_name, service_name, product_id, filter, top, skip, custom_headers)
    ...
    def list_by_products_with_http_info(resource_group_name, service_name, product_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_by_products_async(resource_group_name, service_name, product_id, filter, top, skip, custom_headers).value!
    end
    ...
    def list_by_products_next(next_page_link, custom_headers = nil)
      response = list_by_products_next_async(next_page_link, custom_headers).value!
    ...
    def list_by_products_next_with_http_info(next_page_link, custom_headers = nil)
      list_by_products_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_by_products_as_lazy(resource_group_name, service_name, product_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_by_products_async(resource_group_name, service_name, product_id, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_by_products_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
