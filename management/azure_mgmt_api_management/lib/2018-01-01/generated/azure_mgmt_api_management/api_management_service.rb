...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ApiManagementService
    ...
    def restore(resource_group_name, service_name, parameters, custom_headers = nil)
      response = restore_async(resource_group_name, service_name, parameters, custom_headers).value!
    ...
    def restore_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_restore_async(resource_group_name, service_name, parameters, custom_headers)

      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceResource.mapper()
    ...
    def backup(resource_group_name, service_name, parameters, custom_headers = nil)
      response = backup_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def backup_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_backup_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def create_or_update_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def update(resource_group_name, service_name, parameters, custom_headers = nil)
      response = update_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_sso_token(resource_group_name, service_name, custom_headers = nil)
      response = get_sso_token_async(resource_group_name, service_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_sso_token_with_http_info(resource_group_name, service_name, custom_headers = nil)
      get_sso_token_async(resource_group_name, service_name, custom_headers).value!
    end
    ...
    def get_sso_token_async(resource_group_name, service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceGetSsoTokenResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def check_name_availability_async(parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceCheckNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceNameAvailabilityResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def apply_network_configuration_updates(resource_group_name, service_name, parameters = nil, custom_headers = nil)
      response = apply_network_configuration_updates_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def apply_network_configuration_updates_async(resource_group_name, service_name, parameters = nil, custom_headers = nil)
      # Send request
      promise = begin_apply_network_configuration_updates_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def upload_certificate(resource_group_name, service_name, parameters, custom_headers = nil)
      response = upload_certificate_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def upload_certificate_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      upload_certificate_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def upload_certificate_async(resource_group_name, service_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceUploadCertificateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::CertificateInformation.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_hostname(resource_group_name, service_name, parameters, custom_headers = nil)
      response = update_hostname_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_hostname_async(resource_group_name, service_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_hostname_async(resource_group_name, service_name, parameters, custom_headers)
    ...
    def begin_restore(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_restore_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_restore_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_restore_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_restore_async(resource_group_name, service_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceBackupRestoreParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_backup(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_backup_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_backup_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_backup_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_create_or_update_async(resource_group_name, service_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceResource.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_update_async(resource_group_name, service_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_apply_network_configuration_updates(resource_group_name, service_name, parameters = nil, custom_headers = nil)
      response = begin_apply_network_configuration_updates_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_apply_network_configuration_updates_with_http_info(resource_group_name, service_name, parameters = nil, custom_headers = nil)
      begin_apply_network_configuration_updates_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_apply_network_configuration_updates_async(resource_group_name, service_name, parameters = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceApplyNetworkConfigurationParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update_hostname(resource_group_name, service_name, parameters, custom_headers = nil)
      response = begin_update_hostname_async(resource_group_name, service_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_hostname_with_http_info(resource_group_name, service_name, parameters, custom_headers = nil)
      begin_update_hostname_async(resource_group_name, service_name, parameters, custom_headers).value!
    end
    ...
    def begin_update_hostname_async(resource_group_name, service_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiManagementServiceUpdateHostnameParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
