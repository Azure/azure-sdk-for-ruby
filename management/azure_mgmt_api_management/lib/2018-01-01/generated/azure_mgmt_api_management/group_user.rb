...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class GroupUser
    ...
    def list(resource_group_name, service_name, group_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_as_lazy(resource_group_name, service_name, group_id, filter, top, skip, custom_headers)
    ...
    def list_with_http_info(resource_group_name, service_name, group_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_async(resource_group_name, service_name, group_id, filter, top, skip, custom_headers).value!
    end
    ...
    def check_entity_exists(resource_group_name, service_name, group_id, uid, custom_headers = nil)
      response = check_entity_exists_async(resource_group_name, service_name, group_id, uid, custom_headers).value!
    ...
    def check_entity_exists_with_http_info(resource_group_name, service_name, group_id, uid, custom_headers = nil)
      check_entity_exists_async(resource_group_name, service_name, group_id, uid, custom_headers).value!
    end
    ...
    def list_as_lazy(resource_group_name, service_name, group_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_async(resource_group_name, service_name, group_id, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
