...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class UserSubscription
    ...
    def list(resource_group_name, service_name, uid, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_as_lazy(resource_group_name, service_name, uid, filter, top, skip, custom_headers)
    ...
    def list_with_http_info(resource_group_name, service_name, uid, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_async(resource_group_name, service_name, uid, filter, top, skip, custom_headers).value!
    end
    ...
    def list_as_lazy(resource_group_name, service_name, uid, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_async(resource_group_name, service_name, uid, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
