...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ProductPolicy
    ...
    def list_by_product(resource_group_name, service_name, product_id, custom_headers = nil)
      response = list_by_product_async(resource_group_name, service_name, product_id, custom_headers).value!
    ...
    def list_by_product_with_http_info(resource_group_name, service_name, product_id, custom_headers = nil)
      list_by_product_async(resource_group_name, service_name, product_id, custom_headers).value!
    end
    ...
    def delete(resource_group_name, service_name, product_id, if_match, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, product_id, if_match, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, product_id, if_match, custom_headers = nil)
      delete_async(resource_group_name, service_name, product_id, if_match, custom_headers).value!
    end
