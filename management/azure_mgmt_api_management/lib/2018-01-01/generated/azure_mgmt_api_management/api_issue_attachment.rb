...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ApiIssueAttachment
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::IssueAttachmentCollection.mapper()
    ...
    def get_entity_tag(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers = nil)
      response = get_entity_tag_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers).value!
      nil
    end
    ...
    def get_entity_tag_with_http_info(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers = nil)
      get_entity_tag_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers).value!
    end
    ...
    def get(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers = nil)
      response = get_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers = nil)
      get_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers).value!
    end
    ...
    def get_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::IssueAttachmentContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match = nil, custom_headers = nil)
      response = create_or_update_async(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match = nil, custom_headers = nil)
      create_or_update_async(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match, custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::IssueAttachmentContract.mapper()
    ...
    def delete(resource_group_name, service_name, api_id, issue_id, attachment_id, if_match, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, api_id, issue_id, attachment_id, if_match, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, api_id, issue_id, attachment_id, if_match, custom_headers = nil)
      delete_async(resource_group_name, service_name, api_id, issue_id, attachment_id, if_match, custom_headers).value!
    end
