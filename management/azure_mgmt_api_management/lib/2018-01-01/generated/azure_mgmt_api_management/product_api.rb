...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ProductApi
    ...
    def check_entity_exists(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      response = check_entity_exists_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
    ...
    def check_entity_exists_with_http_info(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      check_entity_exists_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      response = create_or_update_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, product_id, api_id, custom_headers = nil)
      create_or_update_async(resource_group_name, service_name, product_id, api_id, custom_headers).value!
    end
