...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class OperationOperations
    ...
    def list_by_tags(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_by_tags_as_lazy(resource_group_name, service_name, api_id, filter, top, skip, custom_headers)
    ...
    def list_by_tags_with_http_info(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_by_tags_async(resource_group_name, service_name, api_id, filter, top, skip, custom_headers).value!
    end
    ...
    def list_by_tags_as_lazy(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_by_tags_async(resource_group_name, service_name, api_id, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
