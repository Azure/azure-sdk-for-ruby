...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ApiPolicy
    ...
    def list_by_api(resource_group_name, service_name, api_id, custom_headers = nil)
      response = list_by_api_async(resource_group_name, service_name, api_id, custom_headers).value!
    ...
    def list_by_api_with_http_info(resource_group_name, service_name, api_id, custom_headers = nil)
      list_by_api_async(resource_group_name, service_name, api_id, custom_headers).value!
    end
    ...
    def delete(resource_group_name, service_name, api_id, if_match, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, api_id, if_match, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, api_id, if_match, custom_headers = nil)
      delete_async(resource_group_name, service_name, api_id, if_match, custom_headers).value!
    end
