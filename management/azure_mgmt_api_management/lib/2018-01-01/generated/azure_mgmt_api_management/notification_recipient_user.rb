...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class NotificationRecipientUser
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::RecipientUserCollection.mapper()
    ...
    def check_entity_exists(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      response = check_entity_exists_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def check_entity_exists_with_http_info(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      check_entity_exists_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      response = create_or_update_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      create_or_update_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::RecipientUserContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, notification_name, uid, custom_headers = nil)
      delete_async(resource_group_name, service_name, notification_name, uid, custom_headers).value!
    end
