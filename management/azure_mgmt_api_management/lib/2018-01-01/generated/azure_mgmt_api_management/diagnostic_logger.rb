...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class DiagnosticLogger
    ...
    def list_by_service(resource_group_name, service_name, diagnostic_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_by_service_as_lazy(resource_group_name, service_name, diagnostic_id, filter, top, skip, custom_headers)
    ...
    def list_by_service_with_http_info(resource_group_name, service_name, diagnostic_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_by_service_async(resource_group_name, service_name, diagnostic_id, filter, top, skip, custom_headers).value!
    end
    ...
    def check_entity_exists(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      response = check_entity_exists_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
    ...
    def check_entity_exists_with_http_info(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      check_entity_exists_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      response = create_or_update_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      create_or_update_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
    end
    ...
    def delete(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers = nil)
      delete_async(resource_group_name, service_name, diagnostic_id, loggerid, custom_headers).value!
    end
    ...
    def list_by_service_as_lazy(resource_group_name, service_name, diagnostic_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_by_service_async(resource_group_name, service_name, diagnostic_id, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
