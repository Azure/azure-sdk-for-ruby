...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ApiRelease
    ...
    def list(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      first_page = list_as_lazy(resource_group_name, service_name, api_id, filter, top, skip, custom_headers)
    ...
    def list_with_http_info(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      list_async(resource_group_name, service_name, api_id, filter, top, skip, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiReleaseCollection.mapper()
    ...
    def get_entity_tag(resource_group_name, service_name, api_id, release_id, custom_headers = nil)
      response = get_entity_tag_async(resource_group_name, service_name, api_id, release_id, custom_headers).value!
      nil
    end
    ...
    def get_entity_tag_with_http_info(resource_group_name, service_name, api_id, release_id, custom_headers = nil)
      get_entity_tag_async(resource_group_name, service_name, api_id, release_id, custom_headers).value!
    end
    ...
    def get(resource_group_name, service_name, api_id, release_id, custom_headers = nil)
      response = get_async(resource_group_name, service_name, api_id, release_id, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, service_name, api_id, release_id, custom_headers = nil)
      get_async(resource_group_name, service_name, api_id, release_id, custom_headers).value!
    end
    ...
    def get_async(resource_group_name, service_name, api_id, release_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiReleaseContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create(resource_group_name, service_name, api_id, release_id, parameters, custom_headers = nil)
      response = create_async(resource_group_name, service_name, api_id, release_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_with_http_info(resource_group_name, service_name, api_id, release_id, parameters, custom_headers = nil)
      create_async(resource_group_name, service_name, api_id, release_id, parameters, custom_headers).value!
    end
    ...
    def create_async(resource_group_name, service_name, api_id, release_id, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ApiReleaseContract.mapper()
    ...
    def update(resource_group_name, service_name, api_id, release_id, parameters, if_match, custom_headers = nil)
      response = update_async(resource_group_name, service_name, api_id, release_id, parameters, if_match, custom_headers).value!
      nil
    end
    ...
    def update_with_http_info(resource_group_name, service_name, api_id, release_id, parameters, if_match, custom_headers = nil)
      update_async(resource_group_name, service_name, api_id, release_id, parameters, if_match, custom_headers).value!
    end
    ...
    def delete(resource_group_name, service_name, api_id, release_id, if_match, custom_headers = nil)
      response = delete_async(resource_group_name, service_name, api_id, release_id, if_match, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, api_id, release_id, if_match, custom_headers = nil)
      delete_async(resource_group_name, service_name, api_id, release_id, if_match, custom_headers).value!
    end
    ...
    def list_as_lazy(resource_group_name, service_name, api_id, filter = nil, top = nil, skip = nil, custom_headers = nil)
      response = list_async(resource_group_name, service_name, api_id, filter, top, skip, custom_headers).value!
      unless response.nil?
        page = response.body
