...
module Azure::ApiManagement::Mgmt::V2018_01_01_preview
  ...
  class ApiManagementServiceSkus
    ...
    def list_available_service_skus(resource_group_name, service_name, custom_headers = nil)
      first_page = list_available_service_skus_as_lazy(resource_group_name, service_name, custom_headers)
    ...
    def list_available_service_skus_with_http_info(resource_group_name, service_name, custom_headers = nil)
      list_available_service_skus_async(resource_group_name, service_name, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01_preview::Models::ResourceSkuResults.mapper()
    ...
    def list_available_service_skus_next(next_page_link, custom_headers = nil)
      response = list_available_service_skus_next_async(next_page_link, custom_headers).value!
    ...
    def list_available_service_skus_next_with_http_info(next_page_link, custom_headers = nil)
      list_available_service_skus_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_available_service_skus_as_lazy(resource_group_name, service_name, custom_headers = nil)
      response = list_available_service_skus_async(resource_group_name, service_name, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_available_service_skus_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
