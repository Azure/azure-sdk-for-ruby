...
module Azure::Compute::Management::Profile_2016_04_30_Preview
    ...
    #
    class ComputeClass
      attr_reader :availability_sets, :virtual_machine_extension_images, :virtual_machine_extensions, :virtual_machine_images, :usage_operations, :virtual_machine_sizes, :images, :virtual_machines, :virtual_machine_scale_sets, :virtual_machine_scale_set_vms, :disks, :snapshots, :configurable, :base_url, :options, :model_classes
