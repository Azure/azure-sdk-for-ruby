  ...
  class Snapshots
    ...
    def create_or_update_async(resource_group_name, snapshot_name, snapshot, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Compute::Mgmt::V2016_04_30_preview::Models::Snapshot.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Compute::Mgmt::V2016_04_30_preview::Models::Snapshot.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Compute::Mgmt::V2016_04_30_preview::Models::SnapshotList.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def grant_access_async(resource_group_name, snapshot_name, grant_access_data, custom_headers = nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Compute::Mgmt::V2016_04_30_preview::Models::AccessUri.new.from_json(parsed_response)
        end
    ...
    def begin_create_or_update_async(resource_group_name, snapshot_name, snapshot, custom_headers = nil)
      ...
      # Serialize Request
      request_content = snapshot.nil? ? nil: snapshot.to_json
    ...
    def begin_grant_access_async(resource_group_name, snapshot_name, grant_access_data, custom_headers = nil)
      ...
      # Serialize Request
      request_content = grant_access_data.nil? ? nil: grant_access_data.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Compute::Mgmt::V2016_04_30_preview::Models::AccessUri.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
