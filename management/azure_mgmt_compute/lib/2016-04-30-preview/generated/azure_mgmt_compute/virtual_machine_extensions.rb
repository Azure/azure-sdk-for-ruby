...
module Azure::Compute::Mgmt::V2016_04_30_preview
  ...
  class VirtualMachineExtensions
    ...
    def create_or_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Compute::Mgmt::V2016_04_30_preview::Models::VirtualMachineExtension.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Compute::Mgmt::V2016_04_30_preview::Models::VirtualMachineExtension.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def begin_create_or_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_content = extension_parameters.nil? ? nil: extension_parameters.to_json
