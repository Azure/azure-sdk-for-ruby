...
module Azure::Compute::Mgmt::V2017_12_01
  ...
  class AvailabilitySets
    ...
    def update(resource_group_name, availability_set_name, parameters, custom_headers = nil)
      response = update_async(resource_group_name, availability_set_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(resource_group_name, availability_set_name, parameters, custom_headers = nil)
      update_async(resource_group_name, availability_set_name, parameters, custom_headers).value!
    end
