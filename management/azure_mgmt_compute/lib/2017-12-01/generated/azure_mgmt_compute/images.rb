...
module Azure::Compute::Mgmt::V2017_12_01
  ...
  class Images
    ...
    def update(resource_group_name, image_name, parameters, custom_headers = nil)
      response = update_async(resource_group_name, image_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, image_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, image_name, parameters, custom_headers)
    ...
    def begin_update(resource_group_name, image_name, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, image_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, image_name, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, image_name, parameters, custom_headers).value!
    end
