...
module Azure::Compute::Mgmt::V2017_12_01
  ...
  class VirtualMachineScaleSetVMs
    ...
    def update(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers = nil)
      response = update_async(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers)
    ...
    def redeploy(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      response = redeploy_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def redeploy_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      # Send request
      promise = begin_redeploy_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers)
    ...
    def perform_maintenance(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      response = perform_maintenance_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def perform_maintenance_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      # Send request
      promise = begin_perform_maintenance_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers)
    ...
    def begin_update(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, vm_scale_set_name, instance_id, parameters, custom_headers).value!
    end
    ...
    def begin_redeploy(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      response = begin_redeploy_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_redeploy_with_http_info(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      begin_redeploy_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
    end
    ...
    def begin_perform_maintenance(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      response = begin_perform_maintenance_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_perform_maintenance_with_http_info(resource_group_name, vm_scale_set_name, instance_id, custom_headers = nil)
      begin_perform_maintenance_async(resource_group_name, vm_scale_set_name, instance_id, custom_headers).value!
    end
