...
module Azure::ARM::Compute
  ...
  class VirtualMachineExtensions
    ...
    #
    def create_or_update_with_http_info(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers = nil)
      create_or_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def delete_with_http_info(resource_group_name, vm_name, vm_extension_name, custom_headers = nil)
      delete_async(resource_group_name, vm_name, vm_extension_name, custom_headers).value!
    end
