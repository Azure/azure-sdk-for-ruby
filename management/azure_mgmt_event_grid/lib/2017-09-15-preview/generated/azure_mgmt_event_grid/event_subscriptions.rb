...
module Azure::ARM::EventGrid::Api_2017_09_15_preview
  ...
  class EventSubscriptions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventSubscription.mapper()
    ...
    def get_full_url_async(scope, event_subscription_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventSubscriptionFullUrl.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_global_by_subscription_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventSubscriptionsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(scope, event_subscription_name, event_subscription_info, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventSubscription.mapper()
    ...
    def begin_update_async(scope, event_subscription_name, event_subscription_update_parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventSubscriptionUpdateParameters.mapper()
