...
module Azure::ARM::EventGrid::Api_2017_09_15_preview
  ...
  class Topics
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::Topic.mapper()
    ...
    def list_by_subscription_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::TopicsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_shared_access_keys_async(resource_group_name, topic_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::TopicSharedAccessKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_key_async(resource_group_name, topic_name, regenerate_key_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::TopicRegenerateKeyRequest.mapper()
    ...
    def list_event_types_async(resource_group_name, provider_namespace, resource_type_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::EventTypesListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, topic_name, topic_info, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::EventGrid::Api_2017_09_15_preview::Models::Topic.mapper()
