      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::EventSubscription.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(scope, event_subscription_name, event_subscription_info, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::EventSubscription.new.from_json(parsed_response)
        end
    ...
    def get_full_url_async(scope, event_subscription_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::EventSubscriptionFullUrl.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_global_by_subscription_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::EventSubscriptionsListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
