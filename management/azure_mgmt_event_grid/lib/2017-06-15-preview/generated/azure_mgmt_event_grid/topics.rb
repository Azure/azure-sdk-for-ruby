...
module Azure::EventGrid::Mgmt::V2017_06_15_preview
  ...
  class Topics
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::Topic.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, topic_name, topic_info, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::Topic.new.from_json(parsed_response)
        end
    ...
    def list_by_subscription_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::TopicsListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_shared_access_keys_async(resource_group_name, topic_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::TopicSharedAccessKeys.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def regenerate_key_async(resource_group_name, topic_name, regenerate_key_request, custom_headers = nil)
      ...
      # Serialize Request
      request_content = regenerate_key_request.nil? ? nil: regenerate_key_request.to_json
    ...
    def list_event_types_async(resource_group_name, provider_namespace, resource_type_name, resource_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::EventGrid::Mgmt::V2017_06_15_preview::Models::EventTypesListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_or_update_async(resource_group_name, topic_name, topic_info, custom_headers = nil)
      ...
      # Serialize Request
      request_content = topic_info.nil? ? nil: topic_info.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
