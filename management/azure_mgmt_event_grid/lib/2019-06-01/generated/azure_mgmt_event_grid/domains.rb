...
module Azure::EventGrid::Mgmt::V2019_02_01_preview
  ...
  class Domains
    ...
    def create_or_update(resource_group_name, domain_name, domain_info, custom_headers = nil)
      response = create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers)
    ...
    def delete(resource_group_name, domain_name, custom_headers = nil)
      response = delete_async(resource_group_name, domain_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, domain_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, domain_name, custom_headers)
    ...
    def update(resource_group_name, domain_name, domain_update_parameters, custom_headers = nil)
      response = update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers)
    ...
    def list_by_subscription(filter = nil, top = nil, custom_headers = nil)
      first_page = list_by_subscription_as_lazy(filter, top, custom_headers)
    ...
    def list_by_subscription_with_http_info(filter = nil, top = nil, custom_headers = nil)
      list_by_subscription_async(filter, top, custom_headers).value!
    end
    ...
    def list_shared_access_keys(resource_group_name, domain_name, custom_headers = nil)
      response = list_shared_access_keys_async(resource_group_name, domain_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_shared_access_keys_with_http_info(resource_group_name, domain_name, custom_headers = nil)
      list_shared_access_keys_async(resource_group_name, domain_name, custom_headers).value!
    end
    ...
    def regenerate_key(resource_group_name, domain_name, regenerate_key_request, custom_headers = nil)
      response = regenerate_key_async(resource_group_name, domain_name, regenerate_key_request, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def regenerate_key_with_http_info(resource_group_name, domain_name, regenerate_key_request, custom_headers = nil)
      regenerate_key_async(resource_group_name, domain_name, regenerate_key_request, custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, domain_name, domain_info, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, domain_name, domain_info, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers).value!
    end
    ...
    def begin_delete(resource_group_name, domain_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, domain_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, domain_name, custom_headers = nil)
      begin_delete_async(resource_group_name, domain_name, custom_headers).value!
    end
    ...
    def begin_update(resource_group_name, domain_name, domain_update_parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, domain_name, domain_update_parameters, custom_headers = nil)
      begin_update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers).value!
    end
    ...
    def list_by_subscription_as_lazy(filter = nil, top = nil, custom_headers = nil)
      response = list_by_subscription_async(filter, top, custom_headers).value!
      unless response.nil?
        page = response.body
