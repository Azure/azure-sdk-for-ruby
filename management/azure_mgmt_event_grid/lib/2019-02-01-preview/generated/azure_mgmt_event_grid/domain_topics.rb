...
module Azure::EventGrid::Mgmt::V2019_02_01_preview
  ...
  class DomainTopics
    ...
    def get(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      response = get_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      get_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      response = create_or_update_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, domain_name, domain_topic_name, custom_headers)
    ...
    def delete(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      response = delete_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, domain_name, domain_topic_name, custom_headers)
    ...
    def list_by_domain(resource_group_name, domain_name, filter = nil, top = nil, custom_headers = nil)
      first_page = list_by_domain_as_lazy(resource_group_name, domain_name, filter, top, custom_headers)
    ...
    def list_by_domain_with_http_info(resource_group_name, domain_name, filter = nil, top = nil, custom_headers = nil)
      list_by_domain_async(resource_group_name, domain_name, filter, top, custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
    end
    ...
    def begin_delete(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, domain_name, domain_topic_name, custom_headers = nil)
      begin_delete_async(resource_group_name, domain_name, domain_topic_name, custom_headers).value!
    end
    ...
    def list_by_domain_next(next_page_link, custom_headers = nil)
      response = list_by_domain_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_by_domain_next_with_http_info(next_page_link, custom_headers = nil)
      list_by_domain_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_by_domain_as_lazy(resource_group_name, domain_name, filter = nil, top = nil, custom_headers = nil)
      response = list_by_domain_async(resource_group_name, domain_name, filter, top, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_by_domain_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
