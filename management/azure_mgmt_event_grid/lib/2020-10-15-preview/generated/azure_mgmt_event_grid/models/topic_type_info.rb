...
module Azure::EventGrid::Mgmt::V2020_10_15_preview
  module Models
    ...
    class TopicTypeInfo < Resource
      ...
      # @return [String] Source resource format.
      attr_accessor :source_resource_format

      # @return [Array<Enum>] Supported source scopes.
      attr_accessor :supported_scopes_for_source
          ...
          type: {
            ...
            model_properties: {
              ...
              source_resource_format: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.sourceResourceFormat',
                type: {
                  name: 'String'
                }
              },
              supported_scopes_for_source: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.supportedScopesForSource',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
