...
Gem::Specification.new do |spec|
  ...
  spec.version       = Azure::IotCentral::Mgmt::VERSION
  spec.authors       = 'Microsoft Corporation'
  spec.email         = 'azrubyteam@microsoft.com'
  spec.description   = 'Microsoft Azure IotCentral Management Client Library for Ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure IotCentral Management services.'
