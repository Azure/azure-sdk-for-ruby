...
module Azure::IotCentral::Mgmt::V2018_09_01
  ...
  class Apps
    ...
    def template_async(custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/applicationTemplates/{applicationTemplateId}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::IotCentral::Mgmt::V2018_09_01::Models::AppTemplate.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_templates(custom_headers = nil)
      first_page = list_templates_as_lazy(custom_headers)
      first_page.get_all_items
    end
    ...
    def list_templates_with_http_info(custom_headers = nil)
      list_templates_async(custom_headers).value!
    end
    ...
    def list_templates_async(custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/applicationTemplates'
    ...
    def list_templates_next(next_page_link, custom_headers = nil)
      response = list_templates_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_templates_next_with_http_info(next_page_link, custom_headers = nil)
      list_templates_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_templates_as_lazy(custom_headers = nil)
      response = list_templates_async(custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_templates_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
