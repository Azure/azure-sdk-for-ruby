...
module Azure::ARM::MachineLearning::WebServices::Api_2016_05_01_preview
  ...
  class WebServices
    ...
    def create_or_update_async(resource_group_name, web_service_name, create_or_update_payload, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ARM::MachineLearning::WebServices::Api_2016_05_01_preview::Models::WebService.mapper()
    ...
    def list_keys_async(resource_group_name, web_service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MachineLearning::WebServices::Api_2016_05_01_preview::Models::WebServiceKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_by_resource_group_async(resource_group_name, skiptoken = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::MachineLearning::WebServices::Api_2016_05_01_preview::Models::PaginatedWebServicesList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, web_service_name, create_or_update_payload, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::MachineLearning::WebServices::Api_2016_05_01_preview::Models::WebService.mapper()
