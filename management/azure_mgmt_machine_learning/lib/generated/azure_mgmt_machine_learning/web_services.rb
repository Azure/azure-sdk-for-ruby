...
module Azure::ARM::MachineLearning
  ...
  class WebServices
    ...
    def create_or_update_async(resource_group_name, web_service_name, create_or_update_payload, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::ARM::MachineLearning::Models::WebService.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::MachineLearning::Models::WebService.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_keys_async(resource_group_name, web_service_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MachineLearning::Models::WebServiceKeys.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_by_resource_group_async(resource_group_name, skiptoken = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::MachineLearning::Models::PaginatedWebServicesList.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_or_update_async(resource_group_name, web_service_name, create_or_update_payload, custom_headers = nil)
      ...
      # Serialize Request
      request_content = create_or_update_payload.to_json
    ...
    def begin_patch_async(resource_group_name, web_service_name, patch_payload, custom_headers = nil)
      ...
      # Serialize Request
      request_content = patch_payload.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
