...
module Azure::VMwareCloudSimple::Mgmt::V2019-04-01
  ...
  #
  class VirtualNetworksByPC
    include MsRestAzure

    #
    # Creates and initializes a new instance of the VirtualNetworksByPC class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::VirtualNetworkListResponse.mapper()
