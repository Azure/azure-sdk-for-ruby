...
module Azure::VMwareCloudSimple::Mgmt::V2019-04-01
  ...
  #
  class PrivateCloudByRegion
    include MsRestAzure

    #
    # Creates and initializes a new instance of the PrivateCloudByRegion class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::PrivateCloudList.mapper()
