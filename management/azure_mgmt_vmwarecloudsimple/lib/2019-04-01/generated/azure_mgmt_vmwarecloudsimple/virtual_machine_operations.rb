...
module Azure::VMwareCloudSimple::Mgmt::V2019-04-01
  ...
  class VirtualMachineOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::VirtualMachineListResponse.mapper()
    ...
    def get_async(resource_group_name, virtual_machine_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::VirtualMachine.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, virtual_machine_name, virtual_machine_request, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::VirtualMachine.mapper()
    ...
    def begin_stop_async(resource_group_name, virtual_machine_name, m = nil, mode = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::VMwareCloudSimple::Mgmt::V2019-04-01::Models::VirtualMachineStopMode.mapper()
