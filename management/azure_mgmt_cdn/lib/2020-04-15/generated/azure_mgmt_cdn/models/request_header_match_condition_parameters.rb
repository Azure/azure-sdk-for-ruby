...
module Azure::CDN::Mgmt::V2020_04_15
  module Models
    ...
    class RequestHeaderMatchConditionParameters
      ...
      # @return [String] Name of Header to be matched
      attr_accessor :selector

      # @return [RequestHeaderOperator] Describes operator to be matched.
      ...
      #
      # Mapper for RequestHeaderMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RequestHeaderMatchConditionParameters',
          type: {
            name: 'Composite',
            ...
            model_properties: {
              odatatype: {
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRuleRequestHeaderConditionParameters',
                type: {
                  name: 'String'
                }
              },
