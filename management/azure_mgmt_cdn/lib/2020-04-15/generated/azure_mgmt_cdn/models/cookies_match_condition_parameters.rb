...
module Azure::CDN::Mgmt::V2020_04_15
  module Models
    ...
    class CookiesMatchConditionParameters
      ...
      # @return [String] Name of Cookies to be matched
      attr_accessor :selector

      # @return [CookiesOperator] Describes operator to be matched. Possible
      ...
      #
      # Mapper for CookiesMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'CookiesMatchConditionParameters',
          type: {
            name: 'Composite',
            ...
            model_properties: {
              odatatype: {
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRuleCookiesConditionParameters',
                type: {
                  name: 'String'
                }
              },
