...
module Azure::CDN::Mgmt::V2020_04_15
  module Models
    ...
    class RequestSchemeMatchConditionParameters
      ...
      #
      # Mapper for RequestSchemeMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RequestSchemeMatchConditionParameters',
          type: {
            name: 'Composite',
            ...
            model_properties: {
              odatatype: {
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRuleRequestSchemeConditionParameters',
                type: {
                  name: 'String'
                }
              },
