...
module Azure::CDN::Mgmt::V2020_04_15
  module Models
    ...
    class PostArgsMatchConditionParameters
      ...
      # @return [String] Name of PostArg to be matched
      attr_accessor :selector

      # @return [PostArgsOperator] Describes operator to be matched. Possible
      ...
      #
      # Mapper for PostArgsMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PostArgsMatchConditionParameters',
          type: {
            name: 'Composite',
            ...
            model_properties: {
              odatatype: {
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRulePostArgsConditionParameters',
                type: {
                  name: 'String'
                }
              },
