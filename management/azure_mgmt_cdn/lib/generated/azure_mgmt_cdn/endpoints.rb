...
module Azure::ARM::CDN
  ...
  class Endpoints
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::CDN::Models::EndpointListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, profile_name, endpoint_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::CDN::Models::Endpoint.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_async(resource_group_name, profile_name, endpoint_name, endpoint, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::ARM::CDN::Models::Endpoint.new.from_json(parsed_response)
        end
    ...
    def validate_custom_domain_async(resource_group_name, profile_name, endpoint_name, custom_domain_properties, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::CDN::Models::ValidateCustomDomainOutput.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_resource_usage_async(resource_group_name, profile_name, endpoint_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::CDN::Models::ResourceUsageListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_async(resource_group_name, profile_name, endpoint_name, endpoint, custom_headers = nil)
      ...
      # Serialize Request
      request_content = endpoint.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update_async(resource_group_name, profile_name, endpoint_name, endpoint_update_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = endpoint_update_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_purge_content_async(resource_group_name, profile_name, endpoint_name, content_file_paths, custom_headers = nil)
      ...
      # Serialize Request
      request_content = content_file_paths.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
