      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::CDN::Mgmt::V2017_04_02::Models::CustomDomainListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, profile_name, endpoint_name, custom_domain_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CDN::Mgmt::V2017_04_02::Models::CustomDomain.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_async(resource_group_name, profile_name, endpoint_name, custom_domain_name, custom_domain_properties, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::CDN::Mgmt::V2017_04_02::Models::CustomDomain.new.from_json(parsed_response)
        end
