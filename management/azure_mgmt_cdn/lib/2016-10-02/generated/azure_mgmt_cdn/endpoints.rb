...
module Azure::CDN::Mgmt::V2016_10_02
  ...
  class Endpoints
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::CDN::Mgmt::V2016_10_02::Models::EndpointListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, profile_name, endpoint_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CDN::Mgmt::V2016_10_02::Models::Endpoint.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_async(resource_group_name, profile_name, endpoint_name, endpoint, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::CDN::Mgmt::V2016_10_02::Models::Endpoint.new.from_json(parsed_response)
        end
    ...
    def validate_custom_domain_async(resource_group_name, profile_name, endpoint_name, custom_domain_properties, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CDN::Mgmt::V2016_10_02::Models::ValidateCustomDomainOutput.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_create_async(resource_group_name, profile_name, endpoint_name, endpoint, custom_headers = nil)
      ...
      # Serialize Request
      request_content = endpoint.nil? ? nil: endpoint.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update_async(resource_group_name, profile_name, endpoint_name, endpoint_update_properties, custom_headers = nil)
      ...
      # Serialize Request
      request_content = endpoint_update_properties.nil? ? nil: endpoint_update_properties.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
