...
module Azure::ARM::CDN::Api_2015_06_01
  ...
  class CustomDomains
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::CustomDomainListResult.mapper()
    ...
    def get_async(custom_domain_name, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::CustomDomain.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(custom_domain_name, custom_domain_properties, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::CustomDomainParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        begin
          parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
          result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::ErrorResponse.mapper()
          result.body = @client.deserialize(result_mapper, parsed_response)
        rescue Exception => e
          fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
        end
