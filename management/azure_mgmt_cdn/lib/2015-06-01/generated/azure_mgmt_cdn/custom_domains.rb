  ...
  class CustomDomains
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::CDN::Mgmt::V2015_06_01::Models::CustomDomainListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(custom_domain_name, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::CDN::Mgmt::V2015_06_01::Models::CustomDomain.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_async(custom_domain_name, custom_domain_properties, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::CDN::Mgmt::V2015_06_01::Models::CustomDomain.new.from_json(parsed_response)
        end
    ...
    def update_async(custom_domain_name, custom_domain_properties, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        begin
          parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
          result.body = Azure::CDN::Mgmt::V2015_06_01::Models::ErrorResponse.new.from_json(parsed_response)
        rescue Exception => e
          fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
        end
