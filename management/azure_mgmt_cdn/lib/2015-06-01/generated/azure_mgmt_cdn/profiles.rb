...
module Azure::ARM::CDN::Api_2015_06_01
  ...
  class Profiles
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::ProfileListResult.mapper()
    ...
    def get_async(profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::Profile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def generate_sso_uri_async(profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::SsoUri.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(profile_name, profile_properties, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::ProfileCreateParameters.mapper()
    ...
    def begin_update_async(profile_name, profile_properties, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::CDN::Api_2015_06_01::Models::ProfileUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  profile_properties)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
