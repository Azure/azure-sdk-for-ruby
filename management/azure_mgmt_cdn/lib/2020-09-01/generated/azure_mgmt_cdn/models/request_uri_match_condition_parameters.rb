...
module Azure::CDN::Mgmt::V2020_09_01
  module Models
    ...
    class RequestUriMatchConditionParameters
      ...
      # @return [RequestUriOperator] Describes operator to be matched. Possible
      ...
      #
      # Mapper for RequestUriMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RequestUriMatchConditionParameters',
          type: {
            name: 'Composite',
            ...
            model_properties: {
              odatatype: {
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRuleRequestUriConditionParameters',
                type: {
                  name: 'String'
                }
              },
