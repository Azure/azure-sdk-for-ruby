...
module Azure::CDN::Mgmt::V2020_09_01
  module Models
    ...
    class UrlPathMatchConditionParameters
      ...
      # @return [UrlPathOperator] Describes operator to be matched. Possible
      ...
      #
      # Mapper for UrlPathMatchConditionParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'UrlPathMatchConditionParameters',
          type: {
            name: 'Composite',
            class_name: 'UrlPathMatchConditionParameters',
            model_properties: {
              odatatype: {
                client_side_validation: true,
                required: true,
                ...
                default_value: '#Microsoft.Azure.Cdn.Models.DeliveryRuleUrlPathMatchConditionParameters',
                type: {
                  name: 'String'
                }
              },
