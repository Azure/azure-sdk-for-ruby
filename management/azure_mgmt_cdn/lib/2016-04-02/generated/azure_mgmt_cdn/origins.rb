...
module Azure::ARM::CDN::Api_2016_04_02
  ...
  class Origins
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::CDN::Api_2016_04_02::Models::OriginListResult.mapper()
    ...
    def get_async(origin_name, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::CDN::Api_2016_04_02::Models::Origin.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(origin_name, origin_properties, endpoint_name, profile_name, resource_group_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::CDN::Api_2016_04_02::Models::OriginParameters.mapper()
