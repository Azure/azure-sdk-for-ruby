...
module Azure::StreamAnalytics::Mgmt::V2016_03_01
  ...
  class Outputs
    ...
    def create_or_replace_async(output, resource_group_name, job_name, output_name, if_match = nil, if_none_match = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_content = output.nil? ? nil: output.to_json
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::StreamAnalytics::Mgmt::V2016_03_01::Models::Output.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_streaming_job_async(resource_group_name, job_name, select = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::StreamAnalytics::Mgmt::V2016_03_01::Models::OutputListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def test_async(resource_group_name, job_name, output_name, output = nil, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::StreamAnalytics::Mgmt::V2016_03_01::Models::ResourceTestStatus.new.from_json(parsed_response)
        end
    ...
    def begin_test_async(resource_group_name, job_name, output_name, output = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::StreamAnalytics::Mgmt::V2016_03_01::Models::ResourceTestStatus.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
