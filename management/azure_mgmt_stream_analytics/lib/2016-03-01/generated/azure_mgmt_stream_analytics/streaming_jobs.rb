...
module Azure::ARM::StreamAnalytics::Api_2016_03_01
  ...
  class StreamingJobs
    ...
    def create_or_replace_async(streaming_job, resource_group_name, job_name, if_match = nil, if_none_match = nil, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::StreamingJob.mapper()
    ...
    def update_async(streaming_job, resource_group_name, job_name, if_match = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::StreamingJob.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, expand = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::StreamingJobListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_start_async(resource_group_name, job_name, start_job_parameters = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::StartStreamingJobParameters.mapper()
