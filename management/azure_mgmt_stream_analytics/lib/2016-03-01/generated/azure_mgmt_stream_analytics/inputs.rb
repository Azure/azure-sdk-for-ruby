...
module Azure::ARM::StreamAnalytics::Api_2016_03_01
  ...
  class Inputs
    ...
    def create_or_replace_async(input, resource_group_name, job_name, input_name, if_match = nil, if_none_match = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::Input.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::Input.mapper()
    ...
    def list_by_streaming_job_async(resource_group_name, job_name, select = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::StreamAnalytics::Api_2016_03_01::Models::InputListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
