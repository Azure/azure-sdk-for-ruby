...
module Azure::ARM::StreamAnalytics
  ...
  class Outputs
    ...
    def create_or_replace_async(output, resource_group_name, job_name, output_name, if_match = nil, if_none_match = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::StreamAnalytics::Models::Output.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::StreamAnalytics::Models::Output.mapper()
    ...
    def list_by_streaming_job_async(resource_group_name, job_name, select = nil, custom_headers = nil)
      ...
      options = {
          ...
          query_params: {'$select' => select,'api-version' => api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
      promise = @client.make_request_async(:get, path_template, options)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::StreamAnalytics::Models::OutputListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
