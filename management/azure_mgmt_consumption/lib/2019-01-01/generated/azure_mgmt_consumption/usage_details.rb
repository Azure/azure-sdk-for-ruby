...
module Azure::Consumption::Mgmt::V2019_01_01
  ...
  class UsageDetails
    ...
    #
    def list(scope, expand = nil, filter = nil, skiptoken = nil, top = nil, query_options = nil, custom_headers = nil)
      first_page = list_as_lazy(scope, expand, filter, skiptoken, top, query_options, custom_headers)
    ...
    #
    def list_with_http_info(scope, expand = nil, filter = nil, skiptoken = nil, top = nil, query_options = nil, custom_headers = nil)
      list_async(scope, expand, filter, skiptoken, top, query_options, custom_headers).value!
    end
    ...
    #
    def list_async(scope, expand = nil, filter = nil, skiptoken = nil, top = nil, query_options = nil, custom_headers = nil)
    ...
    # response.
    #
    def list_as_lazy(scope, expand = nil, filter = nil, skiptoken = nil, top = nil, query_options = nil, custom_headers = nil)
      response = list_async(scope, expand, filter, skiptoken, top, query_options, custom_headers).value!
      unless response.nil?
        page = response.body
