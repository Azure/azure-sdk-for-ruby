...
module Azure::Consumption::Mgmt::V2019_01_01
  ...
  class Marketplaces
    ...
    def list(scope, filter = nil, top = nil, skiptoken = nil, custom_headers = nil)
      first_page = list_as_lazy(scope, filter, top, skiptoken, custom_headers)
    ...
    def list_with_http_info(scope, filter = nil, top = nil, skiptoken = nil, custom_headers = nil)
      list_async(scope, filter, top, skiptoken, custom_headers).value!
    end
    ...
    def list_as_lazy(scope, filter = nil, top = nil, skiptoken = nil, custom_headers = nil)
      response = list_async(scope, filter, top, skiptoken, custom_headers).value!
      unless response.nil?
        page = response.body
