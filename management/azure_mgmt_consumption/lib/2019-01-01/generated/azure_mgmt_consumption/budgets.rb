...
module Azure::Consumption::Mgmt::V2019_01_01
  ...
  class Budgets
    ...
    def list(scope, custom_headers = nil)
      first_page = list_as_lazy(scope, custom_headers)
    ...
    def list_with_http_info(scope, custom_headers = nil)
      list_async(scope, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_01_01::Models::BudgetsListResult.mapper()
    ...
    def get(scope, budget_name, custom_headers = nil)
      response = get_async(scope, budget_name, custom_headers).value!
    ...
    def get_with_http_info(scope, budget_name, custom_headers = nil)
      get_async(scope, budget_name, custom_headers).value!
    end
    ...
    def get_async(scope, budget_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Consumption::Mgmt::V2019_01_01::Models::Budget.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(scope, budget_name, parameters, custom_headers = nil)
      response = create_or_update_async(scope, budget_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(scope, budget_name, parameters, custom_headers = nil)
      create_or_update_async(scope, budget_name, parameters, custom_headers).value!
    end
    ...
    def create_or_update_async(scope, budget_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::Consumption::Mgmt::V2019_01_01::Models::Budget.mapper()
    ...
    def delete(scope, budget_name, custom_headers = nil)
      response = delete_async(scope, budget_name, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(scope, budget_name, custom_headers = nil)
      delete_async(scope, budget_name, custom_headers).value!
    end
    ...
    def list_as_lazy(scope, custom_headers = nil)
      response = list_async(scope, custom_headers).value!
      unless response.nil?
        page = response.body
