...
module Azure::Consumption::Mgmt::V2019_01_01
  ...
  class Balances
    ...
    def get_by_billing_account(billing_account_id, custom_headers = nil)
      response = get_by_billing_account_async(billing_account_id, custom_headers).value!
    ...
    def get_by_billing_account_with_http_info(billing_account_id, custom_headers = nil)
      get_by_billing_account_async(billing_account_id, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_01_01::Models::Balance.mapper()
    ...
    def get_for_billing_period_by_billing_account(billing_account_id, billing_period_name, custom_headers = nil)
      response = get_for_billing_period_by_billing_account_async(billing_account_id, billing_period_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_for_billing_period_by_billing_account_with_http_info(billing_account_id, billing_period_name, custom_headers = nil)
      get_for_billing_period_by_billing_account_async(billing_account_id, billing_period_name, custom_headers).value!
    end
