...
module Azure::Consumption::Mgmt::V2019_01_01
  ...
  class AggregatedCost
    ...
    def get_by_management_group(management_group_id, filter = nil, custom_headers = nil)
      response = get_by_management_group_async(management_group_id, filter, custom_headers).value!
    ...
    def get_by_management_group_with_http_info(management_group_id, filter = nil, custom_headers = nil)
      get_by_management_group_async(management_group_id, filter, custom_headers).value!
    end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_01_01::Models::ManagementGroupAggregatedCostResult.mapper()
    ...
    def get_for_billing_period_by_management_group(management_group_id, billing_period_name, custom_headers = nil)
      response = get_for_billing_period_by_management_group_async(management_group_id, billing_period_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def get_for_billing_period_by_management_group_with_http_info(management_group_id, billing_period_name, custom_headers = nil)
      get_for_billing_period_by_management_group_async(management_group_id, billing_period_name, custom_headers).value!
    end
