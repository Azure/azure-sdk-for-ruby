...
module Azure::Automation::Mgmt::V2015_10_31
  ...
  class RunbookOperations
    ...
    def create_or_update(automation_account_name, runbook_name, parameters, custom_headers = nil)
      response = create_or_update_async(automation_account_name, runbook_name, parameters, custom_headers).value!
      nil
    end
    ...
    def create_or_update_with_http_info(automation_account_name, runbook_name, parameters, custom_headers = nil)
      create_or_update_async(automation_account_name, runbook_name, parameters, custom_headers).value!
    end
    ...
    def update(automation_account_name, runbook_name, parameters, custom_headers = nil)
      response = update_async(automation_account_name, runbook_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(automation_account_name, runbook_name, parameters, custom_headers = nil)
      update_async(automation_account_name, runbook_name, parameters, custom_headers).value!
    end
    ...
    def delete(automation_account_name, runbook_name, custom_headers = nil)
      response = delete_async(automation_account_name, runbook_name, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(automation_account_name, runbook_name, custom_headers = nil)
      delete_async(automation_account_name, runbook_name, custom_headers).value!
    end
