...
module Azure::Automation::Mgmt::V2015_10_31
  ...
  class DscConfigurationOperations
    ...
    def update(resource_group_name, automation_account_name, configuration_name, parameters = nil, custom_headers = nil)
      response = update_async(resource_group_name, automation_account_name, configuration_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_with_http_info(resource_group_name, automation_account_name, configuration_name, parameters = nil, custom_headers = nil)
      update_async(resource_group_name, automation_account_name, configuration_name, parameters, custom_headers).value!
    end
    ...
    def list_by_automation_account(resource_group_name, automation_account_name, filter = nil, skip = nil, top = nil, inlinecount = nil, custom_headers = nil)
      first_page = list_by_automation_account_as_lazy(resource_group_name, automation_account_name, filter, skip, top, inlinecount, custom_headers)
    ...
    def list_by_automation_account_with_http_info(resource_group_name, automation_account_name, filter = nil, skip = nil, top = nil, inlinecount = nil, custom_headers = nil)
      list_by_automation_account_async(resource_group_name, automation_account_name, filter, skip, top, inlinecount, custom_headers).value!
    end
    ...
    def list_by_automation_account_as_lazy(resource_group_name, automation_account_name, filter = nil, skip = nil, top = nil, inlinecount = nil, custom_headers = nil)
      response = list_by_automation_account_async(resource_group_name, automation_account_name, filter, skip, top, inlinecount, custom_headers).value!
      unless response.nil?
        page = response.body
