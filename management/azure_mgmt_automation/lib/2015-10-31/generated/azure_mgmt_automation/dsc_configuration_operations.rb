...
module Azure::ARM::Automation::Api_2015_10_31
  ...
  class DscConfigurationOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscConfiguration.mapper()
    ...
    def create_or_update_async(resource_group_name, automation_account_name, configuration_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscConfigurationCreateOrUpdateParameters.mapper()
    ...
    def list_by_automation_account_async(resource_group_name, automation_account_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscConfigurationListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
