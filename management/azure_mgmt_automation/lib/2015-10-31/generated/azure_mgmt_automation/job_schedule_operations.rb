...
module Azure::Automation::Mgmt::V2015_10_31
  ...
  class JobScheduleOperations
    ...
    def delete(automation_account_name, job_schedule_id, custom_headers = nil)
      response = delete_async(automation_account_name, job_schedule_id, custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(automation_account_name, job_schedule_id, custom_headers = nil)
      delete_async(automation_account_name, job_schedule_id, custom_headers).value!
    end
    ...
    def get(automation_account_name, job_schedule_id, custom_headers = nil)
      response = get_async(automation_account_name, job_schedule_id, custom_headers).value!
    ...
    def get_with_http_info(automation_account_name, job_schedule_id, custom_headers = nil)
      get_async(automation_account_name, job_schedule_id, custom_headers).value!
    end
    ...
    def create(automation_account_name, job_schedule_id, parameters, custom_headers = nil)
      response = create_async(automation_account_name, job_schedule_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_with_http_info(automation_account_name, job_schedule_id, parameters, custom_headers = nil)
      create_async(automation_account_name, job_schedule_id, parameters, custom_headers).value!
    end
