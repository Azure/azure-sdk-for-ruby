...
module Azure::ARM::Automation::Api_2015_10_31
  ...
  class DscCompilationJobOperations
    ...
    def create_async(resource_group_name, automation_account_name, compilation_job_id, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscCompilationJobCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscCompilationJob.mapper()
    ...
    def list_by_automation_account_async(resource_group_name, automation_account_name, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::DscCompilationJobListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_stream_async(resource_group_name, automation_account_name, job_id, job_stream_id, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Automation::Api_2015_10_31::Models::JobStream.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
