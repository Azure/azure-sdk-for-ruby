      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Automation::Mgmt::V2015_10_31::Models::Activity.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_module_async(resource_group_name, automation_account_name, module_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Automation::Mgmt::V2015_10_31::Models::ActivityListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
