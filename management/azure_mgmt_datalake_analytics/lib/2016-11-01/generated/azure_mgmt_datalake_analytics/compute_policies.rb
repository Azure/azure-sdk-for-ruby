...
module Azure::ARM::DataLakeAnalytics::Api_2016_11_01
  ...
  class ComputePolicies
    ...
    def create_or_update_async(resource_group_name, account_name, compute_policy_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::ComputePolicyCreateOrUpdateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::ComputePolicy.mapper()
    ...
    def update_async(resource_group_name, account_name, compute_policy_name, parameters = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::ComputePolicy.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_account_async(resource_group_name, account_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::ComputePolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
