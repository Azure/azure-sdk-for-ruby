...
module Azure::ARM::DataLakeAnalytics::Api_2016_11_01
  ...
  class DataLakeStoreAccounts
    ...
    def add_async(resource_group_name, account_name, data_lake_store_account_name, parameters = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::AddDataLakeStoreParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::DataLakeStoreAccountInfo.mapper()
    ...
    def list_by_account_async(resource_group_name, account_name, filter = nil, top = nil, skip = nil, select = nil, orderby = nil, count = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::DataLakeAnalytics::Api_2016_11_01::Models::DataLakeAnalyticsAccountListDataLakeStoreResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
