...
module Azure::ARM::TrafficManager::Api_2015_11_01
  ...
  class Endpoints
    ...
    def update_async(resource_group_name, profile_name, endpoint_type, endpoint_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::TrafficManager::Api_2015_11_01::Models::Endpoint.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::TrafficManager::Api_2015_11_01::Models::Endpoint.mapper()
