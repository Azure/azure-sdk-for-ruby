...
Gem::Specification.new do |spec|
  ...
  spec.version       = Azure::ResourceGraph::Mgmt::VERSION
  spec.authors       = 'Microsoft Corporation'
  spec.email         = 'azrubyteam@microsoft.com'
  spec.description   = 'Microsoft Azure Resource Graph Library for Ruby'
  spec.summary       = 'Official Ruby client library to consume Microsoft Azure Resource Graph.'
