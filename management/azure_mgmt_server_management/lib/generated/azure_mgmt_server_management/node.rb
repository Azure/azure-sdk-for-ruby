...
module Azure::ARM::ServerManagement
  ...
  class Node
    ...
    def create_async(resource_group_name, node_name, location = nil, tags = nil, gateway_id = nil, connection_name = nil, user_name = nil, password = nil, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::ARM::ServerManagement::Models::NodeResource.new.from_json(parsed_response)
        end
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::ARM::ServerManagement::Models::NodeResource.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::ARM::ServerManagement::Models::NodeResources.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def begin_update_async(resource_group_name, node_name, location = nil, tags = nil, gateway_id = nil, connection_name = nil, user_name = nil, password = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_content = node_parameters.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
