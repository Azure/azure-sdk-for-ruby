...
module Azure::Scheduler::Mgmt::V2016_03_01
  ...
  class Jobs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Scheduler::Mgmt::V2016_03_01::Models::JobDefinition.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_or_update_async(resource_group_name, job_collection_name, job_name, job, custom_headers = nil)
      ...
      # Serialize Request
      request_content = job.nil? ? nil: job.to_json
    ...
    def list_async(resource_group_name, job_collection_name, top = nil, skip = nil, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Scheduler::Mgmt::V2016_03_01::Models::JobListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_job_history_async(resource_group_name, job_collection_name, job_name, top = nil, skip = nil, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Scheduler::Mgmt::V2016_03_01::Models::JobHistoryListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
