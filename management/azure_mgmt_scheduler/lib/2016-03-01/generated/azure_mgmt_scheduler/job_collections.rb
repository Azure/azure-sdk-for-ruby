...
module Azure::ARM::ResourcesManagement::Api_2016_03_01
  ...
  class JobCollections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::ResourcesManagement::Api_2016_03_01::Models::JobCollectionListResult.mapper()
    ...
    def get_async(resource_group_name, job_collection_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::ResourcesManagement::Api_2016_03_01::Models::JobCollectionDefinition.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, job_collection_name, job_collection, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::ResourcesManagement::Api_2016_03_01::Models::JobCollectionDefinition.mapper()
