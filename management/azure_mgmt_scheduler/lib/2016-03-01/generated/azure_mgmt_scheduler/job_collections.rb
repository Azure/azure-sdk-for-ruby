...
module Azure::Scheduler::Mgmt::V2016_03_01
  ...
  class JobCollections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Scheduler::Mgmt::V2016_03_01::Models::JobCollectionListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, job_collection_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Scheduler::Mgmt::V2016_03_01::Models::JobCollectionDefinition.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, job_collection_name, job_collection, custom_headers = nil)
      ...
      # Serialize Request
      request_content = job_collection.nil? ? nil: job_collection.to_json
