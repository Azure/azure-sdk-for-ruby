...
module Azure::ARM::Logic::Api_2015_02_01_preview
  ...
  class WorkflowAccessKeys
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::Logic::Api_2015_02_01_preview::Models::WorkflowAccessKeyListResult.mapper()
    ...
    def get_async(resource_group_name, workflow_name, access_key_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Logic::Api_2015_02_01_preview::Models::WorkflowAccessKey.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, workflow_name, access_key_name, workflow_accesskey, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Logic::Api_2015_02_01_preview::Models::WorkflowAccessKey.mapper()
    ...
    def list_secret_keys_async(resource_group_name, workflow_name, access_key_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Logic::Api_2015_02_01_preview::Models::WorkflowSecretKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_secret_key_async(resource_group_name, workflow_name, access_key_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Logic::Api_2015_02_01_preview::Models::RegenerateSecretKeyParameters.mapper()
