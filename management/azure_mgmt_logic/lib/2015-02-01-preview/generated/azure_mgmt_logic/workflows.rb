...
module Azure::Logic::Mgmt::V2015_02_01_preview
  ...
  class Workflows
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Logic::Mgmt::V2015_02_01_preview::Models::WorkflowListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, workflow_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Logic::Mgmt::V2015_02_01_preview::Models::Workflow.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, workflow_name, workflow, custom_headers = nil)
      ...
      # Serialize Request
      request_content = workflow.nil? ? nil: workflow.to_json
    ...
    def run_async(resource_group_name, workflow_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::Logic::Mgmt::V2015_02_01_preview::Models::WorkflowRun.new.from_json(parsed_response)
        end
    ...
    def begin_run_async(resource_group_name, workflow_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 202
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Logic::Mgmt::V2015_02_01_preview::Models::WorkflowRun.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
