...
module Azure::Logic::Mgmt::V2016_06_01
  ...
  class Workflows
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Logic::Mgmt::V2016_06_01::Models::WorkflowListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, workflow_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Logic::Mgmt::V2016_06_01::Models::Workflow.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def regenerate_access_key_async(resource_group_name, workflow_name, key_type, custom_headers = nil)
      ...
      # Serialize Request
      request_content = key_type.nil? ? nil: key_type.to_json
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
