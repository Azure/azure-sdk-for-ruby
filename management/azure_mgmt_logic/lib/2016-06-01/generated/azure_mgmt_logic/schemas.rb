...
module Azure::Logic::Mgmt::V2016_06_01
  ...
  class Schemas
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Logic::Mgmt::V2016_06_01::Models::IntegrationAccountSchemaListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, integration_account_name, schema_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Logic::Mgmt::V2016_06_01::Models::IntegrationAccountSchema.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, integration_account_name, schema_name, schema, custom_headers = nil)
      ...
      # Serialize Request
      request_content = schema.nil? ? nil: schema.to_json
