...
module Azure::Logic::Mgmt::V2016_06_01
  ...
  class WorkflowRuns
    ...
    #
    #
    def delete(resource_group_name, workflow_name, run_name, custom_headers = nil)
      response = delete_async(resource_group_name, workflow_name, run_name, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def delete_with_http_info(resource_group_name, workflow_name, run_name, custom_headers = nil)
      delete_async(resource_group_name, workflow_name, run_name, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def delete_async(resource_group_name, workflow_name, run_name, custom_headers = nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'workflow_name is nil' if workflow_name.nil?
      fail ArgumentError, 'run_name is nil' if run_name.nil?
