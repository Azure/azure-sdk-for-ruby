...
module Azure::Logic::Mgmt::V2018_07_01_preview
  ...
  class Workflows
    ...
    def list_callback_url(resource_group_name, workflow_name, list_callback_url, custom_headers = nil)
      response = list_callback_url_async(resource_group_name, workflow_name, list_callback_url, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_callback_url_with_http_info(resource_group_name, workflow_name, list_callback_url, custom_headers = nil)
      list_callback_url_async(resource_group_name, workflow_name, list_callback_url, custom_headers).value!
    end
    ...
    def move(resource_group_name, workflow_name, move, custom_headers = nil)
      response = move_async(resource_group_name, workflow_name, move, custom_headers).value!
      nil
    end
    ...
    def move_with_http_info(resource_group_name, workflow_name, move, custom_headers = nil)
      move_async(resource_group_name, workflow_name, move, custom_headers).value!
    end
    ...
    def validate_by_resource_group(resource_group_name, workflow_name, validate, custom_headers = nil)
      response = validate_by_resource_group_async(resource_group_name, workflow_name, validate, custom_headers).value!
      nil
    end
    ...
    def validate_by_resource_group_with_http_info(resource_group_name, workflow_name, validate, custom_headers = nil)
      validate_by_resource_group_async(resource_group_name, workflow_name, validate, custom_headers).value!
    end
    ...
    def validate_by_location(resource_group_name, location, workflow_name, workflow, custom_headers = nil)
      response = validate_by_location_async(resource_group_name, location, workflow_name, workflow, custom_headers).value!
      nil
    end
    ...
    def validate_by_location_with_http_info(resource_group_name, location, workflow_name, workflow, custom_headers = nil)
      validate_by_location_async(resource_group_name, location, workflow_name, workflow, custom_headers).value!
    end
