...
module Azure::DataShare::Mgmt::V2019_11_01
  module Models
    ...
    class ADLSGen2FileSystemDataSetMapping < DataSetMapping
      ...
      # @return [String] The file system name.
      ...
      #
      # Mapper for ADLSGen2FileSystemDataSetMapping class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AdlsGen2FileSystem',
          type: {
            name: 'Composite',
            class_name: 'ADLSGen2FileSystemDataSetMapping',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
