      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result.body = Azure::Policy::Mgmt::V2015_10_01_preview::Models::PolicyDefinition.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_async(filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Policy::Mgmt::V2015_10_01_preview::Models::PolicyDefinitionListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
