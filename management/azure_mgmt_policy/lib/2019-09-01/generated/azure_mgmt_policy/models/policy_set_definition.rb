...
module Azure::Policy::Mgmt::V2019_09_01
  module Models
    ...
    class PolicySetDefinition
      ...
      # @return The policy set definition metadata.  Metadata is an open ended
      # object and is typically a collection of key value pairs.
      attr_accessor :metadata

      # @return [Hash{String => ParameterDefinitionsValue}] The policy set
      ...
      # @return [Array<PolicyDefinitionGroup>] The metadata describing groups
      # of policy definition references within the policy set definition.
      attr_accessor :policy_definition_groups
          ...
          type: {
            ...
            model_properties: {
              ...
              policy_definition_groups: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.policyDefinitionGroups',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'PolicyDefinitionGroupElementType',
                      type: {
                        name: 'Composite',
