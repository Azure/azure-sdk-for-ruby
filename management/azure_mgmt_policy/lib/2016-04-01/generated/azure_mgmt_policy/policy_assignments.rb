      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Policy::Mgmt::V2016_04_01::Models::PolicyAssignment.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_for_resource_group_async(resource_group_name, filter = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Policy::Mgmt::V2016_04_01::Models::PolicyAssignmentListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
