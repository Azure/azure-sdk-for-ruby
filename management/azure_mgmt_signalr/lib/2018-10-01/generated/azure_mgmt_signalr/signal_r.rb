...
module Azure::Signalr::Mgmt::V2018_10_01
  ...
  class SignalR
    ...
    def restart(resource_group_name, resource_name, custom_headers = nil)
      response = restart_async(resource_group_name, resource_name, custom_headers).value!
      nil
    end
    ...
    def restart_async(resource_group_name, resource_name, custom_headers = nil)
      # Send request
      promise = begin_restart_async(resource_group_name, resource_name, custom_headers)
    ...
    # Manager API or the portal.
    # @param resource_name [String] The name of the SignalR resource.
    # @param parameters [SignalRFeaturesParameters] Parameters that describes the
    # SignalR resource features opreation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [SignalRFeatureList] operation results.
    #
    def switch_features(resource_group_name, resource_name, parameters = nil, custom_headers = nil)
      response = switch_features_async(resource_group_name, resource_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def switch_features_async(resource_group_name, resource_name, parameters = nil, custom_headers = nil)
      # Send request
      promise = begin_switch_features_async(resource_group_name, resource_name, parameters, custom_headers)

      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Signalr::Mgmt::V2018_10_01::Models::SignalRFeatureList.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    # @return [SignalRFeatureList] operation results.
    #
    def list_features(resource_group_name, resource_name, custom_headers = nil)
      response = list_features_async(resource_group_name, resource_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_features_with_http_info(resource_group_name, resource_name, custom_headers = nil)
      list_features_async(resource_group_name, resource_name, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_features_async(resource_group_name, resource_name, custom_headers = nil)
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'resource_name is nil' if resource_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/SignalR/{resourceName}/listFeatures'
    ...
    def begin_restart(resource_group_name, resource_name, custom_headers = nil)
      response = begin_restart_async(resource_group_name, resource_name, custom_headers).value!
      nil
    end
    ...
    def begin_restart_with_http_info(resource_group_name, resource_name, custom_headers = nil)
      begin_restart_async(resource_group_name, resource_name, custom_headers).value!
    end
    ...
    # @return [SignalRFeatureList] operation results.
    #
    def begin_switch_features(resource_group_name, resource_name, parameters = nil, custom_headers = nil)
      response = begin_switch_features_async(resource_group_name, resource_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_switch_features_with_http_info(resource_group_name, resource_name, parameters = nil, custom_headers = nil)
      begin_switch_features_async(resource_group_name, resource_name, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_switch_features_async(resource_group_name, resource_name, parameters = nil, custom_headers = nil)
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'resource_name is nil' if resource_name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::Signalr::Mgmt::V2018_10_01::Models::SignalRFeaturesParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/SignalR/{resourceName}/switchFeatures'
