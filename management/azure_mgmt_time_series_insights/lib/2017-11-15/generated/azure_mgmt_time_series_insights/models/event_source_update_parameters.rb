...
module Azure::TimeSeriesInsights::Mgmt::V2017_11_15
  module Models
    ...
    class EventSourceUpdateParameters
      ...
      # properties for the event source.
      attr_accessor :tags


      #
      # Mapper for EventSourceUpdateParameters class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'EventSourceUpdateParameters',
          type: {
            name: 'Composite',
            class_name: 'EventSourceUpdateParameters',
            model_properties: {
              tags: {
                client_side_validation: true,
                required: false,
