...
module Azure::ContainerInstance::Mgmt::V2017_12_01_preview
  ...
  class ContainerLogs
    ...
    def list(resource_group_name, container_group_name, container_name, tail = nil, custom_headers = nil)
      response = list_async(resource_group_name, container_group_name, container_name, tail, custom_headers).value!
    ...
    def list_with_http_info(resource_group_name, container_group_name, container_name, tail = nil, custom_headers = nil)
      list_async(resource_group_name, container_group_name, container_name, tail, custom_headers).value!
    end
