...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  module Models
    ...
    class ExtendedSqlPoolBlobAuditingPolicy < ProxyResource
      ...
      # account.
      # If state is Enabled and storageEndpoint is specified, not specifying
      # the storageAccountAccessKey will use SQL server system-assigned managed
      ...
      #
      # Mapper for ExtendedSqlPoolBlobAuditingPolicy class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ExtendedSqlPoolBlobAuditingPolicy',
          type: {
            name: 'Composite',
