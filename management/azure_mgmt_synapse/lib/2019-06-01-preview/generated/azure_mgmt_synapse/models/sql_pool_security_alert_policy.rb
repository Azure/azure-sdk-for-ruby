...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  module Models
    ...
    class SqlPoolSecurityAlertPolicy < ProxyResource
      ...
      # on the specific Sql pool. Possible values include: 'New', 'Enabled',
      # 'Disabled'
      attr_accessor :state
      ...
      #
      # Mapper for SqlPoolSecurityAlertPolicy class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'SqlPoolSecurityAlertPolicy',
          type: {
            name: 'Composite',
