...
module Azure::ContainerService::Mgmt::V2019_04_01
  module Models
    ...
    class ManagedCluster < Resource
      ...
      # @return [Array<String>] (PREVIEW) Authorized IP Ranges to kubernetes
      # API server.
      attr_accessor :api_server_authorized_ipranges
          ...
          type: {
            ...
            model_properties: {
              ...
              api_server_authorized_ipranges: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.apiServerAuthorizedIPRanges',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
