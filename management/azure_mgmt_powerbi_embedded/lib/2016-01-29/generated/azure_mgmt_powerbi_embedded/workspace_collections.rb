...
module Azure::PowerBiEmbedded::Mgmt::V2016_01_29
  ...
  class WorkspaceCollections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::PowerBiEmbedded::Mgmt::V2016_01_29::Models::WorkspaceCollection.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def create_async(resource_group_name, workspace_collection_name, body, custom_headers = nil)
      ...
      # Serialize Request
      request_content = body.nil? ? nil: body.to_json
    ...
    def check_name_availability_async(location, body, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::PowerBiEmbedded::Mgmt::V2016_01_29::Models::CheckNameResponse.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::PowerBiEmbedded::Mgmt::V2016_01_29::Models::WorkspaceCollectionList.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def get_access_keys_async(resource_group_name, workspace_collection_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::PowerBiEmbedded::Mgmt::V2016_01_29::Models::WorkspaceCollectionAccessKeys.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
