...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    class SiteConfig
      ...
      # @return [String] Version of PowerShell.
      attr_accessor :power_shell_version
      ...
      # @return [Boolean] Virtual Network Route All enabled. This causes all
      # outbound traffic to have Virtual Network Security Groups and User
      # Defined Routes applied.
      attr_accessor :vnet_route_all_enabled

      # @return [Integer] The number of private ports assigned to this app.
      # These will be assigned dynamically on runtime.
      attr_accessor :vnet_private_ports_count
      ...
      # @return [ApiManagementConfig] Azure API management settings linked to
      # the app.
      attr_accessor :api_management_config
      ...
      # @return [Array<IpSecurityRestriction>] IP security restrictions for
      # main.
      attr_accessor :ip_security_restrictions

      # @return [Array<IpSecurityRestriction>] IP security restrictions for
      # scm.
      attr_accessor :scm_ip_security_restrictions

      # @return [Boolean] IP security restrictions for scm to use main.
      attr_accessor :scm_ip_security_restrictions_use_main
          ...
          type: {
            ...
            model_properties: {
              ...
              power_shell_version: {
                client_side_validation: true,
                required: false,
                serialized_name: 'powerShellVersion',
                type: {
                  name: 'String'
                }
              },
              ...
              windows_fx_version: {
                client_side_validation: true,
                required: false,
                serialized_name: 'windowsFxVersion',
                type: {
                  name: 'String'
                }
              },
              ...
              vnet_route_all_enabled: {
                client_side_validation: true,
                required: false,
                serialized_name: 'vnetRouteAllEnabled',
                type: {
                  name: 'Boolean'
                }
              },
              vnet_private_ports_count: {
                client_side_validation: true,
                required: false,
                serialized_name: 'vnetPrivatePortsCount',
                type: {
                  name: 'Number'
                }
              },
              ...
              managed_service_identity_id: {
                client_side_validation: true,
                required: false,
                serialized_name: 'managedServiceIdentityId',
                type: {
                  name: 'Number'
                }
              },
              x_managed_service_identity_id: {
                client_side_validation: true,
                required: false,
                serialized_name: 'xManagedServiceIdentityId',
                type: {
                  name: 'Number'
                }
              },
              ...
              scm_ip_security_restrictions: {
                client_side_validation: true,
                required: false,
                serialized_name: 'scmIpSecurityRestrictions',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
              ...
              scm_ip_security_restrictions_use_main: {
                client_side_validation: true,
                required: false,
                serialized_name: 'scmIpSecurityRestrictionsUseMain',
                type: {
                  name: 'Boolean'
                }
              },
              ...
              scm_min_tls_version: {
                client_side_validation: true,
                required: false,
                serialized_name: 'scmMinTlsVersion',
                type: {
                  name: 'String'
                }
              },
              ...
              pre_warmed_instance_count: {
                client_side_validation: true,
                required: false,
                serialized_name: 'preWarmedInstanceCount',
                constraints: {
                  InclusiveMaximum: 10,
                  InclusiveMinimum: 0
                },
              ...
              health_check_path: {
                client_side_validation: true,
                required: false,
                serialized_name: 'healthCheckPath',
                type: {
                  name: 'String'
                }
              }
