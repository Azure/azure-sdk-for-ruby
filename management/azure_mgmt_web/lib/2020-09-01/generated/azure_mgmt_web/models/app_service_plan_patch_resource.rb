...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    class AppServicePlanPatchResource < ProxyOnlyResource
      ...
      attr_accessor :free_offer_expiration_time

      # @return [String] Resource group of the App Service plan.
      attr_accessor :resource_group

      # @return [Boolean] This needs to set to <code>true</code> when creating
      # a Linux App Service Plan, along with <code>kind</code> set to
