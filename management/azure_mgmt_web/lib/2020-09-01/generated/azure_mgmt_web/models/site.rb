...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    class Site < Resource
      ...
      # @return [ClientCertMode] This composes with ClientCertEnabled setting.
      ...
      # 'Optional'
      attr_accessor :client_cert_mode

      # @return [String] client certificate authentication comma-separated
      # exclusion paths
      attr_accessor :client_cert_exclusion_paths
      ...
      # @return [String] Unique identifier that verifies the custom domains
      # assigned to the app. Customer will add this id to a txt record for
      # verification.
      attr_accessor :custom_domain_verification_id
      ...
      # @return [RedundancyMode] Site redundancy mode. Possible values include:
      ...
      attr_accessor :in_progress_operation_id
          ...
          type: {
            ...
            model_properties: {
              ...
              client_cert_mode: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.clientCertMode',
                type: {
                  name: 'Enum',
                  module: 'ClientCertMode'
                }
              },
              client_cert_exclusion_paths: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.clientCertExclusionPaths',
                type: {
                  name: 'String'
                }
              },
              ...
              custom_domain_verification_id: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.customDomainVerificationId',
                type: {
                  name: 'String'
                }
              },
              ...
              redundancy_mode: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.redundancyMode',
                type: {
                  name: 'Enum',
                  module: 'RedundancyMode'
                }
              },
              in_progress_operation_id: {
                ...
                required: false,
                read_only: true,
                serialized_name: 'properties.inProgressOperationId',
                type: {
                  name: 'String'
                }
              },
