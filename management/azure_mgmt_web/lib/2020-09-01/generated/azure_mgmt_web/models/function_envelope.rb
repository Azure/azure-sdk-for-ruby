...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    class FunctionEnvelope < ProxyOnlyResource
      ...
      # @return [String] Test data URI.
      attr_accessor :test_data_href
      ...
      # @return [String] The invocation URL
      attr_accessor :invoke_url_template

      # @return [String] The function language
      attr_accessor :language

      # @return [Boolean] Gets or sets a value indicating whether the function
      # is disabled
          ...
          type: {
            ...
            model_properties: {
              ...
              test_data_href: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.test_data_href',
                type: {
                  name: 'String'
                }
              },
              ...
              invoke_url_template: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.invoke_url_template',
                type: {
                  name: 'String'
                }
              },
