...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    class PrivateLinkConnectionApprovalRequestResource < ProxyOnlyResource
      ...
      #
      # Mapper for PrivateLinkConnectionApprovalRequestResource class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PrivateLinkConnectionApprovalRequestResource',
          type: {
            name: 'Composite',
            class_name: 'PrivateLinkConnectionApprovalRequestResource',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
