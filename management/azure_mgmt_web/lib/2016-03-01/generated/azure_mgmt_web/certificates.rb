...
module Azure::Web::Mgmt::V2016_03_01
  ...
  class Certificates
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::Web::Mgmt::V2016_03_01::Models::CertificateCollection.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::Web::Mgmt::V2016_03_01::Models::Certificate.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, name, certificate_envelope, custom_headers = nil)
      ...
      # Serialize Request
      request_content = certificate_envelope.nil? ? nil: certificate_envelope.to_json
