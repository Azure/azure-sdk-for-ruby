...
module Azure::Web::Profiles::Latest
  module Mgmt
    ...
    class WebManagementClass
      attr_reader :app_service_environments, :app_service_plans, :certificates, :deleted_web_apps, :diagnostics, :provider, :recommendations, :resource_health_metadata_operations, :app_service_certificate_orders, :web_apps, :certificate_registration_provider, :domains, :top_level_domains, :domain_registration_provider, :configurable, :base_url, :options, :model_classes
