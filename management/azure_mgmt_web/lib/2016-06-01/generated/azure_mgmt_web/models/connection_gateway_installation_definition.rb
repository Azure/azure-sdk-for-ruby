...
module Azure::Web::Mgmt::V2016_06_01
  module Models
    ...
    class ConnectionGatewayInstallationDefinition < ResourceDefinition
      ...
      # @return [ConnectionGatewayInstallationDefinitionProperties]
      attr_accessor :properties


      #
      # Mapper for ConnectionGatewayInstallationDefinition class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ConnectionGatewayInstallationDefinition',
          type: {
            name: 'Composite',
