...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPolicies
    ...
    def create_or_update(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      response = create_or_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers)
    ...
    def update(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      response = update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers)
    ...
    def list_by_restorable_dropped_database(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers = nil)
      first_page = list_by_restorable_dropped_database_as_lazy(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers)
    ...
    def list_by_restorable_dropped_database_with_http_info(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers = nil)
      list_by_restorable_dropped_database_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
    end
    ...
    def begin_update(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, parameters, custom_headers).value!
    end
    ...
    def list_by_restorable_dropped_database_next(next_page_link, custom_headers = nil)
      response = list_by_restorable_dropped_database_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_by_restorable_dropped_database_next_with_http_info(next_page_link, custom_headers = nil)
      list_by_restorable_dropped_database_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_by_restorable_dropped_database_as_lazy(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers = nil)
      response = list_by_restorable_dropped_database_async(resource_group_name, managed_instance_name, restorable_dropped_database_id, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_by_restorable_dropped_database_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
