...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class SensitivityLabels
    ...
    # @return [Array<SensitivityLabel>] operation results.
    #
    def list_recommended_by_database(resource_group_name, server_name, database_name, filter = nil, custom_headers = nil)
      first_page = list_recommended_by_database_as_lazy(resource_group_name, server_name, database_name, filter, custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_recommended_by_database_with_http_info(resource_group_name, server_name, database_name, filter = nil, custom_headers = nil)
      list_recommended_by_database_async(resource_group_name, server_name, database_name, filter, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_recommended_by_database_async(resource_group_name, server_name, database_name, filter = nil, custom_headers = nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      fail ArgumentError, 'database_name is nil' if database_name.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
    ...
    def list_current_by_database_next(next_page_link, custom_headers = nil)
      response = list_current_by_database_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_current_by_database_next_with_http_info(next_page_link, custom_headers = nil)
      list_current_by_database_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_recommended_by_database_next(next_page_link, custom_headers = nil)
      response = list_recommended_by_database_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_recommended_by_database_next_with_http_info(next_page_link, custom_headers = nil)
      list_recommended_by_database_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_current_by_database_as_lazy(resource_group_name, server_name, database_name, filter = nil, custom_headers = nil)
      ...
      unless response.nil?
        ...
        page.next_method = Proc.new do |next_page_link|
          list_current_by_database_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
    ...
    # the response.
    #
    def list_recommended_by_database_as_lazy(resource_group_name, server_name, database_name, filter = nil, custom_headers = nil)
      response = list_recommended_by_database_async(resource_group_name, server_name, database_name, filter, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_recommended_by_database_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
