...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class ServerDnsAliases
    ...
    def get(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      response = get_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      get_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
    end
    ...
    def create_or_update(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      response = create_or_update_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, server_name, dns_alias_name, custom_headers)
    ...
    def delete(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      response = delete_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, server_name, dns_alias_name, custom_headers)
    ...
    def acquire(resource_group_name, server_name, dns_alias_name, parameters, custom_headers = nil)
      response = acquire_async(resource_group_name, server_name, dns_alias_name, parameters, custom_headers).value!
      nil
    end
    ...
    def acquire_async(resource_group_name, server_name, dns_alias_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_acquire_async(resource_group_name, server_name, dns_alias_name, parameters, custom_headers)
    ...
    def begin_create_or_update(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      response = begin_create_or_update_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      begin_create_or_update_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
    end
    ...
    def begin_delete(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, server_name, dns_alias_name, custom_headers = nil)
      begin_delete_async(resource_group_name, server_name, dns_alias_name, custom_headers).value!
    end
    ...
    def begin_acquire(resource_group_name, server_name, dns_alias_name, parameters, custom_headers = nil)
      response = begin_acquire_async(resource_group_name, server_name, dns_alias_name, parameters, custom_headers).value!
      nil
    end
    ...
    def begin_acquire_with_http_info(resource_group_name, server_name, dns_alias_name, parameters, custom_headers = nil)
      begin_acquire_async(resource_group_name, server_name, dns_alias_name, parameters, custom_headers).value!
    end
