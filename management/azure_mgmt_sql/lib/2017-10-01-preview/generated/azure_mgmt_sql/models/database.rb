...
module Azure::SQL::Mgmt::V2017_10_01_preview
  module Models
    ...
    class Database < TrackedResource
      ...
      # @return [String] Resource that manages the database.
      ...
      # @return [String] The requested service level objective name of the
      # database.
          ...
          type: {
            ...
            model_properties: {
              ...
              max_log_size_bytes: {
                ...
                required: false,
                read_only: true,
                serialized_name: 'properties.maxLogSizeBytes',
                type: {
                  name: 'Number'
                }
              },
              ...
              current_sku: {
                ...
                required: false,
                read_only: true,
                serialized_name: 'properties.currentSku',
                type: {
                  name: 'Composite',
                  class_name: 'Sku'
                }
