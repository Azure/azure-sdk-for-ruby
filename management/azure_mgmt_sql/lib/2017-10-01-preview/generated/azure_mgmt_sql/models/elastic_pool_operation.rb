...
module Azure::SQL::Mgmt::V2017_10_01_preview
  module Models
    ...
    class ElasticPoolOperation < ProxyResource
      ...
      # @return [String] The name of the elastic pool the operation is being
      # performed on.
      ...
      # @return [String] The operation state.
      attr_accessor :state
      ...
      #
      # Mapper for ElasticPoolOperation class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ElasticPoolOperation',
          type: {
            name: 'Composite',
