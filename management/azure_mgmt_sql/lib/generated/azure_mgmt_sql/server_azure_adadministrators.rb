...
module Azure::ARM::SQL
  ...
  class ServerAzureADAdministrators
    ...
    #
    def create_or_update_with_http_info(resource_group_name, server_name, properties, custom_headers = nil)
      create_or_update_async(resource_group_name, server_name, properties, custom_headers).value!
    end
