...
module Azure::ARM::SQL
  ...
  class Databases
    ...
    # @param server_name [String] The name of the server.
    # @param database_name [String] The name of the database.
    # @param geo_backup_policy_name [String] The name of the geo backup policy.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [GeoBackupPolicy] operation results.
    #
    def get_geo_backup_policy(resource_group_name, server_name, database_name, geo_backup_policy_name, custom_headers = nil)
      response = get_geo_backup_policy_async(resource_group_name, server_name, database_name, geo_backup_policy_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_geo_backup_policy_with_http_info(resource_group_name, server_name, database_name, geo_backup_policy_name, custom_headers = nil)
      get_geo_backup_policy_async(resource_group_name, server_name, database_name, geo_backup_policy_name, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_geo_backup_policy_async(resource_group_name, server_name, database_name, geo_backup_policy_name, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      fail ArgumentError, 'database_name is nil' if database_name.nil?
      fail ArgumentError, 'geo_backup_policy_name is nil' if geo_backup_policy_name.nil?
