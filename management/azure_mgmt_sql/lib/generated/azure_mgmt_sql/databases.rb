...
module Azure::ARM::SQL
  ...
  class Databases
    ...
    def create_or_update_geo_backup_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      ...
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      fail ArgumentError, 'database_name is nil' if database_name.nil?
      @client.geo_backup_policy_name = 'Default'
      ...
      options = {
          middlewares: [[MsRest::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'serverName' => server_name,'databaseName' => database_name,'geoBackupPolicyName' => @client.geo_backup_policy_name},
          query_params: {'api-version' => api_version},
    ...
    # @return [BackupLongTermRetentionPolicy] operation results.
    #
    def create_long_term_retention_policy(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      response = create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers)
    ...
    # @return [BackupLongTermRetentionPolicy] operation results.
    #
    def begin_create_long_term_retention_policy(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      response = begin_create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_create_long_term_retention_policy_with_http_info(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      begin_create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_create_long_term_retention_policy_async(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
