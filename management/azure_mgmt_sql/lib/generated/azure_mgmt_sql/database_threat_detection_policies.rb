...
module Azure::ARM::SQL
  ...
  class DatabaseThreatDetectionPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = DatabaseSecurityAlertPolicy.mapper()
    ...
    # @param database_name [String] The name of the database for which database
    # Threat Detection policy is defined.
    # @param database_security_alert_policy [DatabaseSecurityAlertPolicy] The
    ...
    # @return [DatabaseSecurityAlertPolicy] operation results.
    #
    def create_or_update(resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers = nil)
      response = create_or_update_async(resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers = nil)
      create_or_update_async(resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_or_update_async(resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers = nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      fail ArgumentError, 'database_name is nil' if database_name.nil?
      fail ArgumentError, 'database_security_alert_policy is nil' if database_security_alert_policy.nil?
      api_version = '2014-04-01'
      ...
      # Serialize Request
      request_mapper = DatabaseSecurityAlertPolicy.mapper()
      request_content = @client.serialize(request_mapper,  database_security_alert_policy, 'database_security_alert_policy')
