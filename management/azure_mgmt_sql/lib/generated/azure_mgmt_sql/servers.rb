...
module Azure::ARM::SQL
  ...
  class Servers
    ...
    # Manager API or the portal.
    # @param server_name [String] The name of the server.
    # @param parameters [ImportRequestParameters] The required parameters for
    ...
    #
    def import_database(resource_group_name, server_name, parameters, custom_headers = nil)
      response = import_database_async(resource_group_name, server_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def import_database_async(resource_group_name, server_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_import_database_async(resource_group_name, server_name, parameters, custom_headers)
    ...
    # @return [ImportExportOperationResponse] operation results.
    #
    def begin_import_database(resource_group_name, server_name, parameters, custom_headers = nil)
      response = begin_import_database_async(resource_group_name, server_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_import_database_with_http_info(resource_group_name, server_name, parameters, custom_headers = nil)
      begin_import_database_async(resource_group_name, server_name, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_import_database_async(resource_group_name, server_name, parameters, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      ...
      # Serialize Request
      request_mapper = ImportRequestParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters, 'parameters')
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
