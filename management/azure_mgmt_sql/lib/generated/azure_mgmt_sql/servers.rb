...
module Azure::ARM::SQL
  ...
  class Servers
    ...
    #
    #
    def cancel_upgrade(resource_group_name, server_name, custom_headers = nil)
      response = cancel_upgrade_async(resource_group_name, server_name, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def cancel_upgrade_with_http_info(resource_group_name, server_name, custom_headers = nil)
      cancel_upgrade_async(resource_group_name, server_name, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def cancel_upgrade_async(resource_group_name, server_name, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/operationResults/versionUpgrade'
    ...
    # will be added to the HTTP request.
    #
    # @return [ServerUpgradeGetResult] operation results.
    #
    def get_upgrade(resource_group_name, server_name, custom_headers = nil)
      response = get_upgrade_async(resource_group_name, server_name, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_upgrade_with_http_info(resource_group_name, server_name, custom_headers = nil)
      get_upgrade_async(resource_group_name, server_name, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_upgrade_async(resource_group_name, server_name, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = ServerUpgradeGetResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    def start_upgrade(resource_group_name, server_name, parameters, custom_headers = nil)
      response = start_upgrade_async(resource_group_name, server_name, parameters, custom_headers).value!
      nil
    end
    ...
    # response.
    #
    def start_upgrade_async(resource_group_name, server_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_start_upgrade_async(resource_group_name, server_name, parameters, custom_headers)
    ...
    #
    #
    def begin_start_upgrade(resource_group_name, server_name, parameters, custom_headers = nil)
      response = begin_start_upgrade_async(resource_group_name, server_name, parameters, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_start_upgrade_with_http_info(resource_group_name, server_name, parameters, custom_headers = nil)
      begin_start_upgrade_async(resource_group_name, server_name, parameters, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_start_upgrade_async(resource_group_name, server_name, parameters, custom_headers = nil)
      api_version = '2014-04-01'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      ...
      # Serialize Request
      request_mapper = ServerUpgradeStartParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters, 'parameters')
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/upgrade'
