...
module Azure::ARM::SQL
  module Models
    ...
    class UpgradeRecommendedElasticPoolProperties
      ...
      # @return [String] The name of the recommended elastic pool being
      # upgraded.
      attr_accessor :name

      # @return [TargetElasticPoolEditions] The target edition for the
      # recommended elastic pool being upgraded. Possible values include:
      # 'Basic', 'Standard', 'Premium'
      attr_accessor :edition

      # @return [Integer] The DTU guarantee for the recommended elastic pool
      # being upgraded.
      attr_accessor :dtu

      # @return [Integer] The storage limit in MB for the recommended elastic
      # pool being upgraded.
      attr_accessor :storage_mb

      # @return [Integer] The DTU guarantee for database for the recommended
      # elastic pool being upgraded.
      attr_accessor :database_dtu_min

      # @return [Integer] The DTU cap for database for the recommended elastic
      # pool being upgraded.
