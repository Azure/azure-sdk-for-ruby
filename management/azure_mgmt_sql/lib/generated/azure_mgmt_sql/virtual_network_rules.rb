...
module Azure::ARM::SQL
  ...
  class VirtualNetworkRules
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, server_name, virtual_network_rule_name, parameters, custom_headers = nil)
      create_or_update_async(resource_group_name, server_name, virtual_network_rule_name, parameters, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def delete_with_http_info(resource_group_name, server_name, virtual_network_rule_name, custom_headers = nil)
      delete_async(resource_group_name, server_name, virtual_network_rule_name, custom_headers).value!
    end
