...
module Azure::ARM::SQL::Api_2014_04_01
  ...
  class ServerConnectionPolicies
    ...
    def create_or_update_async(resource_group_name, server_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::SQL::Api_2014_04_01::Models::ServerConnectionPolicy.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::SQL::Api_2014_04_01::Models::ServerConnectionPolicy.mapper()
