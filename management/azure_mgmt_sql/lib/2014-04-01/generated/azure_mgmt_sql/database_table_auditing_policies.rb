      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::SQL::Mgmt::V2014_04_01::Models::DatabaseTableAuditingPolicy.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def list_by_database_async(resource_group_name, server_name, database_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::SQL::Mgmt::V2014_04_01::Models::DatabaseTableAuditingPolicyListResult.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
