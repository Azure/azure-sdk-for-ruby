...
module Azure::ARM::SQL::Api_2015_05_01_preview
  ...
  class VirtualNetworkRules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::VirtualNetworkRule.mapper()
    ...
    def list_by_server_async(resource_group_name, server_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::VirtualNetworkRuleListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, server_name, virtual_network_rule_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::VirtualNetworkRule.mapper()
