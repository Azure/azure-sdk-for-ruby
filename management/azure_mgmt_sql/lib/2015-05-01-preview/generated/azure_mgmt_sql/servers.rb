      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result.body = Azure::SQL::Mgmt::V2015_05_01_preview::Models::ServerListResult.new.from_json(parsed_response)
          rescue Exception => e
    ...
    def get_async(resource_group_name, server_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result.body = Azure::SQL::Mgmt::V2015_05_01_preview::Models::Server.new.from_json(parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
        end
    ...
    def create_or_update_async(resource_group_name, server_name, parameters, custom_headers = nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          parsed_response = Azure::SQL::Mgmt::V2015_05_01_preview::Models::Server.new.from_json(parsed_response)
        end
