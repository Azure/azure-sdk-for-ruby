...
module Azure::ARM::SQL::Api_2015_05_01_preview
  ...
  class DatabaseBlobAuditingPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::DatabaseBlobAuditingPolicy.mapper()
    ...
    def create_or_update_async(resource_group_name, server_name, database_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::DatabaseBlobAuditingPolicy.mapper()
