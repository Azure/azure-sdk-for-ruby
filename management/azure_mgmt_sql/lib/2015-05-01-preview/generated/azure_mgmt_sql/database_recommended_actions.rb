...
module Azure::ARM::SQL::Api_2015_05_01_preview
  ...
  class DatabaseRecommendedActions
    ...
    def get_async(resource_group_name, server_name, database_name, advisor_name, recommended_action_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::RecommendedAction.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, server_name, database_name, advisor_name, recommended_action_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::SQL::Api_2015_05_01_preview::Models::RecommendedAction.mapper()
