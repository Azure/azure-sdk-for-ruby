...
module Azure::SQL::Mgmt::V2015_05_01_preview
  ...
  class VirtualClusters
    ...
    def get(resource_group_name, virtual_cluster_name, custom_headers = nil)
      response = get_async(resource_group_name, virtual_cluster_name, custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, virtual_cluster_name, custom_headers = nil)
      get_async(resource_group_name, virtual_cluster_name, custom_headers).value!
    end
    ...
    def delete(resource_group_name, virtual_cluster_name, custom_headers = nil)
      response = delete_async(resource_group_name, virtual_cluster_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, virtual_cluster_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, virtual_cluster_name, custom_headers)
    ...
    def update(resource_group_name, virtual_cluster_name, parameters, custom_headers = nil)
      response = update_async(resource_group_name, virtual_cluster_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, virtual_cluster_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, virtual_cluster_name, parameters, custom_headers)
    ...
    def begin_delete(resource_group_name, virtual_cluster_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, virtual_cluster_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, virtual_cluster_name, custom_headers = nil)
      begin_delete_async(resource_group_name, virtual_cluster_name, custom_headers).value!
    end
    ...
    def begin_update(resource_group_name, virtual_cluster_name, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, virtual_cluster_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, virtual_cluster_name, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, virtual_cluster_name, parameters, custom_headers).value!
    end
