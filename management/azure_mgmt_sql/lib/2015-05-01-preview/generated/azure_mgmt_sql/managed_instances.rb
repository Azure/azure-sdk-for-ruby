...
module Azure::SQL::Mgmt::V2015_05_01_preview
  ...
  class ManagedInstances
    ...
    def delete(resource_group_name, managed_instance_name, custom_headers = nil)
      response = delete_async(resource_group_name, managed_instance_name, custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, managed_instance_name, custom_headers = nil)
      # Send request
      promise = begin_delete_async(resource_group_name, managed_instance_name, custom_headers)
    ...
    def update(resource_group_name, managed_instance_name, parameters, custom_headers = nil)
      response = update_async(resource_group_name, managed_instance_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def update_async(resource_group_name, managed_instance_name, parameters, custom_headers = nil)
      # Send request
      promise = begin_update_async(resource_group_name, managed_instance_name, parameters, custom_headers)
    ...
    def list_by_instance_pool(resource_group_name, instance_pool_name, custom_headers = nil)
      first_page = list_by_instance_pool_as_lazy(resource_group_name, instance_pool_name, custom_headers)
      first_page.get_all_items
    end
    ...
    def list_by_instance_pool_with_http_info(resource_group_name, instance_pool_name, custom_headers = nil)
      list_by_instance_pool_async(resource_group_name, instance_pool_name, custom_headers).value!
    end
    ...
    def begin_delete(resource_group_name, managed_instance_name, custom_headers = nil)
      response = begin_delete_async(resource_group_name, managed_instance_name, custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, managed_instance_name, custom_headers = nil)
      begin_delete_async(resource_group_name, managed_instance_name, custom_headers).value!
    end
    ...
    def begin_update(resource_group_name, managed_instance_name, parameters, custom_headers = nil)
      response = begin_update_async(resource_group_name, managed_instance_name, parameters, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_with_http_info(resource_group_name, managed_instance_name, parameters, custom_headers = nil)
      begin_update_async(resource_group_name, managed_instance_name, parameters, custom_headers).value!
    end
    ...
    def list_by_instance_pool_next(next_page_link, custom_headers = nil)
      response = list_by_instance_pool_next_async(next_page_link, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def list_by_instance_pool_next_with_http_info(next_page_link, custom_headers = nil)
      list_by_instance_pool_next_async(next_page_link, custom_headers).value!
    end
    ...
    def list_by_instance_pool_as_lazy(resource_group_name, instance_pool_name, custom_headers = nil)
      response = list_by_instance_pool_async(resource_group_name, instance_pool_name, custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_by_instance_pool_next_async(next_page_link, custom_headers)
        end
        page
      end
    end
